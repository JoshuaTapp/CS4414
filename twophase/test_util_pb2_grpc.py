...
class TestUtilPing(object):
    ...
    def Ping(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TestUtilPing/Ping',
            test__util__pb2.TestUtilEmpty.SerializeToString,
            test__util__pb2.TestUtilEmpty.FromString,
