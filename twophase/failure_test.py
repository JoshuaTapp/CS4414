...
class SetOneValueNoFailuresTest(InjectedFailuresTest):
...
class ChangeValueNoFailuresTest(InjectedFailuresTest):
    @parameterized.expand([(1,), (2,), (5,)]) 
    def test_change_value_no_failures(self, workers):
        self._change_value_no_failures(workers)
   
class ChangeValueReorderingTest(InjectedFailuresTest):
...
class ChangeValueFailuresTest(InjectedFailuresTest):
    @parameterized.expand([
        (2, 0, 0, False),
        (2, 0, 0, True),
        (2, 0, 1, False),
...
class ChangeValueLogFailuresTest(InjectedFailuresTest):
    @parameterized.expand([
        (2, 0, False),
        (2, 0, True),
        (2, 1, False),
