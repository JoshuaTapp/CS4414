...
80100046:	e8 1e 3d 00 00       	call   80103d69 <acquire>
...
80100087:	e8 c9 3a 00 00       	call   80103b55 <acquiresleep>
      return b;
...
801000d5:	e8 7b 3a 00 00       	call   80103b55 <acquiresleep>
      return b;
...
801000ea:	68 e0 68 10 80       	push   $0x801068e0
...
801000fb:	68 f1 68 10 80       	push   $0x801068f1
80100100:	68 20 a5 10 80       	push   $0x8010a520
80100105:	e8 23 3b 00 00       	call   80103c2d <initlock>
...
8010013a:	68 f8 68 10 80       	push   $0x801068f8
8010013f:	8d 43 0c             	lea    0xc(%ebx),%eax
80100142:	50                   	push   %eax
80100143:	e8 da 39 00 00       	call   80103b22 <initsleeplock>
...
801001a8:	e8 32 3a 00 00       	call   80103bdf <holdingsleep>
...
801001cb:	68 ff 68 10 80       	push   $0x801068ff
...
801001e4:	e8 f6 39 00 00       	call   80103bdf <holdingsleep>
...
801001f4:	e8 ab 39 00 00       	call   80103ba4 <releasesleep>

  acquire(&bcache.lock);
801001f9:	c7 04 24 20 a5 10 80 	movl   $0x8010a520,(%esp)
80100200:	e8 64 3b 00 00       	call   80103d69 <acquire>
  b->refcnt--;
...
8010024c:	e8 7d 3b 00 00       	call   80103dce <release>
}
...
8010025e:	68 06 69 10 80       	push   $0x80106906
...
8010028a:	e8 da 3a 00 00       	call   80103d69 <acquire>
  while(n > 0){
...
801002a5:	75 47                	jne    801002ee <consoleread+0x86>
      if(myproc()->killed){
801002a7:	e8 4f 30 00 00       	call   801032fb <myproc>
...
801002bf:	e8 63 34 00 00       	call   80103727 <sleep>
801002c4:	83 c4 10             	add    $0x10,%esp
801002c7:	eb d1                	jmp    8010029a <consoleread+0x32>
        release(&cons.lock);
801002c9:	83 ec 0c             	sub    $0xc,%esp
801002cc:	68 20 ef 10 80       	push   $0x8010ef20
801002d1:	e8 f8 3a 00 00       	call   80103dce <release>
        ilock(ip);
...
80100331:	e8 98 3a 00 00       	call   80103dce <release>
  ilock(ip);
...
80100363:	68 0d 69 10 80       	push   $0x8010690d
...
8010038f:	e8 b4 38 00 00       	call   80103c48 <getcallerpcs>
  for(i=0; i<10; i++)
...
801003a5:	68 21 69 10 80       	push   $0x80106921
...
80100492:	68 25 69 10 80       	push   $0x80106925
...
801004ae:	e8 da 39 00 00       	call   80103e8d <memmove>
    pos -= 80;
...
801004cd:	e8 43 39 00 00       	call   80103e15 <memset>
...
801004fa:	e8 63 4d 00 00       	call   80105262 <uartputc>
...
80100513:	e8 4a 4d 00 00       	call   80105262 <uartputc>
80100518:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010051f:	e8 3e 4d 00 00       	call   80105262 <uartputc>
80100524:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052b:	e8 32 4d 00 00       	call   80105262 <uartputc>
...
80100568:	0f b6 92 50 69 10 80 	movzbl -0x7fef96b0(%edx),%edx
...
801005c6:	e8 9e 37 00 00       	call   80103d69 <acquire>
  for(i = 0; i < n; i++)
...
801005ed:	e8 dc 37 00 00       	call   80103dce <release>
  ilock(ip);
...
801006cb:	75 12                	jne    801006df <cprintf+0xd8>
        s = "(null)";
801006cd:	bb 38 69 10 80       	mov    $0x80106938,%ebx
...
80100729:	e8 a0 36 00 00       	call   80103dce <release>
...
80100744:	e8 20 36 00 00       	call   80103d69 <acquire>
  while((c = getc()) >= 0){
...
801007f2:	e8 98 30 00 00       	call   8010388f <wakeup>
...
8010086f:	e8 5a 35 00 00       	call   80103dce <release>
  if(doprocdump) {
...
80100883:	e8 a6 30 00 00       	call   8010392e <procdump>
}
...
80100890:	68 48 69 10 80       	push   $0x80106948
80100895:	68 20 ef 10 80       	push   $0x8010ef20
8010089a:	e8 8e 33 00 00       	call   80103c2d <initlock>
...
801008da:	e8 1c 2a 00 00       	call   801032fb <myproc>
...
8010095a:	68 61 69 10 80       	push   $0x80106961
...
8010096c:	eb dc                	jmp    8010094a <exec+0x7c>
  if((pgdir = setupkvm()) == 0)
8010096e:	e8 d6 5c 00 00       	call   80106649 <setupkvm>
...
80100a02:	e8 be 5a 00 00       	call   801064c5 <allocuvm>
...
80100a34:	e8 37 59 00 00       	call   80106370 <loaduvm>
...
80100a71:	e8 4f 5a 00 00       	call   801064c5 <allocuvm>
...
80100ab4:	e8 15 5c 00 00       	call   801066ce <clearpteu>
...
80100ae6:	e8 d3 34 00 00       	call   80103fbe <strlen>
...
80100af8:	e8 c1 34 00 00       	call   80103fbe <strlen>
...
80100b0a:	e8 4f 5d 00 00       	call   8010685e <copyout>
...
80100b6a:	e8 ef 5c 00 00       	call   8010685e <copyout>
...
80100ba7:	e8 d5 33 00 00       	call   80103f81 <safestrcpy>
...
80100bd5:	e8 a1 55 00 00       	call   8010617b <switchuvm>
  freevm(oldpgdir);
...
80100c09:	68 6d 69 10 80       	push   $0x8010696d
80100c0e:	68 60 ef 10 80       	push   $0x8010ef60
80100c13:	e8 15 30 00 00       	call   80103c2d <initlock>
}
...
80100c29:	e8 3b 31 00 00       	call   80103d69 <acquire>
...
80100c58:	e8 71 31 00 00       	call   80103dce <release>
      return f;
...
80100c6f:	e8 5a 31 00 00       	call   80103dce <release>
  return 0;
...
80100c8d:	e8 d7 30 00 00       	call   80103d69 <acquire>
  if(f->ref < 1)
...
80100caa:	e8 1f 31 00 00       	call   80103dce <release>
  return f;
}
...
80100cb9:	68 74 69 10 80       	push   $0x80106974
...
80100cd2:	e8 92 30 00 00       	call   80103d69 <acquire>
  if(f->ref < 1)
...
80100d23:	e8 a6 30 00 00       	call   80103dce <release>
...
80100e44:	68 86 69 10 80       	push   $0x80106986
...
80100f0a:	68 8f 69 10 80       	push   $0x8010698f
...
80100f31:	68 95 69 10 80       	push   $0x80106995
...
80100f81:	e8 07 2f 00 00       	call   80103e8d <memmove>
...
80100f91:	e8 f7 2e 00 00       	call   80103e8d <memmove>
    name[len] = 0;
...
80100fd6:	e8 3a 2e 00 00       	call   80103e15 <memset>
  log_write(bp);
...
8010105f:	68 9f 69 10 80       	push   $0x8010699f
...
80101116:	68 b2 69 10 80       	push   $0x801069b2
...
801011ed:	68 c8 69 10 80       	push   $0x801069c8
...
8010120a:	e8 5a 2b 00 00       	call   80103d69 <acquire>
...
80101251:	e8 78 2b 00 00       	call   80103dce <release>
      return ip;
...
80101287:	e8 42 2b 00 00       	call   80103dce <release>
  return ip;
...
8010129c:	68 db 69 10 80       	push   $0x801069db
...
801012c5:	e8 c3 2b 00 00       	call   80103e8d <memmove>
  brelse(bp);
...
801012e1:	68 eb 69 10 80       	push   $0x801069eb
801012e6:	68 60 f9 10 80       	push   $0x8010f960
801012eb:	e8 3d 29 00 00       	call   80103c2d <initlock>
  for(i = 0; i < NINODE; i++) {
...
801012fd:	68 f2 69 10 80       	push   $0x801069f2
...
80101310:	e8 0d 28 00 00       	call   80103b22 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010135a:	68 58 6a 10 80       	push   $0x80106a58
...
801013cd:	68 f8 69 10 80       	push   $0x801069f8
...
801013df:	e8 31 2a 00 00       	call   80103e15 <memset>
      dip->type = type;
...
8010146e:	e8 1a 2a 00 00       	call   80103e8d <memmove>
  log_write(bp);
...
8010154e:	e8 16 28 00 00       	call   80103d69 <acquire>
  ip->ref++;
...
80101563:	e8 66 28 00 00       	call   80103dce <release>
}
...
80101588:	e8 c8 25 00 00       	call   80103b55 <acquiresleep>
  if(ip->valid == 0){
...
801015a0:	68 0a 6a 10 80       	push   $0x80106a0a
...
80101602:	e8 86 28 00 00       	call   80103e8d <memmove>
    brelse(bp);
...
80101627:	68 10 6a 10 80       	push   $0x80106a10
...
80101644:	e8 96 25 00 00       	call   80103bdf <holdingsleep>
...
8010165a:	e8 45 25 00 00       	call   80103ba4 <releasesleep>
}
...
8010166c:	68 1f 6a 10 80       	push   $0x80106a1f
...
80101686:	e8 ca 24 00 00       	call   80103b55 <acquiresleep>
...
8010169f:	e8 00 25 00 00       	call   80103ba4 <releasesleep>
  acquire(&icache.lock);
801016a4:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801016ab:	e8 b9 26 00 00       	call   80103d69 <acquire>
  ip->ref--;
...
801016c0:	e8 09 27 00 00       	call   80103dce <release>
}
...
801016d8:	e8 8c 26 00 00       	call   80103d69 <acquire>
    int r = ip->ref;
801016dd:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
801016e0:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801016e7:	e8 e2 26 00 00       	call   80103dce <release>
    if(r == 1){
...
80101818:	e8 70 26 00 00       	call   80103e8d <memmove>
    brelse(bp);
...
80101915:	e8 73 25 00 00       	call   80103e8d <memmove>
    log_write(bp);
...
80101998:	e8 5c 25 00 00       	call   80103ef9 <strncmp>
}
8010199d:	c9                   	leave  
8010199e:	c3                   	ret    
...
801019bf:	68 27 6a 10 80       	push   $0x80106a27
801019c4:	e8 7f e9 ff ff       	call   80100348 <panic>
      panic("dirlookup read");
801019c9:	83 ec 0c             	sub    $0xc,%esp
801019cc:	68 39 6a 10 80       	push   $0x80106a39
...
80101a47:	74 17                	je     80101a60 <namex+0x2d>
    ...
    ip = idup(myproc()->cwd);
80101a49:	e8 ad 18 00 00       	call   801032fb <myproc>
...
80101b7e:	68 48 6a 10 80       	push   $0x80106a48
...
80101b95:	e8 9e 23 00 00       	call   80103f38 <strncpy>
  de.inum = inum;
...
80101cc5:	68 ab 6a 10 80       	push   $0x80106aab
80101cca:	e8 79 e6 ff ff       	call   80100348 <panic>
    panic("incorrect blockno");
80101ccf:	83 ec 0c             	sub    $0xc,%esp
80101cd2:	68 b4 6a 10 80       	push   $0x80106ab4
...
80101cef:	68 c6 6a 10 80       	push   $0x80106ac6
80101cf4:	68 00 16 11 80       	push   $0x80111600
80101cf9:	e8 2f 1f 00 00       	call   80103c2d <initlock>
...
80101d69:	e8 fb 1f 00 00       	call   80103d69 <acquire>
...
80101d98:	e8 f2 1a 00 00       	call   8010388f <wakeup>
...
80101db6:	e8 13 20 00 00       	call   80103dce <release>
...
80101dcd:	e8 fc 1f 00 00       	call   80103dce <release>
    return;
...
80101e05:	e8 d5 1d 00 00       	call   80103bdf <holdingsleep>
...
80101e32:	e8 32 1f 00 00       	call   80103d69 <acquire>
...
80101e94:	e8 8e 18 00 00       	call   80103727 <sleep>
...
80101eae:	e8 1b 1f 00 00       	call   80103dce <release>
}
...
80101f22:	68 14 6b 10 80       	push   $0x80106b14
...
80101f9e:	81 fb f0 56 11 80    	cmp    $0x801156f0,%ebx
...
80101fc6:	e8 4a 1e 00 00       	call   80103e15 <memset>
...
80102026:	e8 a3 1d 00 00       	call   80103dce <release>
...
8010204e:	68 dc 6b 10 80       	push   $0x80106bdc
...
8010207d:	68 e6 6b 10 80       	push   $0x80106be6
80102082:	68 40 16 11 80       	push   $0x80111640
80102087:	e8 a1 1b 00 00       	call   80103c2d <initlock>
  kmem.use_lock = 0;
...
80102102:	e8 62 1c 00 00       	call   80103d69 <acquire>
...
80102114:	e8 b5 1c 00 00       	call   80103dce <release>
...
80102157:	0f b6 91 20 6d 10 80 	movzbl -0x7fef92e0(%ecx),%edx
8010215e:	0b 15 7c 16 11 80    	or     0x8011167c,%edx
80102164:	89 15 7c 16 11 80    	mov    %edx,0x8011167c
  shift ^= togglecode[data];
8010216a:	0f b6 81 20 6c 10 80 	movzbl -0x7fef93e0(%ecx),%eax
...
8010217e:	8b 04 85 00 6c 10 80 	mov    -0x7fef9400(,%eax,4),%eax
...
801021b4:	83 e1 7f             	and    $0x7f,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
801021b7:	0f b6 81 20 6d 10 80 	movzbl -0x7fef92e0(%ecx),%eax
...
801024aa:	e8 a9 19 00 00       	call   80103e58 <memcmp>
...
80102605:	e8 83 18 00 00       	call   80103e8d <memmove>
...
80102704:	e8 84 17 00 00       	call   80103e8d <memmove>
...
80102771:	68 20 6e 10 80       	push   $0x80106e20
80102776:	68 a0 16 11 80       	push   $0x801116a0
8010277b:	e8 ad 14 00 00       	call   80103c2d <initlock>
  readsb(dev, &sb);
...
801027bb:	e8 a9 15 00 00       	call   80103d69 <acquire>
...
801027d2:	e8 50 0f 00 00       	call   80103727 <sleep>
...
80102809:	e8 19 0f 00 00       	call   80103727 <sleep>
...
80102820:	e8 a9 15 00 00       	call   80103dce <release>
}
...
80102836:	e8 2e 15 00 00       	call   80103d69 <acquire>
  log.outstanding -= 1;
...
80102870:	e8 59 15 00 00       	call   80103dce <release>
  if(do_commit){
...
8010290b:	e8 59 14 00 00       	call   80103d69 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
8010291d:	68 33 6e 10 80       	push   $0x80106e33
80102922:	e8 21 da ff ff       	call   80100348 <panic>
    panic("log_write outside of trans");
80102927:	83 ec 0c             	sub    $0xc,%esp
8010292a:	68 49 6e 10 80       	push   $0x80106e49
...
80102966:	e8 63 14 00 00       	call   80103dce <release>
}
...
80102994:	e8 f4 14 00 00       	call   80103e8d <memmove>
...
801029a6:	68 48 6b 10 80       	push   $0x80106b48
...
801029c9:	e8 b6 08 00 00       	call   80103284 <mycpu>
...
80102a2d:	e8 ae 08 00 00       	call   801032e0 <cpuid>
80102a32:	89 c3                	mov    %eax,%ebx
80102a34:	e8 a7 08 00 00       	call   801032e0 <cpuid>
80102a39:	83 ec 04             	sub    $0x4,%esp
80102a3c:	53                   	push   %ebx
80102a3d:	50                   	push   %eax
80102a3e:	68 64 6e 10 80       	push   $0x80106e64
80102a43:	e8 bf db ff ff       	call   80100607 <cprintf>
  idtinit();       // load idt register
80102a48:	e8 b3 25 00 00       	call   80105000 <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80102a4d:	e8 32 08 00 00       	call   80103284 <mycpu>
...
80102a60:	e8 d1 0f 00 00       	call   80103a36 <scheduler>
...
80102a68:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a6b:	e8 e6 36 00 00       	call   80106156 <switchkvm>
  seginit();
80102a70:	e8 6c 34 00 00       	call   80105ee1 <seginit>
  lapicinit();
...
80102ac2:	e8 e0 27 00 00       	call   801052a7 <uartinit>
  pinit();         // process table
80102ac7:	e8 9e 07 00 00       	call   8010326a <pinit>
  tvinit();        // trap vectors
80102acc:	e8 2a 24 00 00       	call   80104efb <tvinit>
  binit();         // buffer cache
...
80102af7:	e8 22 08 00 00       	call   8010331e <userinit>
...
80102b3f:	68 78 6e 10 80       	push   $0x80106e78
...
80102b55:	68 92 6e 10 80       	push   $0x80106e92
80102b5a:	53                   	push   %ebx
80102b5b:	e8 f8 12 00 00       	call   80103e58 <memcmp>
...
80102c1f:	68 97 6e 10 80       	push   $0x80106e97
80102c24:	53                   	push   %ebx
80102c25:	e8 2e 12 00 00       	call   80103e58 <memcmp>
...
80102c61:	68 78 6e 10 80       	push   $0x80106e78
...
80102cb5:	68 9c 6e 10 80       	push   $0x80106e9c
...
80102d50:	68 b4 6e 10 80       	push   $0x80106eb4
...
80102dd7:	68 d3 6e 10 80       	push   $0x80106ed3
80102ddc:	50                   	push   %eax
80102ddd:	e8 4b 0e 00 00       	call   80103c2d <initlock>
  (*f0)->type = FD_PIPE;
...
80102e61:	e8 03 0f 00 00       	call   80103d69 <acquire>
  if(writable){
...
80102e83:	e8 07 0a 00 00       	call   8010388f <wakeup>
...
80102ea1:	e8 28 0f 00 00       	call   80103dce <release>
...
80102ec2:	e8 c8 09 00 00       	call   8010388f <wakeup>
...
80102ed0:	e8 f9 0e 00 00       	call   80103dce <release>
    kfree((char*)p);
...
80102ef2:	e8 72 0e 00 00       	call   80103d69 <acquire>
  for(i = 0; i < n; i++){
...
80102f0d:	e8 7d 09 00 00       	call   8010388f <wakeup>
  release(&p->lock);
80102f12:	89 1c 24             	mov    %ebx,(%esp)
80102f15:	e8 b4 0e 00 00       	call   80103dce <release>
  return n;
...
80102f61:	e8 95 03 00 00       	call   801032fb <myproc>
...
80102f70:	e8 59 0e 00 00       	call   80103dce <release>
        return -1;
...
80102fb7:	e8 ad 0d 00 00       	call   80103d69 <acquire>
...
80102fcc:	e8 56 07 00 00       	call   80103727 <sleep>
...
80102fea:	74 37                	je     80103023 <piperead+0x7c>
    if(myproc()->killed){
80102fec:	e8 0a 03 00 00       	call   801032fb <myproc>
...
80102ffb:	e8 ce 0d 00 00       	call   80103dce <release>
      return -1;
...
80103040:	e8 4a 08 00 00       	call   8010388f <wakeup>
  release(&p->lock);
80103045:	89 1c 24             	mov    %ebx,(%esp)
80103048:	e8 81 0d 00 00       	call   80103dce <release>
  return i;
...
80103061:	ba 74 1d 11 80       	mov    $0x80111d74,%edx
80103066:	eb 06                	jmp    8010306e <wakeup1+0xd>
80103068:	81 c2 84 00 00 00    	add    $0x84,%edx
8010306e:	81 fa 74 3e 11 80    	cmp    $0x80113e74,%edx
...
8010308f:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
80103092:	68 40 1d 11 80       	push   $0x80111d40
80103097:	e8 cd 0c 00 00       	call   80103d69 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010309c:	83 c4 10             	add    $0x10,%esp
8010309f:	bb 74 1d 11 80       	mov    $0x80111d74,%ebx
801030a4:	eb 06                	jmp    801030ac <allocproc+0x21>
801030a6:	81 c3 84 00 00 00    	add    $0x84,%ebx
801030ac:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
801030b2:	73 7d                	jae    80103131 <allocproc+0xa6>
    if(p->state == UNUSED)
...
801030cf:	89 43 10             	mov    %eax,0x10(%ebx)
  p->tickets = 10;
801030d2:	c7 43 7c 0a 00 00 00 	movl   $0xa,0x7c(%ebx)
  release(&ptable.lock);
801030d9:	83 ec 0c             	sub    $0xc,%esp
801030dc:	68 40 1d 11 80       	push   $0x80111d40
801030e1:	e8 e8 0c 00 00       	call   80103dce <release>
  if((p->kstack = kalloc()) == 0){
801030e6:	e8 de ef ff ff       	call   801020c9 <kalloc>
801030eb:	89 43 08             	mov    %eax,0x8(%ebx)
801030ee:	83 c4 10             	add    $0x10,%esp
801030f1:	85 c0                	test   %eax,%eax
801030f3:	74 53                	je     80103148 <allocproc+0xbd>
  sp -= sizeof *p->tf;
801030f5:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  p->tf = (struct trapframe*)sp;
801030fb:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801030fe:	c7 80 b0 0f 00 00 f0 	movl   $0x80104ef0,0xfb0(%eax)
80103105:	4e 10 80 
  sp -= sizeof *p->context;
80103108:	05 9c 0f 00 00       	add    $0xf9c,%eax
  p->context = (struct context*)sp;
8010310d:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103110:	83 ec 04             	sub    $0x4,%esp
80103113:	6a 14                	push   $0x14
80103115:	6a 00                	push   $0x0
80103117:	50                   	push   %eax
80103118:	e8 f8 0c 00 00       	call   80103e15 <memset>
  p->context->eip = (uint)forkret;
8010311d:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103120:	c7 40 10 53 31 10 80 	movl   $0x80103153,0x10(%eax)
  return p;
80103127:	83 c4 10             	add    $0x10,%esp
}
8010312a:	89 d8                	mov    %ebx,%eax
8010312c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010312f:	c9                   	leave  
80103130:	c3                   	ret    
  release(&ptable.lock);
80103131:	83 ec 0c             	sub    $0xc,%esp
80103134:	68 40 1d 11 80       	push   $0x80111d40
80103139:	e8 90 0c 00 00       	call   80103dce <release>
  return 0;
8010313e:	83 c4 10             	add    $0x10,%esp
80103141:	bb 00 00 00 00       	mov    $0x0,%ebx
80103146:	eb e2                	jmp    8010312a <allocproc+0x9f>
    p->state = UNUSED;
80103148:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return 0;
8010314f:	89 c3                	mov    %eax,%ebx
80103151:	eb d7                	jmp    8010312a <allocproc+0x9f>

80103153 <forkret>:
{
80103153:	55                   	push   %ebp
80103154:	89 e5                	mov    %esp,%ebp
80103156:	83 ec 14             	sub    $0x14,%esp
  release(&ptable.lock);
80103159:	68 40 1d 11 80       	push   $0x80111d40
8010315e:	e8 6b 0c 00 00       	call   80103dce <release>
  if (first) {
80103163:	83 c4 10             	add    $0x10,%esp
80103166:	83 3d 00 a0 10 80 00 	cmpl   $0x0,0x8010a000
8010316d:	75 02                	jne    80103171 <forkret+0x1e>
}
8010316f:	c9                   	leave  
80103170:	c3                   	ret    
    first = 0;
80103171:	c7 05 00 a0 10 80 00 	movl   $0x0,0x8010a000
80103178:	00 00 00 
    iinit(ROOTDEV);
8010317b:	83 ec 0c             	sub    $0xc,%esp
8010317e:	6a 01                	push   $0x1
80103180:	e8 55 e1 ff ff       	call   801012da <iinit>
    initlog(ROOTDEV);
80103185:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010318c:	e8 d6 f5 ff ff       	call   80102767 <initlog>
80103191:	83 c4 10             	add    $0x10,%esp
}
80103194:	eb d9                	jmp    8010316f <forkret+0x1c>

80103196 <setticket>:
{
80103196:	55                   	push   %ebp
80103197:	89 e5                	mov    %esp,%ebp
80103199:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010319c:	8b 55 0c             	mov    0xc(%ebp),%edx
  ticketCount -= p->tickets;
8010319f:	a1 20 1d 11 80       	mov    0x80111d20,%eax
801031a4:	2b 41 7c             	sub    0x7c(%ecx),%eax
801031a7:	a3 20 1d 11 80       	mov    %eax,0x80111d20
  if(tickets < 0) // lower limit
801031ac:	85 d2                	test   %edx,%edx
801031ae:	78 1b                	js     801031cb <setticket+0x35>
  else if(tickets > 100000) // upper limit
801031b0:	81 fa a0 86 01 00    	cmp    $0x186a0,%edx
801031b6:	7e 21                	jle    801031d9 <setticket+0x43>
    p->tickets = 100000;
801031b8:	c7 41 7c a0 86 01 00 	movl   $0x186a0,0x7c(%ecx)
    ticketCount += 100000;
801031bf:	05 a0 86 01 00       	add    $0x186a0,%eax
801031c4:	a3 20 1d 11 80       	mov    %eax,0x80111d20
801031c9:	eb 07                	jmp    801031d2 <setticket+0x3c>
    p->tickets = 0;
801031cb:	c7 41 7c 00 00 00 00 	movl   $0x0,0x7c(%ecx)
}
801031d2:	b8 00 00 00 00       	mov    $0x0,%eax
801031d7:	5d                   	pop    %ebp
801031d8:	c3                   	ret    
    p->tickets = tickets;  // set ticket from arg if within range
801031d9:	89 51 7c             	mov    %edx,0x7c(%ecx)
    ticketCount += tickets;
801031dc:	01 d0                	add    %edx,%eax
801031de:	a3 20 1d 11 80       	mov    %eax,0x80111d20
801031e3:	eb ed                	jmp    801031d2 <setticket+0x3c>

801031e5 <getprocinfo>:
{
801031e5:	55                   	push   %ebp
801031e6:	89 e5                	mov    %esp,%ebp
801031e8:	53                   	push   %ebx
801031e9:	83 ec 10             	sub    $0x10,%esp
801031ec:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801031ef:	68 40 1d 11 80       	push   $0x80111d40
801031f4:	e8 70 0b 00 00       	call   80103d69 <acquire>
  pi->num_processes = 0;
801031f9:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801031ff:	83 c4 10             	add    $0x10,%esp
80103202:	b8 74 1d 11 80       	mov    $0x80111d74,%eax
80103207:	eb 05                	jmp    8010320e <getprocinfo+0x29>
80103209:	05 84 00 00 00       	add    $0x84,%eax
8010320e:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
80103213:	73 3e                	jae    80103253 <getprocinfo+0x6e>
    int i = p - ptable.proc;
80103215:	89 c2                	mov    %eax,%edx
80103217:	81 ea 74 1d 11 80    	sub    $0x80111d74,%edx
8010321d:	c1 fa 02             	sar    $0x2,%edx
80103220:	69 d2 e1 83 0f 3e    	imul   $0x3e0f83e1,%edx,%edx
    if(p->state != UNUSED)
80103226:	83 78 0c 00          	cmpl   $0x0,0xc(%eax)
8010322a:	74 dd                	je     80103209 <getprocinfo+0x24>
      pi->num_processes++;
8010322c:	8b 0b                	mov    (%ebx),%ecx
8010322e:	83 c1 01             	add    $0x1,%ecx
80103231:	89 0b                	mov    %ecx,(%ebx)
      pi->pids[i] = p->pid;
80103233:	8b 48 10             	mov    0x10(%eax),%ecx
80103236:	89 4c 93 04          	mov    %ecx,0x4(%ebx,%edx,4)
      pi->times_scheduled[i] = p->called;
8010323a:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
80103240:	89 8c 93 04 01 00 00 	mov    %ecx,0x104(%ebx,%edx,4)
      pi->tickets[i] = p->tickets;
80103247:	8b 48 7c             	mov    0x7c(%eax),%ecx
8010324a:	89 8c 93 04 02 00 00 	mov    %ecx,0x204(%ebx,%edx,4)
80103251:	eb b6                	jmp    80103209 <getprocinfo+0x24>
  release(&ptable.lock);
80103253:	83 ec 0c             	sub    $0xc,%esp
80103256:	68 40 1d 11 80       	push   $0x80111d40
8010325b:	e8 6e 0b 00 00       	call   80103dce <release>
}
80103260:	b8 00 00 00 00       	mov    $0x0,%eax
...
8010326d:	83 ec 10             	sub    $0x10,%esp
  initlock(&ptable.lock, "ptable");
80103270:	68 d8 6e 10 80       	push   $0x80106ed8
80103275:	68 40 1d 11 80       	push   $0x80111d40
8010327a:	e8 ae 09 00 00       	call   80103c2d <initlock>
}
...
8010328b:	58                   	pop    %eax
  if(readeflags()&FL_IF)
8010328c:	f6 c4 02             	test   $0x2,%ah
8010328f:	75 28                	jne    801032b9 <mycpu+0x35>
  apicid = lapicid();
80103291:	e8 fc f0 ff ff       	call   80102392 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103296:	ba 00 00 00 00       	mov    $0x0,%edx
8010329b:	39 15 84 17 11 80    	cmp    %edx,0x80111784
801032a1:	7e 23                	jle    801032c6 <mycpu+0x42>
    if (cpus[i].apicid == apicid)
801032a3:	69 ca b0 00 00 00    	imul   $0xb0,%edx,%ecx
801032a9:	0f b6 89 a0 17 11 80 	movzbl -0x7feee860(%ecx),%ecx
801032b0:	39 c1                	cmp    %eax,%ecx
801032b2:	74 1f                	je     801032d3 <mycpu+0x4f>
  for (i = 0; i < ncpu; ++i) {
801032b4:	83 c2 01             	add    $0x1,%edx
801032b7:	eb e2                	jmp    8010329b <mycpu+0x17>
    panic("mycpu called with interrupts enabled\n");
801032b9:	83 ec 0c             	sub    $0xc,%esp
801032bc:	68 bc 6f 10 80       	push   $0x80106fbc
801032c1:	e8 82 d0 ff ff       	call   80100348 <panic>
  panic("unknown apicid\n");
801032c6:	83 ec 0c             	sub    $0xc,%esp
801032c9:	68 df 6e 10 80       	push   $0x80106edf
801032ce:	e8 75 d0 ff ff       	call   80100348 <panic>
      return &cpus[i];
801032d3:	69 c2 b0 00 00 00    	imul   $0xb0,%edx,%eax
801032d9:	05 a0 17 11 80       	add    $0x801117a0,%eax
}
801032de:	c9                   	leave  
801032df:	c3                   	ret    
...
801032e3:	83 ec 08             	sub    $0x8,%esp
  return mycpu()-cpus;
801032e6:	e8 99 ff ff ff       	call   80103284 <mycpu>
801032eb:	2d a0 17 11 80       	sub    $0x801117a0,%eax
801032f0:	c1 f8 04             	sar    $0x4,%eax
801032f3:	69 c0 a3 8b 2e ba    	imul   $0xba2e8ba3,%eax,%eax
}
801032f9:	c9                   	leave  
801032fa:	c3                   	ret    
...
801032ff:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103302:	e8 87 09 00 00       	call   80103c8e <pushcli>
  c = mycpu();
80103307:	e8 78 ff ff ff       	call   80103284 <mycpu>
  p = c->proc;
8010330c:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103312:	e8 b3 09 00 00       	call   80103cca <popcli>
}
80103317:	89 d8                	mov    %ebx,%eax
...
80103322:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103325:	e8 61 fd ff ff       	call   8010308b <allocproc>
8010332a:	89 c3                	mov    %eax,%ebx
  initproc = p;
8010332c:	a3 74 3e 11 80       	mov    %eax,0x80113e74
  if((p->pgdir = setupkvm()) == 0)
80103331:	e8 13 33 00 00       	call   80106649 <setupkvm>
80103336:	89 43 04             	mov    %eax,0x4(%ebx)
80103339:	85 c0                	test   %eax,%eax
8010333b:	0f 84 b8 00 00 00    	je     801033f9 <userinit+0xdb>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
80103341:	83 ec 04             	sub    $0x4,%esp
80103344:	68 2c 00 00 00       	push   $0x2c
80103349:	68 60 a4 10 80       	push   $0x8010a460
8010334e:	50                   	push   %eax
8010334f:	e8 9b 2f 00 00       	call   801062ef <inituvm>
  p->sz = PGSIZE;
80103354:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
8010335a:	8b 43 18             	mov    0x18(%ebx),%eax
8010335d:	83 c4 0c             	add    $0xc,%esp
80103360:	6a 4c                	push   $0x4c
80103362:	6a 00                	push   $0x0
80103364:	50                   	push   %eax
80103365:	e8 ab 0a 00 00       	call   80103e15 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010336a:	8b 43 18             	mov    0x18(%ebx),%eax
8010336d:	66 c7 40 3c 1b 00    	movw   $0x1b,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103373:	8b 43 18             	mov    0x18(%ebx),%eax
80103376:	66 c7 40 2c 23 00    	movw   $0x23,0x2c(%eax)
  p->tf->es = p->tf->ds;
8010337c:	8b 43 18             	mov    0x18(%ebx),%eax
8010337f:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103383:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103387:	8b 43 18             	mov    0x18(%ebx),%eax
8010338a:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
8010338e:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103392:	8b 43 18             	mov    0x18(%ebx),%eax
80103395:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
8010339c:	8b 43 18             	mov    0x18(%ebx),%eax
8010339f:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
801033a6:	8b 43 18             	mov    0x18(%ebx),%eax
801033a9:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
801033b0:	8d 43 6c             	lea    0x6c(%ebx),%eax
801033b3:	83 c4 0c             	add    $0xc,%esp
801033b6:	6a 10                	push   $0x10
801033b8:	68 08 6f 10 80       	push   $0x80106f08
801033bd:	50                   	push   %eax
801033be:	e8 be 0b 00 00       	call   80103f81 <safestrcpy>
  p->cwd = namei("/");
801033c3:	c7 04 24 11 6f 10 80 	movl   $0x80106f11,(%esp)
801033ca:	e8 fe e7 ff ff       	call   80101bcd <namei>
801033cf:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801033d2:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
801033d9:	e8 8b 09 00 00       	call   80103d69 <acquire>
  p->state = RUNNABLE;
801033de:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801033e5:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
801033ec:	e8 dd 09 00 00       	call   80103dce <release>
}
801033f1:	83 c4 10             	add    $0x10,%esp
801033f4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801033f7:	c9                   	leave  
801033f8:	c3                   	ret    
    panic("userinit: out of memory?");
801033f9:	83 ec 0c             	sub    $0xc,%esp
801033fc:	68 ef 6e 10 80       	push   $0x80106eef
80103401:	e8 42 cf ff ff       	call   80100348 <panic>

80103406 <growproc>:
{
80103406:	55                   	push   %ebp
80103407:	89 e5                	mov    %esp,%ebp
80103409:	56                   	push   %esi
8010340a:	53                   	push   %ebx
8010340b:	8b 75 08             	mov    0x8(%ebp),%esi
  struct proc *curproc = myproc();
8010340e:	e8 e8 fe ff ff       	call   801032fb <myproc>
80103413:	89 c3                	mov    %eax,%ebx
  sz = curproc->sz;
80103415:	8b 00                	mov    (%eax),%eax
  if(n > 0){
80103417:	85 f6                	test   %esi,%esi
80103419:	7f 1c                	jg     80103437 <growproc+0x31>
  } else if(n < 0){
8010341b:	78 37                	js     80103454 <growproc+0x4e>
  curproc->sz = sz;
8010341d:	89 03                	mov    %eax,(%ebx)
  switchuvm(curproc);
8010341f:	83 ec 0c             	sub    $0xc,%esp
80103422:	53                   	push   %ebx
80103423:	e8 53 2d 00 00       	call   8010617b <switchuvm>
  return 0;
80103428:	83 c4 10             	add    $0x10,%esp
8010342b:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
8010343a:	01 c6                	add    %eax,%esi
8010343c:	56                   	push   %esi
8010343d:	50                   	push   %eax
8010343e:	ff 73 04             	push   0x4(%ebx)
80103441:	e8 7f 30 00 00       	call   801064c5 <allocuvm>
80103446:	83 c4 10             	add    $0x10,%esp
80103449:	85 c0                	test   %eax,%eax
8010344b:	75 d0                	jne    8010341d <growproc+0x17>
      return -1;
8010344d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103452:	eb dc                	jmp    80103430 <growproc+0x2a>
    if((sz = deallocuvm(curproc->pgdir, sz, sz + n)) == 0)
80103454:	83 ec 04             	sub    $0x4,%esp
80103457:	01 c6                	add    %eax,%esi
80103459:	56                   	push   %esi
8010345a:	50                   	push   %eax
8010345b:	ff 73 04             	push   0x4(%ebx)
8010345e:	e8 bc 2f 00 00       	call   8010641f <deallocuvm>
80103463:	83 c4 10             	add    $0x10,%esp
80103466:	85 c0                	test   %eax,%eax
80103468:	75 b3                	jne    8010341d <growproc+0x17>
      return -1;
8010346a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010346f:	eb bf                	jmp    80103430 <growproc+0x2a>

80103471 <fork>:
{
80103471:	55                   	push   %ebp
80103472:	89 e5                	mov    %esp,%ebp
80103474:	57                   	push   %edi
80103475:	56                   	push   %esi
80103476:	53                   	push   %ebx
80103477:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *curproc = myproc();
8010347a:	e8 7c fe ff ff       	call   801032fb <myproc>
8010347f:	89 c3                	mov    %eax,%ebx
  if((np = allocproc()) == 0){
80103481:	e8 05 fc ff ff       	call   8010308b <allocproc>
80103486:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103489:	85 c0                	test   %eax,%eax
8010348b:	0f 84 f1 00 00 00    	je     80103582 <fork+0x111>
80103491:	89 c7                	mov    %eax,%edi
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103493:	83 ec 08             	sub    $0x8,%esp
80103496:	ff 33                	push   (%ebx)
80103498:	ff 73 04             	push   0x4(%ebx)
8010349b:	e8 5a 32 00 00       	call   801066fa <copyuvm>
801034a0:	89 47 04             	mov    %eax,0x4(%edi)
801034a3:	83 c4 10             	add    $0x10,%esp
801034a6:	85 c0                	test   %eax,%eax
801034a8:	74 3b                	je     801034e5 <fork+0x74>
  np->sz = curproc->sz;
801034aa:	8b 03                	mov    (%ebx),%eax
801034ac:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801034af:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
801034b1:	89 c8                	mov    %ecx,%eax
801034b3:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
801034b6:	8b 73 18             	mov    0x18(%ebx),%esi
801034b9:	8b 79 18             	mov    0x18(%ecx),%edi
801034bc:	b9 13 00 00 00       	mov    $0x13,%ecx
801034c1:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  setticket(np, curproc->tickets);
801034c3:	83 ec 08             	sub    $0x8,%esp
801034c6:	ff 73 7c             	push   0x7c(%ebx)
801034c9:	89 c7                	mov    %eax,%edi
801034cb:	50                   	push   %eax
801034cc:	e8 c5 fc ff ff       	call   80103196 <setticket>
  np->tf->eax = 0;
801034d1:	8b 47 18             	mov    0x18(%edi),%eax
801034d4:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
801034db:	83 c4 10             	add    $0x10,%esp
801034de:	be 00 00 00 00       	mov    $0x0,%esi
801034e3:	eb 3c                	jmp    80103521 <fork+0xb0>
    kfree(np->kstack);
801034e5:	83 ec 0c             	sub    $0xc,%esp
801034e8:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801034eb:	ff 73 08             	push   0x8(%ebx)
801034ee:	e8 99 ea ff ff       	call   80101f8c <kfree>
    np->kstack = 0;
...
80103509:	eb 6d                	jmp    80103578 <fork+0x107>
      np->ofile[i] = filedup(curproc->ofile[i]);
8010350b:	83 ec 0c             	sub    $0xc,%esp
8010350e:	50                   	push   %eax
8010350f:	e8 6a d7 ff ff       	call   80100c7e <filedup>
80103514:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103517:	89 44 b2 28          	mov    %eax,0x28(%edx,%esi,4)
8010351b:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NOFILE; i++)
8010351e:	83 c6 01             	add    $0x1,%esi
80103521:	83 fe 0f             	cmp    $0xf,%esi
80103524:	7f 0a                	jg     80103530 <fork+0xbf>
    if(curproc->ofile[i])
80103526:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
8010352a:	85 c0                	test   %eax,%eax
8010352c:	75 dd                	jne    8010350b <fork+0x9a>
8010352e:	eb ee                	jmp    8010351e <fork+0xad>
  np->cwd = idup(curproc->cwd);
80103530:	83 ec 0c             	sub    $0xc,%esp
80103533:	ff 73 68             	push   0x68(%ebx)
80103536:	e8 04 e0 ff ff       	call   8010153f <idup>
...
8010354e:	e8 2e 0a 00 00       	call   80103f81 <safestrcpy>
  pid = np->pid;
80103553:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103556:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
8010355d:	e8 07 08 00 00       	call   80103d69 <acquire>
  np->state = RUNNABLE;
80103562:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103569:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
80103570:	e8 59 08 00 00       	call   80103dce <release>
  return pid;
...
80103587:	eb ef                	jmp    80103578 <fork+0x107>
...
8010358e:	e8 68 fd ff ff       	call   801032fb <myproc>
80103593:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103595:	83 ec 0c             	sub    $0xc,%esp
80103598:	68 40 1d 11 80       	push   $0x80111d40
8010359d:	e8 88 07 00 00       	call   80103d2a <holding>
801035a2:	83 c4 10             	add    $0x10,%esp
801035a5:	85 c0                	test   %eax,%eax
801035a7:	74 4f                	je     801035f8 <sched+0x6f>
  if(mycpu()->ncli != 1)
801035a9:	e8 d6 fc ff ff       	call   80103284 <mycpu>
801035ae:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
801035b5:	75 4e                	jne    80103605 <sched+0x7c>
  if(p->state == RUNNING)
801035b7:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
801035bb:	74 55                	je     80103612 <sched+0x89>
801035bd:	9c                   	pushf  
801035be:	58                   	pop    %eax
  if(readeflags()&FL_IF)
801035bf:	f6 c4 02             	test   $0x2,%ah
801035c2:	75 5b                	jne    8010361f <sched+0x96>
  intena = mycpu()->intena;
801035c4:	e8 bb fc ff ff       	call   80103284 <mycpu>
801035c9:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
801035cf:	e8 b0 fc ff ff       	call   80103284 <mycpu>
801035d4:	83 ec 08             	sub    $0x8,%esp
801035d7:	ff 70 04             	push   0x4(%eax)
801035da:	83 c3 1c             	add    $0x1c,%ebx
801035dd:	53                   	push   %ebx
801035de:	e8 f3 09 00 00       	call   80103fd6 <swtch>
  mycpu()->intena = intena;
801035e3:	e8 9c fc ff ff       	call   80103284 <mycpu>
801035e8:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
801035ee:	83 c4 10             	add    $0x10,%esp
801035f1:	8d 65 f8             	lea    -0x8(%ebp),%esp
801035f4:	5b                   	pop    %ebx
801035f5:	5e                   	pop    %esi
801035f6:	5d                   	pop    %ebp
801035f7:	c3                   	ret    
...
801035fb:	68 13 6f 10 80       	push   $0x80106f13
80103600:	e8 43 cd ff ff       	call   80100348 <panic>
    panic("sched locks");
80103605:	83 ec 0c             	sub    $0xc,%esp
80103608:	68 25 6f 10 80       	push   $0x80106f25
8010360d:	e8 36 cd ff ff       	call   80100348 <panic>
    panic("sched running");
80103612:	83 ec 0c             	sub    $0xc,%esp
80103615:	68 31 6f 10 80       	push   $0x80106f31
8010361a:	e8 29 cd ff ff       	call   80100348 <panic>
    panic("sched interruptible");
8010361f:	83 ec 0c             	sub    $0xc,%esp
80103622:	68 3f 6f 10 80       	push   $0x80106f3f
80103627:	e8 1c cd ff ff       	call   80100348 <panic>
...
80103630:	53                   	push   %ebx
  struct proc *curproc = myproc();
80103631:	e8 c5 fc ff ff       	call   801032fb <myproc>
  if(curproc == initproc)
80103636:	39 05 74 3e 11 80    	cmp    %eax,0x80113e74
8010363c:	74 09                	je     80103647 <exit+0x1b>
8010363e:	89 c6                	mov    %eax,%esi
  for(fd = 0; fd < NOFILE; fd++){
80103640:	bb 00 00 00 00       	mov    $0x0,%ebx
80103645:	eb 24                	jmp    8010366b <exit+0x3f>
    panic("init exiting");
80103647:	83 ec 0c             	sub    $0xc,%esp
8010364a:	68 53 6f 10 80       	push   $0x80106f53
8010364f:	e8 f4 cc ff ff       	call   80100348 <panic>
      fileclose(curproc->ofile[fd]);
80103654:	83 ec 0c             	sub    $0xc,%esp
80103657:	50                   	push   %eax
80103658:	e8 66 d6 ff ff       	call   80100cc3 <fileclose>
      curproc->ofile[fd] = 0;
8010365d:	c7 44 9e 28 00 00 00 	movl   $0x0,0x28(%esi,%ebx,4)
80103664:	00 
80103665:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
80103668:	83 c3 01             	add    $0x1,%ebx
8010366b:	83 fb 0f             	cmp    $0xf,%ebx
8010366e:	7f 0a                	jg     8010367a <exit+0x4e>
    if(curproc->ofile[fd]){
80103670:	8b 44 9e 28          	mov    0x28(%esi,%ebx,4),%eax
80103674:	85 c0                	test   %eax,%eax
80103676:	75 dc                	jne    80103654 <exit+0x28>
80103678:	eb ee                	jmp    80103668 <exit+0x3c>
  begin_op();
8010367a:	e8 31 f1 ff ff       	call   801027b0 <begin_op>
  iput(curproc->cwd);
8010367f:	83 ec 0c             	sub    $0xc,%esp
80103682:	ff 76 68             	push   0x68(%esi)
80103685:	e8 ec df ff ff       	call   80101676 <iput>
  end_op();
8010368a:	e8 9b f1 ff ff       	call   8010282a <end_op>
  curproc->cwd = 0;
8010368f:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103696:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
8010369d:	e8 c7 06 00 00       	call   80103d69 <acquire>
  wakeup1(curproc->parent);
801036a2:	8b 46 14             	mov    0x14(%esi),%eax
801036a5:	e8 b7 f9 ff ff       	call   80103061 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801036aa:	83 c4 10             	add    $0x10,%esp
801036ad:	bb 74 1d 11 80       	mov    $0x80111d74,%ebx
801036b2:	eb 06                	jmp    801036ba <exit+0x8e>
801036b4:	81 c3 84 00 00 00    	add    $0x84,%ebx
801036ba:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
801036c0:	73 1a                	jae    801036dc <exit+0xb0>
    if(p->parent == curproc){
801036c2:	39 73 14             	cmp    %esi,0x14(%ebx)
801036c5:	75 ed                	jne    801036b4 <exit+0x88>
      p->parent = initproc;
801036c7:	a1 74 3e 11 80       	mov    0x80113e74,%eax
801036cc:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
801036cf:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801036d3:	75 df                	jne    801036b4 <exit+0x88>
        wakeup1(initproc);
801036d5:	e8 87 f9 ff ff       	call   80103061 <wakeup1>
801036da:	eb d8                	jmp    801036b4 <exit+0x88>
  curproc->state = ZOMBIE;
801036dc:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
801036e3:	e8 a1 fe ff ff       	call   80103589 <sched>
  panic("zombie exit");
801036e8:	83 ec 0c             	sub    $0xc,%esp
801036eb:	68 60 6f 10 80       	push   $0x80106f60
...
801036f8:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);  //DOC: yieldlock
801036fb:	68 40 1d 11 80       	push   $0x80111d40
80103700:	e8 64 06 00 00       	call   80103d69 <acquire>
  myproc()->state = RUNNABLE;
80103705:	e8 f1 fb ff ff       	call   801032fb <myproc>
8010370a:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80103711:	e8 73 fe ff ff       	call   80103589 <sched>
  release(&ptable.lock);
80103716:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
8010371d:	e8 ac 06 00 00       	call   80103dce <release>
}
...
8010372a:	56                   	push   %esi
8010372b:	53                   	push   %ebx
8010372c:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
8010372f:	e8 c7 fb ff ff       	call   801032fb <myproc>
  if(p == 0)
80103734:	85 c0                	test   %eax,%eax
80103736:	74 66                	je     8010379e <sleep+0x77>
80103738:	89 c3                	mov    %eax,%ebx
  if(lk == 0)
8010373a:	85 f6                	test   %esi,%esi
8010373c:	74 6d                	je     801037ab <sleep+0x84>
  if(lk != &ptable.lock){  //DOC: sleeplock0
8010373e:	81 fe 40 1d 11 80    	cmp    $0x80111d40,%esi
80103744:	74 18                	je     8010375e <sleep+0x37>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103746:	83 ec 0c             	sub    $0xc,%esp
80103749:	68 40 1d 11 80       	push   $0x80111d40
8010374e:	e8 16 06 00 00       	call   80103d69 <acquire>
    release(lk);
80103753:	89 34 24             	mov    %esi,(%esp)
80103756:	e8 73 06 00 00       	call   80103dce <release>
8010375b:	83 c4 10             	add    $0x10,%esp
  p->chan = chan;
8010375e:	8b 45 08             	mov    0x8(%ebp),%eax
80103761:	89 43 20             	mov    %eax,0x20(%ebx)
  p->state = SLEEPING;
80103764:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
8010376b:	e8 19 fe ff ff       	call   80103589 <sched>
  p->chan = 0;
80103770:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  if(lk != &ptable.lock){  //DOC: sleeplock2
80103777:	81 fe 40 1d 11 80    	cmp    $0x80111d40,%esi
8010377d:	74 18                	je     80103797 <sleep+0x70>
    release(&ptable.lock);
8010377f:	83 ec 0c             	sub    $0xc,%esp
80103782:	68 40 1d 11 80       	push   $0x80111d40
80103787:	e8 42 06 00 00       	call   80103dce <release>
    acquire(lk);
8010378c:	89 34 24             	mov    %esi,(%esp)
8010378f:	e8 d5 05 00 00       	call   80103d69 <acquire>
...
801037a1:	68 6c 6f 10 80       	push   $0x80106f6c
801037a6:	e8 9d cb ff ff       	call   80100348 <panic>
    panic("sleep without lk");
801037ab:	83 ec 0c             	sub    $0xc,%esp
801037ae:	68 72 6f 10 80       	push   $0x80106f72
801037b3:	e8 90 cb ff ff       	call   80100348 <panic>
...
801037bc:	53                   	push   %ebx
  struct proc *curproc = myproc();
801037bd:	e8 39 fb ff ff       	call   801032fb <myproc>
801037c2:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
801037c4:	83 ec 0c             	sub    $0xc,%esp
801037c7:	68 40 1d 11 80       	push   $0x80111d40
801037cc:	e8 98 05 00 00       	call   80103d69 <acquire>
801037d1:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801037d4:	b8 00 00 00 00       	mov    $0x0,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801037d9:	bb 74 1d 11 80       	mov    $0x80111d74,%ebx
801037de:	eb 5e                	jmp    8010383e <wait+0x86>
        pid = p->pid;
801037e0:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
801037e3:	83 ec 0c             	sub    $0xc,%esp
801037e6:	ff 73 08             	push   0x8(%ebx)
801037e9:	e8 9e e7 ff ff       	call   80101f8c <kfree>
        p->kstack = 0;
801037ee:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801037f5:	83 c4 04             	add    $0x4,%esp
801037f8:	ff 73 04             	push   0x4(%ebx)
801037fb:	e8 c7 2d 00 00       	call   801065c7 <freevm>
        p->pid = 0;
80103800:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103807:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
8010380e:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103812:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103819:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103820:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
80103827:	e8 a2 05 00 00       	call   80103dce <release>
        return pid;
8010382c:	83 c4 10             	add    $0x10,%esp
}
8010382f:	89 f0                	mov    %esi,%eax
...
80103837:	c3                   	ret    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103838:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010383e:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
80103844:	73 12                	jae    80103858 <wait+0xa0>
      if(p->parent != curproc)
80103846:	39 73 14             	cmp    %esi,0x14(%ebx)
80103849:	75 ed                	jne    80103838 <wait+0x80>
      if(p->state == ZOMBIE){
8010384b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010384f:	74 8f                	je     801037e0 <wait+0x28>
      havekids = 1;
80103851:	b8 01 00 00 00       	mov    $0x1,%eax
80103856:	eb e0                	jmp    80103838 <wait+0x80>
    if(!havekids || curproc->killed){
80103858:	85 c0                	test   %eax,%eax
8010385a:	74 06                	je     80103862 <wait+0xaa>
8010385c:	83 7e 24 00          	cmpl   $0x0,0x24(%esi)
80103860:	74 17                	je     80103879 <wait+0xc1>
      release(&ptable.lock);
80103862:	83 ec 0c             	sub    $0xc,%esp
80103865:	68 40 1d 11 80       	push   $0x80111d40
8010386a:	e8 5f 05 00 00       	call   80103dce <release>
      return -1;
8010386f:	83 c4 10             	add    $0x10,%esp
80103872:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103877:	eb b6                	jmp    8010382f <wait+0x77>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103879:	83 ec 08             	sub    $0x8,%esp
8010387c:	68 40 1d 11 80       	push   $0x80111d40
80103881:	56                   	push   %esi
80103882:	e8 a0 fe ff ff       	call   80103727 <sleep>
    havekids = 0;
80103887:	83 c4 10             	add    $0x10,%esp
8010388a:	e9 45 ff ff ff       	jmp    801037d4 <wait+0x1c>
...
80103892:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
80103895:	68 40 1d 11 80       	push   $0x80111d40
8010389a:	e8 ca 04 00 00       	call   80103d69 <acquire>
  wakeup1(chan);
8010389f:	8b 45 08             	mov    0x8(%ebp),%eax
801038a2:	e8 ba f7 ff ff       	call   80103061 <wakeup1>
  release(&ptable.lock);
801038a7:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
801038ae:	e8 1b 05 00 00       	call   80103dce <release>
}
...
801038bf:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801038c2:	68 40 1d 11 80       	push   $0x80111d40
801038c7:	e8 9d 04 00 00       	call   80103d69 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801038cc:	83 c4 10             	add    $0x10,%esp
801038cf:	b8 74 1d 11 80       	mov    $0x80111d74,%eax
801038d4:	eb 0e                	jmp    801038e4 <kill+0x2c>
    if(p->pid == pid){
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
        p->state = RUNNABLE;
801038d6:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
801038dd:	eb 1e                	jmp    801038fd <kill+0x45>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801038df:	05 84 00 00 00       	add    $0x84,%eax
801038e4:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
801038e9:	73 2c                	jae    80103917 <kill+0x5f>
    if(p->pid == pid){
801038eb:	39 58 10             	cmp    %ebx,0x10(%eax)
801038ee:	75 ef                	jne    801038df <kill+0x27>
      p->killed = 1;
801038f0:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
801038f7:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801038fb:	74 d9                	je     801038d6 <kill+0x1e>
      release(&ptable.lock);
801038fd:	83 ec 0c             	sub    $0xc,%esp
80103900:	68 40 1d 11 80       	push   $0x80111d40
80103905:	e8 c4 04 00 00       	call   80103dce <release>
      return 0;
...
8010391a:	68 40 1d 11 80       	push   $0x80111d40
8010391f:	e8 aa 04 00 00       	call   80103dce <release>
  return -1;
80103924:	83 c4 10             	add    $0x10,%esp
80103927:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010392c:	eb e4                	jmp    80103912 <kill+0x5a>
...
80103932:	53                   	push   %ebx
80103933:	83 ec 30             	sub    $0x30,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103936:	bb 74 1d 11 80       	mov    $0x80111d74,%ebx
8010393b:	eb 36                	jmp    80103973 <procdump+0x45>
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
8010393d:	b8 83 6f 10 80       	mov    $0x80106f83,%eax
    cprintf("%d %s %s", p->pid, state, p->name);
80103942:	8d 53 6c             	lea    0x6c(%ebx),%edx
80103945:	52                   	push   %edx
80103946:	50                   	push   %eax
80103947:	ff 73 10             	push   0x10(%ebx)
8010394a:	68 87 6f 10 80       	push   $0x80106f87
8010394f:	e8 b3 cc ff ff       	call   80100607 <cprintf>
    if(p->state == SLEEPING){
80103954:	83 c4 10             	add    $0x10,%esp
80103957:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
8010395b:	74 3c                	je     80103999 <procdump+0x6b>
...
80103960:	68 07 73 10 80       	push   $0x80107307
80103965:	e8 9d cc ff ff       	call   80100607 <cprintf>
8010396a:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010396d:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103973:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
80103979:	73 61                	jae    801039dc <procdump+0xae>
    if(p->state == UNUSED)
8010397b:	8b 43 0c             	mov    0xc(%ebx),%eax
8010397e:	85 c0                	test   %eax,%eax
80103980:	74 eb                	je     8010396d <procdump+0x3f>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103982:	83 f8 05             	cmp    $0x5,%eax
80103985:	77 b6                	ja     8010393d <procdump+0xf>
80103987:	8b 04 85 e4 6f 10 80 	mov    -0x7fef901c(,%eax,4),%eax
8010398e:	85 c0                	test   %eax,%eax
80103990:	75 b0                	jne    80103942 <procdump+0x14>
      state = "???";
80103992:	b8 83 6f 10 80       	mov    $0x80106f83,%eax
80103997:	eb a9                	jmp    80103942 <procdump+0x14>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80103999:	8b 43 1c             	mov    0x1c(%ebx),%eax
8010399c:	8b 40 0c             	mov    0xc(%eax),%eax
8010399f:	83 c0 08             	add    $0x8,%eax
801039a2:	83 ec 08             	sub    $0x8,%esp
801039a5:	8d 55 d0             	lea    -0x30(%ebp),%edx
801039a8:	52                   	push   %edx
801039a9:	50                   	push   %eax
801039aa:	e8 99 02 00 00       	call   80103c48 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
801039af:	83 c4 10             	add    $0x10,%esp
801039b2:	be 00 00 00 00       	mov    $0x0,%esi
801039b7:	eb 14                	jmp    801039cd <procdump+0x9f>
        cprintf(" %p", pc[i]);
801039b9:	83 ec 08             	sub    $0x8,%esp
801039bc:	50                   	push   %eax
801039bd:	68 21 69 10 80       	push   $0x80106921
801039c2:	e8 40 cc ff ff       	call   80100607 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
801039c7:	83 c6 01             	add    $0x1,%esi
801039ca:	83 c4 10             	add    $0x10,%esp
801039cd:	83 fe 09             	cmp    $0x9,%esi
801039d0:	7f 8b                	jg     8010395d <procdump+0x2f>
801039d2:	8b 44 b5 d0          	mov    -0x30(%ebp,%esi,4),%eax
801039d6:	85 c0                	test   %eax,%eax
801039d8:	75 df                	jne    801039b9 <procdump+0x8b>
801039da:	eb 81                	jmp    8010395d <procdump+0x2f>
  }
}
801039dc:	8d 65 f8             	lea    -0x8(%ebp),%esp
801039df:	5b                   	pop    %ebx
801039e0:	5e                   	pop    %esi
801039e1:	5d                   	pop    %ebp
801039e2:	c3                   	ret    

801039e3 <lcg_parkmiller>:
...
801039e8:	8b 4d 08             	mov    0x8(%ebp),%ecx
        Therefore:
...
801039eb:	8b 19                	mov    (%ecx),%ebx
801039ed:	ba 91 13 8f bc       	mov    $0xbc8f1391,%edx
801039f2:	89 d8                	mov    %ebx,%eax
801039f4:	f7 e2                	mul    %edx
801039f6:	c1 ea 0f             	shr    $0xf,%edx
    unsigned rem = *state % (N / G);  /* max : 2,147,483,646 % 44,488 = 44,487 */
801039f9:	69 f2 c8 ad 00 00    	imul   $0xadc8,%edx,%esi
801039ff:	89 d8                	mov    %ebx,%eax
80103a01:	29 f0                	sub    %esi,%eax

    unsigned a = rem * G;        /* max : 44,487 * 48,271 = 2,147,431,977 */
80103a03:	69 c0 8f bc 00 00    	imul   $0xbc8f,%eax,%eax
    unsigned b = div * (N % G);  /* max : 48,271 * 3,399 = 164,073,129 */
80103a09:	69 d2 47 0d 00 00    	imul   $0xd47,%edx,%edx

    return *state = (a > b) ? (a - b) : (a + (N - b));
80103a0f:	39 d0                	cmp    %edx,%eax
80103a11:	76 08                	jbe    80103a1b <lcg_parkmiller+0x38>
80103a13:	29 d0                	sub    %edx,%eax
80103a15:	89 01                	mov    %eax,(%ecx)
}
80103a17:	5b                   	pop    %ebx
80103a18:	5e                   	pop    %esi
80103a19:	5d                   	pop    %ebp
80103a1a:	c3                   	ret    
    return *state = (a > b) ? (a - b) : (a + (N - b));
80103a1b:	29 d0                	sub    %edx,%eax
80103a1d:	05 ff ff ff 7f       	add    $0x7fffffff,%eax
80103a22:	eb f1                	jmp    80103a15 <lcg_parkmiller+0x32>

80103a24 <next_random>:
...
80103a2a:	68 08 a0 10 80       	push   $0x8010a008
80103a2f:	e8 af ff ff ff       	call   801039e3 <lcg_parkmiller>
}
80103a34:	c9                   	leave  
80103a35:	c3                   	ret    
...
80103a3a:	53                   	push   %ebx
  struct cpu *c = mycpu();
80103a3b:	e8 44 f8 ff ff       	call   80103284 <mycpu>
80103a40:	89 c6                	mov    %eax,%esi
  c->proc = 0;
80103a42:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103a49:	00 00 00 
  lcg_parkmiller(&random_seed); 
80103a4c:	83 ec 0c             	sub    $0xc,%esp
80103a4f:	68 08 a0 10 80       	push   $0x8010a008
80103a54:	e8 8a ff ff ff       	call   801039e3 <lcg_parkmiller>
80103a59:	83 c4 10             	add    $0x10,%esp
80103a5c:	e9 a1 00 00 00       	jmp    80103b02 <scheduler+0xcc>
      runnableTickets += p->tickets;
80103a61:	03 58 7c             	add    0x7c(%eax),%ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a64:	05 84 00 00 00       	add    $0x84,%eax
80103a69:	3d 74 3e 11 80       	cmp    $0x80113e74,%eax
80103a6e:	73 08                	jae    80103a78 <scheduler+0x42>
      if(p->state != RUNNABLE)
80103a70:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103a74:	74 eb                	je     80103a61 <scheduler+0x2b>
80103a76:	eb ec                	jmp    80103a64 <scheduler+0x2e>
    int lotto = (((int) next_random()) % (runnableTickets + 1) );
80103a78:	e8 a7 ff ff ff       	call   80103a24 <next_random>
80103a7d:	83 c3 01             	add    $0x1,%ebx
80103a80:	99                   	cltd   
80103a81:	f7 fb                	idiv   %ebx
    int ticketProb = 0;
80103a83:	b8 00 00 00 00       	mov    $0x0,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a88:	bb 74 1d 11 80       	mov    $0x80111d74,%ebx
80103a8d:	eb 06                	jmp    80103a95 <scheduler+0x5f>
80103a8f:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103a95:	81 fb 74 3e 11 80    	cmp    $0x80113e74,%ebx
80103a9b:	73 55                	jae    80103af2 <scheduler+0xbc>
      if(p->state != RUNNABLE)
80103a9d:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103aa1:	75 ec                	jne    80103a8f <scheduler+0x59>
      ticketProb += p->tickets;
80103aa3:	03 43 7c             	add    0x7c(%ebx),%eax
      if(ticketProb < lotto)
80103aa6:	39 c2                	cmp    %eax,%edx
80103aa8:	7f e5                	jg     80103a8f <scheduler+0x59>
      if(ticketProb > lotto)
80103aaa:	7d e3                	jge    80103a8f <scheduler+0x59>
      c->proc = p;
80103aac:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
80103ab2:	83 ec 0c             	sub    $0xc,%esp
80103ab5:	53                   	push   %ebx
80103ab6:	e8 c0 26 00 00       	call   8010617b <switchuvm>
      p->state = RUNNING;
80103abb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ac2:	83 c4 08             	add    $0x8,%esp
80103ac5:	ff 73 1c             	push   0x1c(%ebx)
80103ac8:	8d 46 04             	lea    0x4(%esi),%eax
80103acb:	50                   	push   %eax
80103acc:	e8 05 05 00 00       	call   80103fd6 <swtch>
      switchkvm();
80103ad1:	e8 80 26 00 00       	call   80106156 <switchkvm>
      p->called++;
80103ad6:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
80103adc:	83 c0 01             	add    $0x1,%eax
80103adf:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
      c->proc = 0;
80103ae5:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103aec:	00 00 00 
      break;
80103aef:	83 c4 10             	add    $0x10,%esp
    release(&ptable.lock);
80103af2:	83 ec 0c             	sub    $0xc,%esp
80103af5:	68 40 1d 11 80       	push   $0x80111d40
80103afa:	e8 cf 02 00 00       	call   80103dce <release>
  for(;;){
...
80103b06:	68 40 1d 11 80       	push   $0x80111d40
80103b0b:	e8 59 02 00 00       	call   80103d69 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b10:	83 c4 10             	add    $0x10,%esp
    int runnableTickets = 0;
80103b13:	bb 00 00 00 00       	mov    $0x0,%ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b18:	b8 74 1d 11 80       	mov    $0x80111d74,%eax
80103b1d:	e9 47 ff ff ff       	jmp    80103a69 <scheduler+0x33>

80103b22 <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
80103b2c:	68 fc 6f 10 80       	push   $0x80106ffc
80103b31:	8d 43 04             	lea    0x4(%ebx),%eax
80103b34:	50                   	push   %eax
80103b35:	e8 f3 00 00 00       	call   80103c2d <initlock>
  lk->name = name;
80103b3a:	8b 45 0c             	mov    0xc(%ebp),%eax
80103b3d:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
...
80103b50:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103b53:	c9                   	leave  
80103b54:	c3                   	ret    

80103b55 <acquiresleep>:
...
80103b5a:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103b5d:	8d 73 04             	lea    0x4(%ebx),%esi
80103b60:	83 ec 0c             	sub    $0xc,%esp
80103b63:	56                   	push   %esi
80103b64:	e8 00 02 00 00       	call   80103d69 <acquire>
  while (lk->locked) {
80103b69:	83 c4 10             	add    $0x10,%esp
80103b6c:	eb 0d                	jmp    80103b7b <acquiresleep+0x26>
    sleep(lk, &lk->lk);
80103b6e:	83 ec 08             	sub    $0x8,%esp
80103b71:	56                   	push   %esi
80103b72:	53                   	push   %ebx
80103b73:	e8 af fb ff ff       	call   80103727 <sleep>
80103b78:	83 c4 10             	add    $0x10,%esp
  while (lk->locked) {
80103b7b:	83 3b 00             	cmpl   $0x0,(%ebx)
80103b7e:	75 ee                	jne    80103b6e <acquiresleep+0x19>
  }
  lk->locked = 1;
80103b80:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103b86:	e8 70 f7 ff ff       	call   801032fb <myproc>
80103b8b:	8b 40 10             	mov    0x10(%eax),%eax
80103b8e:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80103b91:	83 ec 0c             	sub    $0xc,%esp
80103b94:	56                   	push   %esi
80103b95:	e8 34 02 00 00       	call   80103dce <release>
}
...
80103ba9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103bac:	8d 73 04             	lea    0x4(%ebx),%esi
80103baf:	83 ec 0c             	sub    $0xc,%esp
80103bb2:	56                   	push   %esi
80103bb3:	e8 b1 01 00 00       	call   80103d69 <acquire>
  lk->locked = 0;
80103bb8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103bbe:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80103bc5:	89 1c 24             	mov    %ebx,(%esp)
80103bc8:	e8 c2 fc ff ff       	call   8010388f <wakeup>
  release(&lk->lk);
80103bcd:	89 34 24             	mov    %esi,(%esp)
80103bd0:	e8 f9 01 00 00       	call   80103dce <release>
}
...
80103be2:	56                   	push   %esi
80103be3:	53                   	push   %ebx
80103be4:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
80103be7:	8d 73 04             	lea    0x4(%ebx),%esi
80103bea:	83 ec 0c             	sub    $0xc,%esp
80103bed:	56                   	push   %esi
80103bee:	e8 76 01 00 00       	call   80103d69 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80103bf3:	83 c4 10             	add    $0x10,%esp
80103bf6:	83 3b 00             	cmpl   $0x0,(%ebx)
80103bf9:	75 17                	jne    80103c12 <holdingsleep+0x33>
80103bfb:	bb 00 00 00 00       	mov    $0x0,%ebx
  release(&lk->lk);
80103c00:	83 ec 0c             	sub    $0xc,%esp
80103c03:	56                   	push   %esi
80103c04:	e8 c5 01 00 00       	call   80103dce <release>
  return r;
}
80103c09:	89 d8                	mov    %ebx,%eax
80103c0b:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103c0e:	5b                   	pop    %ebx
80103c0f:	5e                   	pop    %esi
80103c10:	5d                   	pop    %ebp
80103c11:	c3                   	ret    
  r = lk->locked && (lk->pid == myproc()->pid);
80103c12:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80103c15:	e8 e1 f6 ff ff       	call   801032fb <myproc>
80103c1a:	3b 58 10             	cmp    0x10(%eax),%ebx
80103c1d:	74 07                	je     80103c26 <holdingsleep+0x47>
80103c1f:	bb 00 00 00 00       	mov    $0x0,%ebx
80103c24:	eb da                	jmp    80103c00 <holdingsleep+0x21>
80103c26:	bb 01 00 00 00       	mov    $0x1,%ebx
80103c2b:	eb d3                	jmp    80103c00 <holdingsleep+0x21>
...
80103c36:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80103c39:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80103c3f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80103c46:	5d                   	pop    %ebp
80103c47:	c3                   	ret    

80103c48 <getcallerpcs>:
}
...
80103c4c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  uint *ebp;
  int i;

  ebp = (uint*)v - 2;
80103c4f:	8b 45 08             	mov    0x8(%ebp),%eax
80103c52:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
80103c55:	b8 00 00 00 00       	mov    $0x0,%eax
80103c5a:	83 f8 09             	cmp    $0x9,%eax
80103c5d:	7f 25                	jg     80103c84 <getcallerpcs+0x3c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80103c5f:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80103c65:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80103c6b:	77 17                	ja     80103c84 <getcallerpcs+0x3c>
      break;
    pcs[i] = ebp[1];     // saved %eip
80103c6d:	8b 5a 04             	mov    0x4(%edx),%ebx
80103c70:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
    ebp = (uint*)ebp[0]; // saved %ebp
80103c73:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80103c75:	83 c0 01             	add    $0x1,%eax
80103c78:	eb e0                	jmp    80103c5a <getcallerpcs+0x12>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
80103c7a:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
  for(; i < 10; i++)
80103c81:	83 c0 01             	add    $0x1,%eax
80103c84:	83 f8 09             	cmp    $0x9,%eax
80103c87:	7e f1                	jle    80103c7a <getcallerpcs+0x32>
}
...
80103c97:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80103c98:	e8 e7 f5 ff ff       	call   80103284 <mycpu>
80103c9d:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103ca4:	74 11                	je     80103cb7 <pushcli+0x29>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80103ca6:	e8 d9 f5 ff ff       	call   80103284 <mycpu>
80103cab:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
80103cb2:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103cb5:	c9                   	leave  
80103cb6:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
80103cb7:	e8 c8 f5 ff ff       	call   80103284 <mycpu>
80103cbc:	81 e3 00 02 00 00    	and    $0x200,%ebx
80103cc2:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80103cc8:	eb dc                	jmp    80103ca6 <pushcli+0x18>
...
80103cd5:	75 28                	jne    80103cff <popcli+0x35>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80103cd7:	e8 a8 f5 ff ff       	call   80103284 <mycpu>
...
80103ced:	78 1d                	js     80103d0c <popcli+0x42>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103cef:	e8 90 f5 ff ff       	call   80103284 <mycpu>
80103cf4:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103cfb:	74 1c                	je     80103d19 <popcli+0x4f>
    sti();
}
80103cfd:	c9                   	leave  
80103cfe:	c3                   	ret    
...
80103d02:	68 07 70 10 80       	push   $0x80107007
80103d07:	e8 3c c6 ff ff       	call   80100348 <panic>
    panic("popcli");
80103d0c:	83 ec 0c             	sub    $0xc,%esp
80103d0f:	68 1e 70 10 80       	push   $0x8010701e
80103d14:	e8 2f c6 ff ff       	call   80100348 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103d19:	e8 66 f5 ff ff       	call   80103284 <mycpu>
80103d1e:	83 b8 a8 00 00 00 00 	cmpl   $0x0,0xa8(%eax)
80103d25:	74 d6                	je     80103cfd <popcli+0x33>
  asm volatile("sti");
80103d27:	fb                   	sti    
}
80103d28:	eb d3                	jmp    80103cfd <popcli+0x33>
...
80103d31:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80103d34:	e8 55 ff ff ff       	call   80103c8e <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80103d39:	83 3b 00             	cmpl   $0x0,(%ebx)
80103d3c:	75 11                	jne    80103d4f <holding+0x25>
80103d3e:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
80103d43:	e8 82 ff ff ff       	call   80103cca <popcli>
}
...
80103d4e:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80103d4f:	8b 5b 08             	mov    0x8(%ebx),%ebx
80103d52:	e8 2d f5 ff ff       	call   80103284 <mycpu>
80103d57:	39 c3                	cmp    %eax,%ebx
80103d59:	74 07                	je     80103d62 <holding+0x38>
80103d5b:	bb 00 00 00 00       	mov    $0x0,%ebx
80103d60:	eb e1                	jmp    80103d43 <holding+0x19>
80103d62:	bb 01 00 00 00       	mov    $0x1,%ebx
80103d67:	eb da                	jmp    80103d43 <holding+0x19>
...
80103d70:	e8 19 ff ff ff       	call   80103c8e <pushcli>
  if(holding(lk))
80103d75:	83 ec 0c             	sub    $0xc,%esp
80103d78:	ff 75 08             	push   0x8(%ebp)
80103d7b:	e8 aa ff ff ff       	call   80103d2a <holding>
80103d80:	83 c4 10             	add    $0x10,%esp
80103d83:	85 c0                	test   %eax,%eax
80103d85:	75 3a                	jne    80103dc1 <acquire+0x58>
...
80103d94:	75 f1                	jne    80103d87 <acquire+0x1e>
  __sync_synchronize();
80103d96:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80103d9b:	8b 5d 08             	mov    0x8(%ebp),%ebx
80103d9e:	e8 e1 f4 ff ff       	call   80103284 <mycpu>
...
80103db4:	e8 8f fe ff ff       	call   80103c48 <getcallerpcs>
}
...
80103dc4:	68 25 70 10 80       	push   $0x80107025
80103dc9:	e8 7a c5 ff ff       	call   80100348 <panic>
...
80103dd2:	83 ec 10             	sub    $0x10,%esp
80103dd5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
80103dd8:	53                   	push   %ebx
80103dd9:	e8 4c ff ff ff       	call   80103d2a <holding>
80103dde:	83 c4 10             	add    $0x10,%esp
80103de1:	85 c0                	test   %eax,%eax
80103de3:	74 23                	je     80103e08 <release+0x3a>
  lk->pcs[0] = 0;
80103de5:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80103dec:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80103df3:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80103df8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103dfe:	e8 c7 fe ff ff       	call   80103cca <popcli>
}
...
80103e0b:	68 2d 70 10 80       	push   $0x8010702d
80103e10:	e8 33 c5 ff ff       	call   80100348 <panic>
...
80103e18:	57                   	push   %edi
80103e19:	53                   	push   %ebx
80103e1a:	8b 55 08             	mov    0x8(%ebp),%edx
80103e1d:	8b 45 0c             	mov    0xc(%ebp),%eax
80103e20:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
80103e23:	f6 c2 03             	test   $0x3,%dl
80103e26:	75 25                	jne    80103e4d <memset+0x38>
80103e28:	f6 c1 03             	test   $0x3,%cl
80103e2b:	75 20                	jne    80103e4d <memset+0x38>
    c &= 0xFF;
80103e2d:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80103e30:	c1 e9 02             	shr    $0x2,%ecx
80103e33:	c1 e0 18             	shl    $0x18,%eax
80103e36:	89 fb                	mov    %edi,%ebx
80103e38:	c1 e3 10             	shl    $0x10,%ebx
80103e3b:	09 d8                	or     %ebx,%eax
80103e3d:	89 fb                	mov    %edi,%ebx
80103e3f:	c1 e3 08             	shl    $0x8,%ebx
80103e42:	09 d8                	or     %ebx,%eax
80103e44:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80103e46:	89 d7                	mov    %edx,%edi
80103e48:	fc                   	cld    
80103e49:	f3 ab                	rep stos %eax,%es:(%edi)
}
80103e4b:	eb 05                	jmp    80103e52 <memset+0x3d>
  asm volatile("cld; rep stosb" :
80103e4d:	89 d7                	mov    %edx,%edi
80103e4f:	fc                   	cld    
80103e50:	f3 aa                	rep stos %al,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
...
80103e5d:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103e60:	8b 55 0c             	mov    0xc(%ebp),%edx
80103e63:	8b 45 10             	mov    0x10(%ebp),%eax
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
80103e66:	eb 08                	jmp    80103e70 <memcmp+0x18>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
80103e68:	83 c1 01             	add    $0x1,%ecx
80103e6b:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80103e6e:	89 f0                	mov    %esi,%eax
80103e70:	8d 70 ff             	lea    -0x1(%eax),%esi
80103e73:	85 c0                	test   %eax,%eax
80103e75:	74 12                	je     80103e89 <memcmp+0x31>
    if(*s1 != *s2)
80103e77:	0f b6 01             	movzbl (%ecx),%eax
80103e7a:	0f b6 1a             	movzbl (%edx),%ebx
80103e7d:	38 d8                	cmp    %bl,%al
80103e7f:	74 e7                	je     80103e68 <memcmp+0x10>
      return *s1 - *s2;
80103e81:	0f b6 c0             	movzbl %al,%eax
80103e84:	0f b6 db             	movzbl %bl,%ebx
80103e87:	29 d8                	sub    %ebx,%eax
  }
...
80103e95:	8b 55 0c             	mov    0xc(%ebp),%edx
80103e98:	8b 45 10             	mov    0x10(%ebp),%eax
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80103e9b:	39 f2                	cmp    %esi,%edx
80103e9d:	73 3c                	jae    80103edb <memmove+0x4e>
80103e9f:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80103ea2:	39 f1                	cmp    %esi,%ecx
80103ea4:	76 39                	jbe    80103edf <memmove+0x52>
    s += n;
    d += n;
80103ea6:	8d 14 06             	lea    (%esi,%eax,1),%edx
    while(n-- > 0)
80103ea9:	eb 0d                	jmp    80103eb8 <memmove+0x2b>
      *--d = *--s;
80103eab:	83 e9 01             	sub    $0x1,%ecx
80103eae:	83 ea 01             	sub    $0x1,%edx
80103eb1:	0f b6 01             	movzbl (%ecx),%eax
80103eb4:	88 02                	mov    %al,(%edx)
    while(n-- > 0)
80103eb6:	89 d8                	mov    %ebx,%eax
80103eb8:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103ebb:	85 c0                	test   %eax,%eax
80103ebd:	75 ec                	jne    80103eab <memmove+0x1e>
80103ebf:	eb 14                	jmp    80103ed5 <memmove+0x48>
  } else
    while(n-- > 0)
      *d++ = *s++;
80103ec1:	0f b6 02             	movzbl (%edx),%eax
80103ec4:	88 01                	mov    %al,(%ecx)
80103ec6:	8d 49 01             	lea    0x1(%ecx),%ecx
80103ec9:	8d 52 01             	lea    0x1(%edx),%edx
    while(n-- > 0)
80103ecc:	89 d8                	mov    %ebx,%eax
80103ece:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103ed1:	85 c0                	test   %eax,%eax
80103ed3:	75 ec                	jne    80103ec1 <memmove+0x34>
...
80103ed9:	5d                   	pop    %ebp
80103eda:	c3                   	ret    
80103edb:	89 f1                	mov    %esi,%ecx
80103edd:	eb ef                	jmp    80103ece <memmove+0x41>
80103edf:	89 f1                	mov    %esi,%ecx
80103ee1:	eb eb                	jmp    80103ece <memmove+0x41>
...
80103ee9:	ff 75 10             	push   0x10(%ebp)
80103eec:	ff 75 0c             	push   0xc(%ebp)
80103eef:	ff 75 08             	push   0x8(%ebp)
80103ef2:	e8 96 ff ff ff       	call   80103e8d <memmove>
}
80103ef7:	c9                   	leave  
80103ef8:	c3                   	ret    
...
80103f03:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80103f06:	eb 09                	jmp    80103f11 <strncmp+0x18>
    n--, p++, q++;
80103f08:	83 e8 01             	sub    $0x1,%eax
80103f0b:	83 c2 01             	add    $0x1,%edx
80103f0e:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80103f11:	85 c0                	test   %eax,%eax
80103f13:	74 0b                	je     80103f20 <strncmp+0x27>
80103f15:	0f b6 1a             	movzbl (%edx),%ebx
80103f18:	84 db                	test   %bl,%bl
80103f1a:	74 04                	je     80103f20 <strncmp+0x27>
80103f1c:	3a 19                	cmp    (%ecx),%bl
80103f1e:	74 e8                	je     80103f08 <strncmp+0xf>
  if(n == 0)
80103f20:	85 c0                	test   %eax,%eax
80103f22:	74 0d                	je     80103f31 <strncmp+0x38>
    return 0;
  return (uchar)*p - (uchar)*q;
80103f24:	0f b6 02             	movzbl (%edx),%eax
80103f27:	0f b6 11             	movzbl (%ecx),%edx
80103f2a:	29 d0                	sub    %edx,%eax
}
80103f2c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103f2f:	c9                   	leave  
80103f30:	c3                   	ret    
    return 0;
80103f31:	b8 00 00 00 00       	mov    $0x0,%eax
80103f36:	eb f4                	jmp    80103f2c <strncmp+0x33>
...
80103f44:	8b 45 10             	mov    0x10(%ebp),%eax
  ...
  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80103f47:	89 fa                	mov    %edi,%edx
80103f49:	eb 04                	jmp    80103f4f <strncpy+0x17>
80103f4b:	89 f1                	mov    %esi,%ecx
80103f4d:	89 da                	mov    %ebx,%edx
80103f4f:	89 c3                	mov    %eax,%ebx
80103f51:	83 e8 01             	sub    $0x1,%eax
80103f54:	85 db                	test   %ebx,%ebx
80103f56:	7e 11                	jle    80103f69 <strncpy+0x31>
80103f58:	8d 71 01             	lea    0x1(%ecx),%esi
80103f5b:	8d 5a 01             	lea    0x1(%edx),%ebx
80103f5e:	0f b6 09             	movzbl (%ecx),%ecx
80103f61:	88 0a                	mov    %cl,(%edx)
80103f63:	84 c9                	test   %cl,%cl
80103f65:	75 e4                	jne    80103f4b <strncpy+0x13>
80103f67:	89 da                	mov    %ebx,%edx
    ;
  while(n-- > 0)
80103f69:	8d 48 ff             	lea    -0x1(%eax),%ecx
80103f6c:	85 c0                	test   %eax,%eax
80103f6e:	7e 0a                	jle    80103f7a <strncpy+0x42>
    *s++ = 0;
80103f70:	c6 02 00             	movb   $0x0,(%edx)
  while(n-- > 0)
80103f73:	89 c8                	mov    %ecx,%eax
    *s++ = 0;
80103f75:	8d 52 01             	lea    0x1(%edx),%edx
80103f78:	eb ef                	jmp    80103f69 <strncpy+0x31>
  return os;
}
...
80103f87:	8b 7d 08             	mov    0x8(%ebp),%edi
80103f8a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103f8d:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  if(n <= 0)
80103f90:	85 c0                	test   %eax,%eax
80103f92:	7e 23                	jle    80103fb7 <safestrcpy+0x36>
80103f94:	89 fa                	mov    %edi,%edx
80103f96:	eb 04                	jmp    80103f9c <safestrcpy+0x1b>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80103f98:	89 f1                	mov    %esi,%ecx
80103f9a:	89 da                	mov    %ebx,%edx
80103f9c:	83 e8 01             	sub    $0x1,%eax
80103f9f:	85 c0                	test   %eax,%eax
80103fa1:	7e 11                	jle    80103fb4 <safestrcpy+0x33>
80103fa3:	8d 71 01             	lea    0x1(%ecx),%esi
80103fa6:	8d 5a 01             	lea    0x1(%edx),%ebx
80103fa9:	0f b6 09             	movzbl (%ecx),%ecx
80103fac:	88 0a                	mov    %cl,(%edx)
80103fae:	84 c9                	test   %cl,%cl
80103fb0:	75 e6                	jne    80103f98 <safestrcpy+0x17>
80103fb2:	89 da                	mov    %ebx,%edx
    ;
  *s = 0;
80103fb4:	c6 02 00             	movb   $0x0,(%edx)
  return os;
}
80103fb7:	89 f8                	mov    %edi,%eax
80103fb9:	5b                   	pop    %ebx
80103fba:	5e                   	pop    %esi
80103fbb:	5f                   	pop    %edi
80103fbc:	5d                   	pop    %ebp
...
80103fc9:	eb 03                	jmp    80103fce <strlen+0x10>
80103fcb:	83 c0 01             	add    $0x1,%eax
80103fce:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80103fd2:	75 f7                	jne    80103fcb <strlen+0xd>
    ;
  return n;
}
80103fd4:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80103fd6:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80103fda:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80103fdf:	53                   	push   %ebx
  pushl %esi
80103fe0:	56                   	push   %esi
  pushl %edi
80103fe1:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
80103fe2:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80103fe4:	89 d4                	mov    %edx,%esp
...
80103ff2:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80103ff5:	e8 01 f3 ff ff       	call   801032fb <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80103ffa:	8b 00                	mov    (%eax),%eax
80103ffc:	39 d8                	cmp    %ebx,%eax
80103ffe:	76 18                	jbe    80104018 <fetchint+0x2d>
80104000:	8d 53 04             	lea    0x4(%ebx),%edx
80104003:	39 d0                	cmp    %edx,%eax
80104005:	72 18                	jb     8010401f <fetchint+0x34>
    return -1;
  *ip = *(int*)(addr);
80104007:	8b 13                	mov    (%ebx),%edx
80104009:	8b 45 0c             	mov    0xc(%ebp),%eax
8010400c:	89 10                	mov    %edx,(%eax)
  return 0;
8010400e:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104013:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104016:	c9                   	leave  
80104017:	c3                   	ret    
    return -1;
80104018:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010401d:	eb f4                	jmp    80104013 <fetchint+0x28>
8010401f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104024:	eb ed                	jmp    80104013 <fetchint+0x28>
...
8010402d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104030:	e8 c6 f2 ff ff       	call   801032fb <myproc>

  if(addr >= curproc->sz)
80104035:	39 18                	cmp    %ebx,(%eax)
80104037:	76 25                	jbe    8010405e <fetchstr+0x38>
    return -1;
  *pp = (char*)addr;
80104039:	8b 55 0c             	mov    0xc(%ebp),%edx
8010403c:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
8010403e:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80104040:	89 d8                	mov    %ebx,%eax
80104042:	eb 03                	jmp    80104047 <fetchstr+0x21>
80104044:	83 c0 01             	add    $0x1,%eax
80104047:	39 d0                	cmp    %edx,%eax
80104049:	73 09                	jae    80104054 <fetchstr+0x2e>
    if(*s == 0)
8010404b:	80 38 00             	cmpb   $0x0,(%eax)
8010404e:	75 f4                	jne    80104044 <fetchstr+0x1e>
      return s - *pp;
80104050:	29 d8                	sub    %ebx,%eax
80104052:	eb 05                	jmp    80104059 <fetchstr+0x33>
  }
  return -1;
...
80104063:	eb f4                	jmp    80104059 <fetchstr+0x33>
...
8010406b:	e8 8b f2 ff ff       	call   801032fb <myproc>
...
80104086:	e8 60 ff ff ff       	call   80103feb <fetchint>
}
8010408b:	c9                   	leave  
8010408c:	c3                   	ret    
...
80104095:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104098:	e8 5e f2 ff ff       	call   801032fb <myproc>
...
801040be:	39 c2                	cmp    %eax,%edx
801040c0:	76 25                	jbe    801040e7 <argptr+0x5a>
...
80104117:	e8 0a ff ff ff       	call   80104026 <fetchstr>
...
8010412c:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
8010412f:	e8 c7 f1 ff ff       	call   801032fb <myproc>
...
80104144:	8b 14 85 60 70 10 80 	mov    -0x7fef8fa0(,%eax,4),%edx
...
80104163:	68 35 70 10 80       	push   $0x80107035
80104168:	e8 9a c4 ff ff       	call   80100607 <cprintf>
    curproc->tf->eax = -1;
...
801041a2:	e8 54 f1 ff ff       	call   801032fb <myproc>
...
801041e6:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
801041e8:	e8 0e f1 ff ff       	call   801032fb <myproc>
801041ed:	89 c2                	mov    %eax,%edx

  for(fd = 0; fd < NOFILE; fd++){
801041ef:	b8 00 00 00 00       	mov    $0x0,%eax
801041f4:	83 f8 0f             	cmp    $0xf,%eax
801041f7:	7f 12                	jg     8010420b <fdalloc+0x2c>
    if(curproc->ofile[fd] == 0){
801041f9:	83 7c 82 28 00       	cmpl   $0x0,0x28(%edx,%eax,4)
801041fe:	74 05                	je     80104205 <fdalloc+0x26>
  for(fd = 0; fd < NOFILE; fd++){
80104200:	83 c0 01             	add    $0x1,%eax
80104203:	eb ef                	jmp    801041f4 <fdalloc+0x15>
      curproc->ofile[fd] = f;
80104205:	89 5c 82 28          	mov    %ebx,0x28(%edx,%eax,4)
      return fd;
80104209:	eb 05                	jmp    80104210 <fdalloc+0x31>
    }
  }
  return -1;
...
8010421d:	89 c3                	mov    %eax,%ebx
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
8010421f:	b8 20 00 00 00       	mov    $0x20,%eax
80104224:	89 c6                	mov    %eax,%esi
80104226:	39 43 58             	cmp    %eax,0x58(%ebx)
80104229:	76 2e                	jbe    80104259 <isdirempty+0x44>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010422b:	6a 10                	push   $0x10
8010422d:	50                   	push   %eax
8010422e:	8d 45 e8             	lea    -0x18(%ebp),%eax
80104231:	50                   	push   %eax
80104232:	53                   	push   %ebx
80104233:	e8 29 d5 ff ff       	call   80101761 <readi>
80104238:	83 c4 10             	add    $0x10,%esp
8010423b:	83 f8 10             	cmp    $0x10,%eax
8010423e:	75 0c                	jne    8010424c <isdirempty+0x37>
      panic("isdirempty: readi");
    if(de.inum != 0)
80104240:	66 83 7d e8 00       	cmpw   $0x0,-0x18(%ebp)
80104245:	75 1e                	jne    80104265 <isdirempty+0x50>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80104247:	8d 46 10             	lea    0x10(%esi),%eax
8010424a:	eb d8                	jmp    80104224 <isdirempty+0xf>
      panic("isdirempty: readi");
8010424c:	83 ec 0c             	sub    $0xc,%esp
8010424f:	68 c8 70 10 80       	push   $0x801070c8
80104254:	e8 ef c0 ff ff       	call   80100348 <panic>
      return 0;
  }
  return 1;
80104259:	b8 01 00 00 00       	mov    $0x1,%eax
}
...
8010426a:	eb f2                	jmp    8010425e <isdirempty+0x49>
...
8010426f:	57                   	push   %edi
80104270:	56                   	push   %esi
80104271:	53                   	push   %ebx
80104272:	83 ec 34             	sub    $0x34,%esp
80104275:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104278:	89 4d d0             	mov    %ecx,-0x30(%ebp)
8010427b:	8b 7d 08             	mov    0x8(%ebp),%edi
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010427e:	8d 55 da             	lea    -0x26(%ebp),%edx
80104281:	52                   	push   %edx
80104282:	50                   	push   %eax
80104283:	e8 5d d9 ff ff       	call   80101be5 <nameiparent>
80104288:	89 c6                	mov    %eax,%esi
8010428a:	83 c4 10             	add    $0x10,%esp
8010428d:	85 c0                	test   %eax,%eax
8010428f:	0f 84 33 01 00 00    	je     801043c8 <create+0x15c>
    return 0;
  ilock(dp);
80104295:	83 ec 0c             	sub    $0xc,%esp
80104298:	50                   	push   %eax
80104299:	e8 d1 d2 ff ff       	call   8010156f <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
8010429e:	83 c4 0c             	add    $0xc,%esp
801042a1:	6a 00                	push   $0x0
801042a3:	8d 45 da             	lea    -0x26(%ebp),%eax
801042a6:	50                   	push   %eax
801042a7:	56                   	push   %esi
801042a8:	e8 f2 d6 ff ff       	call   8010199f <dirlookup>
801042ad:	89 c3                	mov    %eax,%ebx
801042af:	83 c4 10             	add    $0x10,%esp
801042b2:	85 c0                	test   %eax,%eax
801042b4:	74 3d                	je     801042f3 <create+0x87>
    iunlockput(dp);
801042b6:	83 ec 0c             	sub    $0xc,%esp
801042b9:	56                   	push   %esi
801042ba:	e8 57 d4 ff ff       	call   80101716 <iunlockput>
    ilock(ip);
801042bf:	89 1c 24             	mov    %ebx,(%esp)
801042c2:	e8 a8 d2 ff ff       	call   8010156f <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801042c7:	83 c4 10             	add    $0x10,%esp
801042ca:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801042cf:	75 07                	jne    801042d8 <create+0x6c>
801042d1:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
801042d6:	74 11                	je     801042e9 <create+0x7d>
      return ip;
    iunlockput(ip);
801042d8:	83 ec 0c             	sub    $0xc,%esp
801042db:	53                   	push   %ebx
801042dc:	e8 35 d4 ff ff       	call   80101716 <iunlockput>
    return 0;
...
801042f6:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
801042fa:	50                   	push   %eax
801042fb:	ff 36                	push   (%esi)
801042fd:	e8 6a d0 ff ff       	call   8010136c <ialloc>
80104302:	89 c3                	mov    %eax,%ebx
80104304:	83 c4 10             	add    $0x10,%esp
80104307:	85 c0                	test   %eax,%eax
80104309:	74 52                	je     8010435d <create+0xf1>
  ilock(ip);
8010430b:	83 ec 0c             	sub    $0xc,%esp
8010430e:	50                   	push   %eax
8010430f:	e8 5b d2 ff ff       	call   8010156f <ilock>
  ip->major = major;
80104314:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104318:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
8010431c:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
80104320:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
80104326:	89 1c 24             	mov    %ebx,(%esp)
80104329:	e8 e0 d0 ff ff       	call   8010140e <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
8010432e:	83 c4 10             	add    $0x10,%esp
80104331:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80104336:	74 32                	je     8010436a <create+0xfe>
  if(dirlink(dp, name, ip->inum) < 0)
80104338:	83 ec 04             	sub    $0x4,%esp
8010433b:	ff 73 04             	push   0x4(%ebx)
8010433e:	8d 45 da             	lea    -0x26(%ebp),%eax
80104341:	50                   	push   %eax
80104342:	56                   	push   %esi
80104343:	e8 d4 d7 ff ff       	call   80101b1c <dirlink>
80104348:	83 c4 10             	add    $0x10,%esp
8010434b:	85 c0                	test   %eax,%eax
8010434d:	78 6c                	js     801043bb <create+0x14f>
  iunlockput(dp);
8010434f:	83 ec 0c             	sub    $0xc,%esp
80104352:	56                   	push   %esi
80104353:	e8 be d3 ff ff       	call   80101716 <iunlockput>
  return ip;
80104358:	83 c4 10             	add    $0x10,%esp
8010435b:	eb 8c                	jmp    801042e9 <create+0x7d>
    panic("create: ialloc");
8010435d:	83 ec 0c             	sub    $0xc,%esp
80104360:	68 da 70 10 80       	push   $0x801070da
80104365:	e8 de bf ff ff       	call   80100348 <panic>
    dp->nlink++;  // for ".."
8010436a:	0f b7 46 56          	movzwl 0x56(%esi),%eax
8010436e:	83 c0 01             	add    $0x1,%eax
80104371:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104375:	83 ec 0c             	sub    $0xc,%esp
80104378:	56                   	push   %esi
80104379:	e8 90 d0 ff ff       	call   8010140e <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010437e:	83 c4 0c             	add    $0xc,%esp
80104381:	ff 73 04             	push   0x4(%ebx)
80104384:	68 ea 70 10 80       	push   $0x801070ea
80104389:	53                   	push   %ebx
8010438a:	e8 8d d7 ff ff       	call   80101b1c <dirlink>
8010438f:	83 c4 10             	add    $0x10,%esp
80104392:	85 c0                	test   %eax,%eax
80104394:	78 18                	js     801043ae <create+0x142>
80104396:	83 ec 04             	sub    $0x4,%esp
80104399:	ff 76 04             	push   0x4(%esi)
8010439c:	68 e9 70 10 80       	push   $0x801070e9
801043a1:	53                   	push   %ebx
801043a2:	e8 75 d7 ff ff       	call   80101b1c <dirlink>
801043a7:	83 c4 10             	add    $0x10,%esp
801043aa:	85 c0                	test   %eax,%eax
801043ac:	79 8a                	jns    80104338 <create+0xcc>
      panic("create dots");
801043ae:	83 ec 0c             	sub    $0xc,%esp
801043b1:	68 ec 70 10 80       	push   $0x801070ec
801043b6:	e8 8d bf ff ff       	call   80100348 <panic>
    panic("create: dirlink");
801043bb:	83 ec 0c             	sub    $0xc,%esp
801043be:	68 f8 70 10 80       	push   $0x801070f8
801043c3:	e8 80 bf ff ff       	call   80100348 <panic>
    return 0;
801043c8:	89 c3                	mov    %eax,%ebx
801043ca:	e9 1a ff ff ff       	jmp    801042e9 <create+0x7d>
...
801043d3:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
801043d6:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801043d9:	ba 00 00 00 00       	mov    $0x0,%edx
801043de:	b8 00 00 00 00       	mov    $0x0,%eax
801043e3:	e8 97 fd ff ff       	call   8010417f <argfd>
801043e8:	85 c0                	test   %eax,%eax
801043ea:	78 23                	js     8010440f <sys_dup+0x40>
  if((fd=fdalloc(f)) < 0)
801043ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043ef:	e8 eb fd ff ff       	call   801041df <fdalloc>
801043f4:	89 c3                	mov    %eax,%ebx
801043f6:	85 c0                	test   %eax,%eax
801043f8:	78 1c                	js     80104416 <sys_dup+0x47>
  filedup(f);
801043fa:	83 ec 0c             	sub    $0xc,%esp
801043fd:	ff 75 f4             	push   -0xc(%ebp)
80104400:	e8 79 c8 ff ff       	call   80100c7e <filedup>
  return fd;
...
8010440e:	c3                   	ret    
    return -1;
8010440f:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104414:	eb f2                	jmp    80104408 <sys_dup+0x39>
    return -1;
80104416:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010441b:	eb eb                	jmp    80104408 <sys_dup+0x39>
...
80104423:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104426:	ba 00 00 00 00       	mov    $0x0,%edx
8010442b:	b8 00 00 00 00       	mov    $0x0,%eax
80104430:	e8 4a fd ff ff       	call   8010417f <argfd>
80104435:	85 c0                	test   %eax,%eax
80104437:	78 43                	js     8010447c <sys_read+0x5f>
80104439:	83 ec 08             	sub    $0x8,%esp
8010443c:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010443f:	50                   	push   %eax
80104440:	6a 02                	push   $0x2
80104442:	e8 1e fc ff ff       	call   80104065 <argint>
80104447:	83 c4 10             	add    $0x10,%esp
8010444a:	85 c0                	test   %eax,%eax
8010444c:	78 2e                	js     8010447c <sys_read+0x5f>
8010444e:	83 ec 04             	sub    $0x4,%esp
80104451:	ff 75 f0             	push   -0x10(%ebp)
80104454:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104457:	50                   	push   %eax
80104458:	6a 01                	push   $0x1
8010445a:	e8 2e fc ff ff       	call   8010408d <argptr>
8010445f:	83 c4 10             	add    $0x10,%esp
80104462:	85 c0                	test   %eax,%eax
80104464:	78 16                	js     8010447c <sys_read+0x5f>
  return fileread(f, p, n);
80104466:	83 ec 04             	sub    $0x4,%esp
80104469:	ff 75 f0             	push   -0x10(%ebp)
8010446c:	ff 75 ec             	push   -0x14(%ebp)
8010446f:	ff 75 f4             	push   -0xc(%ebp)
80104472:	e8 59 c9 ff ff       	call   80100dd0 <fileread>
...
80104481:	eb f7                	jmp    8010447a <sys_read+0x5d>
...
801044c0:	e8 c8 fb ff ff       	call   8010408d <argptr>
801044c5:	83 c4 10             	add    $0x10,%esp
801044c8:	85 c0                	test   %eax,%eax
801044ca:	78 16                	js     801044e2 <sys_write+0x5f>
...
801044d8:	e8 78 c9 ff ff       	call   80100e55 <filewrite>
...
801044e7:	eb f7                	jmp    801044e0 <sys_write+0x5d>
...
801044ec:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
801044ef:	8d 4d f0             	lea    -0x10(%ebp),%ecx
801044f2:	8d 55 f4             	lea    -0xc(%ebp),%edx
801044f5:	b8 00 00 00 00       	mov    $0x0,%eax
801044fa:	e8 80 fc ff ff       	call   8010417f <argfd>
801044ff:	85 c0                	test   %eax,%eax
80104501:	78 25                	js     80104528 <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
80104503:	e8 f3 ed ff ff       	call   801032fb <myproc>
80104508:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010450b:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104512:	00 
  fileclose(f);
80104513:	83 ec 0c             	sub    $0xc,%esp
80104516:	ff 75 f0             	push   -0x10(%ebp)
80104519:	e8 a5 c7 ff ff       	call   80100cc3 <fileclose>
  return 0;
...
8010452d:	eb f7                	jmp    80104526 <sys_close+0x3d>
...
80104535:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104538:	ba 00 00 00 00       	mov    $0x0,%edx
8010453d:	b8 00 00 00 00       	mov    $0x0,%eax
80104542:	e8 38 fc ff ff       	call   8010417f <argfd>
80104547:	85 c0                	test   %eax,%eax
80104549:	78 2a                	js     80104575 <sys_fstat+0x46>
8010454b:	83 ec 04             	sub    $0x4,%esp
8010454e:	6a 14                	push   $0x14
80104550:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104553:	50                   	push   %eax
80104554:	6a 01                	push   $0x1
80104556:	e8 32 fb ff ff       	call   8010408d <argptr>
8010455b:	83 c4 10             	add    $0x10,%esp
8010455e:	85 c0                	test   %eax,%eax
80104560:	78 13                	js     80104575 <sys_fstat+0x46>
  return filestat(f, st);
80104562:	83 ec 08             	sub    $0x8,%esp
80104565:	ff 75 f0             	push   -0x10(%ebp)
80104568:	ff 75 f4             	push   -0xc(%ebp)
8010456b:	e8 19 c8 ff ff       	call   80100d89 <filestat>
...
8010457a:	eb f7                	jmp    80104573 <sys_fstat+0x44>
...
80104581:	83 ec 28             	sub    $0x28,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104584:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104587:	50                   	push   %eax
80104588:	6a 00                	push   $0x0
8010458a:	e8 66 fb ff ff       	call   801040f5 <argstr>
8010458f:	83 c4 10             	add    $0x10,%esp
80104592:	85 c0                	test   %eax,%eax
80104594:	0f 88 d3 00 00 00    	js     8010466d <sys_link+0xf1>
8010459a:	83 ec 08             	sub    $0x8,%esp
8010459d:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801045a0:	50                   	push   %eax
801045a1:	6a 01                	push   $0x1
801045a3:	e8 4d fb ff ff       	call   801040f5 <argstr>
801045a8:	83 c4 10             	add    $0x10,%esp
801045ab:	85 c0                	test   %eax,%eax
801045ad:	0f 88 ba 00 00 00    	js     8010466d <sys_link+0xf1>
  begin_op();
801045b3:	e8 f8 e1 ff ff       	call   801027b0 <begin_op>
  if((ip = namei(old)) == 0){
801045b8:	83 ec 0c             	sub    $0xc,%esp
801045bb:	ff 75 e0             	push   -0x20(%ebp)
801045be:	e8 0a d6 ff ff       	call   80101bcd <namei>
801045c3:	89 c3                	mov    %eax,%ebx
801045c5:	83 c4 10             	add    $0x10,%esp
801045c8:	85 c0                	test   %eax,%eax
801045ca:	0f 84 a4 00 00 00    	je     80104674 <sys_link+0xf8>
  ilock(ip);
801045d0:	83 ec 0c             	sub    $0xc,%esp
801045d3:	50                   	push   %eax
801045d4:	e8 96 cf ff ff       	call   8010156f <ilock>
  if(ip->type == T_DIR){
801045d9:	83 c4 10             	add    $0x10,%esp
801045dc:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801045e1:	0f 84 99 00 00 00    	je     80104680 <sys_link+0x104>
  ip->nlink++;
801045e7:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801045eb:	83 c0 01             	add    $0x1,%eax
801045ee:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801045f2:	83 ec 0c             	sub    $0xc,%esp
801045f5:	53                   	push   %ebx
801045f6:	e8 13 ce ff ff       	call   8010140e <iupdate>
  iunlock(ip);
801045fb:	89 1c 24             	mov    %ebx,(%esp)
801045fe:	e8 2e d0 ff ff       	call   80101631 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104603:	83 c4 08             	add    $0x8,%esp
80104606:	8d 45 ea             	lea    -0x16(%ebp),%eax
80104609:	50                   	push   %eax
8010460a:	ff 75 e4             	push   -0x1c(%ebp)
8010460d:	e8 d3 d5 ff ff       	call   80101be5 <nameiparent>
80104612:	89 c6                	mov    %eax,%esi
80104614:	83 c4 10             	add    $0x10,%esp
80104617:	85 c0                	test   %eax,%eax
80104619:	0f 84 85 00 00 00    	je     801046a4 <sys_link+0x128>
  ilock(dp);
...
8010462d:	39 06                	cmp    %eax,(%esi)
8010462f:	75 67                	jne    80104698 <sys_link+0x11c>
80104631:	83 ec 04             	sub    $0x4,%esp
80104634:	ff 73 04             	push   0x4(%ebx)
80104637:	8d 45 ea             	lea    -0x16(%ebp),%eax
8010463a:	50                   	push   %eax
8010463b:	56                   	push   %esi
8010463c:	e8 db d4 ff ff       	call   80101b1c <dirlink>
80104641:	83 c4 10             	add    $0x10,%esp
80104644:	85 c0                	test   %eax,%eax
80104646:	78 50                	js     80104698 <sys_link+0x11c>
  iunlockput(dp);
80104648:	83 ec 0c             	sub    $0xc,%esp
8010464b:	56                   	push   %esi
8010464c:	e8 c5 d0 ff ff       	call   80101716 <iunlockput>
  iput(ip);
80104651:	89 1c 24             	mov    %ebx,(%esp)
80104654:	e8 1d d0 ff ff       	call   80101676 <iput>
  end_op();
80104659:	e8 cc e1 ff ff       	call   8010282a <end_op>
  return 0;
...
80104672:	eb f2                	jmp    80104666 <sys_link+0xea>
    end_op();
80104674:	e8 b1 e1 ff ff       	call   8010282a <end_op>
    return -1;
80104679:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010467e:	eb e6                	jmp    80104666 <sys_link+0xea>
    iunlockput(ip);
80104680:	83 ec 0c             	sub    $0xc,%esp
80104683:	53                   	push   %ebx
80104684:	e8 8d d0 ff ff       	call   80101716 <iunlockput>
    end_op();
80104689:	e8 9c e1 ff ff       	call   8010282a <end_op>
    return -1;
8010468e:	83 c4 10             	add    $0x10,%esp
80104691:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104696:	eb ce                	jmp    80104666 <sys_link+0xea>
    iunlockput(dp);
80104698:	83 ec 0c             	sub    $0xc,%esp
8010469b:	56                   	push   %esi
8010469c:	e8 75 d0 ff ff       	call   80101716 <iunlockput>
    goto bad;
801046a1:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
801046a4:	83 ec 0c             	sub    $0xc,%esp
801046a7:	53                   	push   %ebx
801046a8:	e8 c2 ce ff ff       	call   8010156f <ilock>
  ip->nlink--;
801046ad:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801046b1:	83 e8 01             	sub    $0x1,%eax
801046b4:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801046b8:	89 1c 24             	mov    %ebx,(%esp)
801046bb:	e8 4e cd ff ff       	call   8010140e <iupdate>
  iunlockput(ip);
801046c0:	89 1c 24             	mov    %ebx,(%esp)
801046c3:	e8 4e d0 ff ff       	call   80101716 <iunlockput>
  end_op();
801046c8:	e8 5d e1 ff ff       	call   8010282a <end_op>
  return -1;
801046cd:	83 c4 10             	add    $0x10,%esp
801046d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046d5:	eb 8f                	jmp    80104666 <sys_link+0xea>
...
801046dd:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
801046e0:	8d 45 c4             	lea    -0x3c(%ebp),%eax
801046e3:	50                   	push   %eax
801046e4:	6a 00                	push   $0x0
801046e6:	e8 0a fa ff ff       	call   801040f5 <argstr>
801046eb:	83 c4 10             	add    $0x10,%esp
801046ee:	85 c0                	test   %eax,%eax
801046f0:	0f 88 83 01 00 00    	js     80104879 <sys_unlink+0x1a2>
  begin_op();
801046f6:	e8 b5 e0 ff ff       	call   801027b0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801046fb:	83 ec 08             	sub    $0x8,%esp
801046fe:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104701:	50                   	push   %eax
80104702:	ff 75 c4             	push   -0x3c(%ebp)
80104705:	e8 db d4 ff ff       	call   80101be5 <nameiparent>
8010470a:	89 c6                	mov    %eax,%esi
8010470c:	83 c4 10             	add    $0x10,%esp
8010470f:	85 c0                	test   %eax,%eax
80104711:	0f 84 ed 00 00 00    	je     80104804 <sys_unlink+0x12d>
  ilock(dp);
80104717:	83 ec 0c             	sub    $0xc,%esp
8010471a:	50                   	push   %eax
8010471b:	e8 4f ce ff ff       	call   8010156f <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104720:	83 c4 08             	add    $0x8,%esp
80104723:	68 ea 70 10 80       	push   $0x801070ea
80104728:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010472b:	50                   	push   %eax
8010472c:	e8 59 d2 ff ff       	call   8010198a <namecmp>
80104731:	83 c4 10             	add    $0x10,%esp
80104734:	85 c0                	test   %eax,%eax
80104736:	0f 84 fc 00 00 00    	je     80104838 <sys_unlink+0x161>
8010473c:	83 ec 08             	sub    $0x8,%esp
8010473f:	68 e9 70 10 80       	push   $0x801070e9
80104744:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104747:	50                   	push   %eax
80104748:	e8 3d d2 ff ff       	call   8010198a <namecmp>
8010474d:	83 c4 10             	add    $0x10,%esp
80104750:	85 c0                	test   %eax,%eax
80104752:	0f 84 e0 00 00 00    	je     80104838 <sys_unlink+0x161>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104758:	83 ec 04             	sub    $0x4,%esp
8010475b:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010475e:	50                   	push   %eax
8010475f:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104762:	50                   	push   %eax
80104763:	56                   	push   %esi
80104764:	e8 36 d2 ff ff       	call   8010199f <dirlookup>
80104769:	89 c3                	mov    %eax,%ebx
8010476b:	83 c4 10             	add    $0x10,%esp
8010476e:	85 c0                	test   %eax,%eax
80104770:	0f 84 c2 00 00 00    	je     80104838 <sys_unlink+0x161>
  ilock(ip);
80104776:	83 ec 0c             	sub    $0xc,%esp
80104779:	50                   	push   %eax
8010477a:	e8 f0 cd ff ff       	call   8010156f <ilock>
  if(ip->nlink < 1)
8010477f:	83 c4 10             	add    $0x10,%esp
80104782:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104787:	0f 8e 83 00 00 00    	jle    80104810 <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010478d:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104792:	0f 84 85 00 00 00    	je     8010481d <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
80104798:	83 ec 04             	sub    $0x4,%esp
8010479b:	6a 10                	push   $0x10
8010479d:	6a 00                	push   $0x0
8010479f:	8d 7d d8             	lea    -0x28(%ebp),%edi
801047a2:	57                   	push   %edi
801047a3:	e8 6d f6 ff ff       	call   80103e15 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801047a8:	6a 10                	push   $0x10
801047aa:	ff 75 c0             	push   -0x40(%ebp)
801047ad:	57                   	push   %edi
801047ae:	56                   	push   %esi
801047af:	e8 aa d0 ff ff       	call   8010185e <writei>
801047b4:	83 c4 20             	add    $0x20,%esp
801047b7:	83 f8 10             	cmp    $0x10,%eax
801047ba:	0f 85 90 00 00 00    	jne    80104850 <sys_unlink+0x179>
  if(ip->type == T_DIR){
801047c0:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801047c5:	0f 84 92 00 00 00    	je     8010485d <sys_unlink+0x186>
  iunlockput(dp);
801047cb:	83 ec 0c             	sub    $0xc,%esp
801047ce:	56                   	push   %esi
801047cf:	e8 42 cf ff ff       	call   80101716 <iunlockput>
  ip->nlink--;
801047d4:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801047d8:	83 e8 01             	sub    $0x1,%eax
801047db:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801047df:	89 1c 24             	mov    %ebx,(%esp)
801047e2:	e8 27 cc ff ff       	call   8010140e <iupdate>
  iunlockput(ip);
801047e7:	89 1c 24             	mov    %ebx,(%esp)
801047ea:	e8 27 cf ff ff       	call   80101716 <iunlockput>
  end_op();
801047ef:	e8 36 e0 ff ff       	call   8010282a <end_op>
  return 0;
...
8010480e:	eb ec                	jmp    801047fc <sys_unlink+0x125>
    panic("unlink: nlink < 1");
80104810:	83 ec 0c             	sub    $0xc,%esp
80104813:	68 08 71 10 80       	push   $0x80107108
80104818:	e8 2b bb ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010481d:	89 d8                	mov    %ebx,%eax
8010481f:	e8 f1 f9 ff ff       	call   80104215 <isdirempty>
80104824:	85 c0                	test   %eax,%eax
80104826:	0f 85 6c ff ff ff    	jne    80104798 <sys_unlink+0xc1>
    iunlockput(ip);
8010482c:	83 ec 0c             	sub    $0xc,%esp
8010482f:	53                   	push   %ebx
80104830:	e8 e1 ce ff ff       	call   80101716 <iunlockput>
    goto bad;
80104835:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
80104838:	83 ec 0c             	sub    $0xc,%esp
8010483b:	56                   	push   %esi
8010483c:	e8 d5 ce ff ff       	call   80101716 <iunlockput>
  end_op();
80104841:	e8 e4 df ff ff       	call   8010282a <end_op>
  return -1;
80104846:	83 c4 10             	add    $0x10,%esp
80104849:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010484e:	eb ac                	jmp    801047fc <sys_unlink+0x125>
    panic("unlink: writei");
80104850:	83 ec 0c             	sub    $0xc,%esp
80104853:	68 1a 71 10 80       	push   $0x8010711a
80104858:	e8 eb ba ff ff       	call   80100348 <panic>
    dp->nlink--;
8010485d:	0f b7 46 56          	movzwl 0x56(%esi),%eax
80104861:	83 e8 01             	sub    $0x1,%eax
80104864:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104868:	83 ec 0c             	sub    $0xc,%esp
8010486b:	56                   	push   %esi
8010486c:	e8 9d cb ff ff       	call   8010140e <iupdate>
80104871:	83 c4 10             	add    $0x10,%esp
80104874:	e9 52 ff ff ff       	jmp    801047cb <sys_unlink+0xf4>
    return -1;
80104879:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010487e:	e9 79 ff ff ff       	jmp    801047fc <sys_unlink+0x125>
...
80104889:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
8010488c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010488f:	50                   	push   %eax
80104890:	6a 00                	push   $0x0
80104892:	e8 5e f8 ff ff       	call   801040f5 <argstr>
80104897:	83 c4 10             	add    $0x10,%esp
8010489a:	85 c0                	test   %eax,%eax
8010489c:	0f 88 a0 00 00 00    	js     80104942 <sys_open+0xbf>
801048a2:	83 ec 08             	sub    $0x8,%esp
801048a5:	8d 45 e0             	lea    -0x20(%ebp),%eax
801048a8:	50                   	push   %eax
801048a9:	6a 01                	push   $0x1
801048ab:	e8 b5 f7 ff ff       	call   80104065 <argint>
801048b0:	83 c4 10             	add    $0x10,%esp
801048b3:	85 c0                	test   %eax,%eax
801048b5:	0f 88 87 00 00 00    	js     80104942 <sys_open+0xbf>
    return -1;

  begin_op();
801048bb:	e8 f0 de ff ff       	call   801027b0 <begin_op>

  if(omode & O_CREATE){
801048c0:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
801048c4:	0f 84 8b 00 00 00    	je     80104955 <sys_open+0xd2>
    ip = create(path, T_FILE, 0, 0);
801048ca:	83 ec 0c             	sub    $0xc,%esp
801048cd:	6a 00                	push   $0x0
801048cf:	b9 00 00 00 00       	mov    $0x0,%ecx
801048d4:	ba 02 00 00 00       	mov    $0x2,%edx
801048d9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801048dc:	e8 8b f9 ff ff       	call   8010426c <create>
801048e1:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801048e3:	83 c4 10             	add    $0x10,%esp
801048e6:	85 c0                	test   %eax,%eax
801048e8:	74 5f                	je     80104949 <sys_open+0xc6>
      end_op();
      return -1;
    }
  }
...
801048ea:	e8 2e c3 ff ff       	call   80100c1d <filealloc>
801048ef:	89 c3                	mov    %eax,%ebx
801048f1:	85 c0                	test   %eax,%eax
801048f3:	0f 84 b5 00 00 00    	je     801049ae <sys_open+0x12b>
801048f9:	e8 e1 f8 ff ff       	call   801041df <fdalloc>
801048fe:	89 c7                	mov    %eax,%edi
80104900:	85 c0                	test   %eax,%eax
80104902:	0f 88 a6 00 00 00    	js     801049ae <sys_open+0x12b>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
8010490c:	e8 20 cd ff ff       	call   80101631 <iunlock>
  end_op();
80104911:	e8 14 df ff ff       	call   8010282a <end_op>

  f->type = FD_INODE;
80104916:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
8010491c:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
8010491f:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80104926:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104929:	83 c4 10             	add    $0x10,%esp
8010492c:	a8 01                	test   $0x1,%al
8010492e:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80104932:	a8 03                	test   $0x3,%al
80104934:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
80104938:	89 f8                	mov    %edi,%eax
...
80104941:	c3                   	ret    
    return -1;
80104942:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104947:	eb ef                	jmp    80104938 <sys_open+0xb5>
      end_op();
80104949:	e8 dc de ff ff       	call   8010282a <end_op>
      return -1;
8010494e:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104953:	eb e3                	jmp    80104938 <sys_open+0xb5>
    if((ip = namei(path)) == 0){
80104955:	83 ec 0c             	sub    $0xc,%esp
80104958:	ff 75 e4             	push   -0x1c(%ebp)
8010495b:	e8 6d d2 ff ff       	call   80101bcd <namei>
80104960:	89 c6                	mov    %eax,%esi
80104962:	83 c4 10             	add    $0x10,%esp
80104965:	85 c0                	test   %eax,%eax
80104967:	74 39                	je     801049a2 <sys_open+0x11f>
    ilock(ip);
80104969:	83 ec 0c             	sub    $0xc,%esp
8010496c:	50                   	push   %eax
8010496d:	e8 fd cb ff ff       	call   8010156f <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104972:	83 c4 10             	add    $0x10,%esp
80104975:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
8010497a:	0f 85 6a ff ff ff    	jne    801048ea <sys_open+0x67>
80104980:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104984:	0f 84 60 ff ff ff    	je     801048ea <sys_open+0x67>
      iunlockput(ip);
8010498a:	83 ec 0c             	sub    $0xc,%esp
8010498d:	56                   	push   %esi
8010498e:	e8 83 cd ff ff       	call   80101716 <iunlockput>
      end_op();
80104993:	e8 92 de ff ff       	call   8010282a <end_op>
      return -1;
80104998:	83 c4 10             	add    $0x10,%esp
8010499b:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801049a0:	eb 96                	jmp    80104938 <sys_open+0xb5>
      end_op();
801049a2:	e8 83 de ff ff       	call   8010282a <end_op>
      return -1;
801049a7:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801049ac:	eb 8a                	jmp    80104938 <sys_open+0xb5>
    if(f)
801049ae:	85 db                	test   %ebx,%ebx
801049b0:	74 0c                	je     801049be <sys_open+0x13b>
      fileclose(f);
801049b2:	83 ec 0c             	sub    $0xc,%esp
801049b5:	53                   	push   %ebx
801049b6:	e8 08 c3 ff ff       	call   80100cc3 <fileclose>
801049bb:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801049be:	83 ec 0c             	sub    $0xc,%esp
801049c1:	56                   	push   %esi
801049c2:	e8 4f cd ff ff       	call   80101716 <iunlockput>
    end_op();
801049c7:	e8 5e de ff ff       	call   8010282a <end_op>
    return -1;
801049cc:	83 c4 10             	add    $0x10,%esp
801049cf:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801049d4:	e9 5f ff ff ff       	jmp    80104938 <sys_open+0xb5>
...
80104a1b:	e8 f6 cc ff ff       	call   80101716 <iunlockput>
  end_op();
80104a20:	e8 05 de ff ff       	call   8010282a <end_op>
  return 0;
80104a25:	83 c4 10             	add    $0x10,%esp
80104a28:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104a2d:	c9                   	leave  
80104a2e:	c3                   	ret    
    end_op();
80104a2f:	e8 f6 dd ff ff       	call   8010282a <end_op>
    return -1;
80104a34:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a39:	eb f2                	jmp    80104a2d <sys_mkdir+0x54>
...
80104aa9:	e8 68 cc ff ff       	call   80101716 <iunlockput>
  end_op();
80104aae:	e8 77 dd ff ff       	call   8010282a <end_op>
  return 0;
...
80104abc:	c3                   	ret    
    end_op();
80104abd:	e8 68 dd ff ff       	call   8010282a <end_op>
    return -1;
80104ac2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ac7:	eb f2                	jmp    80104abb <sys_mknod+0x80>
...
80104ace:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80104ad1:	e8 25 e8 ff ff       	call   801032fb <myproc>
80104ad6:	89 c6                	mov    %eax,%esi
  
  begin_op();
80104ad8:	e8 d3 dc ff ff       	call   801027b0 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80104add:	83 ec 08             	sub    $0x8,%esp
80104ae0:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104ae3:	50                   	push   %eax
80104ae4:	6a 00                	push   $0x0
80104ae6:	e8 0a f6 ff ff       	call   801040f5 <argstr>
80104aeb:	83 c4 10             	add    $0x10,%esp
80104aee:	85 c0                	test   %eax,%eax
80104af0:	78 52                	js     80104b44 <sys_chdir+0x7b>
80104af2:	83 ec 0c             	sub    $0xc,%esp
80104af5:	ff 75 f4             	push   -0xc(%ebp)
80104af8:	e8 d0 d0 ff ff       	call   80101bcd <namei>
80104afd:	89 c3                	mov    %eax,%ebx
80104aff:	83 c4 10             	add    $0x10,%esp
80104b02:	85 c0                	test   %eax,%eax
80104b04:	74 3e                	je     80104b44 <sys_chdir+0x7b>
    end_op();
    return -1;
  }
  ilock(ip);
...
80104b0a:	e8 60 ca ff ff       	call   8010156f <ilock>
  if(ip->type != T_DIR){
80104b0f:	83 c4 10             	add    $0x10,%esp
80104b12:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104b17:	75 37                	jne    80104b50 <sys_chdir+0x87>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80104b1d:	e8 0f cb ff ff       	call   80101631 <iunlock>
  iput(curproc->cwd);
80104b22:	83 c4 04             	add    $0x4,%esp
80104b25:	ff 76 68             	push   0x68(%esi)
80104b28:	e8 49 cb ff ff       	call   80101676 <iput>
  end_op();
80104b2d:	e8 f8 dc ff ff       	call   8010282a <end_op>
  curproc->cwd = ip;
80104b32:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
80104b35:	83 c4 10             	add    $0x10,%esp
80104b38:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80104b43:	c3                   	ret    
    end_op();
80104b44:	e8 e1 dc ff ff       	call   8010282a <end_op>
    return -1;
80104b49:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b4e:	eb ed                	jmp    80104b3d <sys_chdir+0x74>
    iunlockput(ip);
80104b50:	83 ec 0c             	sub    $0xc,%esp
80104b53:	53                   	push   %ebx
80104b54:	e8 bd cb ff ff       	call   80101716 <iunlockput>
    end_op();
80104b59:	e8 cc dc ff ff       	call   8010282a <end_op>
    return -1;
80104b5e:	83 c4 10             	add    $0x10,%esp
80104b61:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b66:	eb d5                	jmp    80104b3d <sys_chdir+0x74>
...
80104b6c:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
...
80104b78:	e8 78 f5 ff ff       	call   801040f5 <argstr>
80104b7d:	83 c4 10             	add    $0x10,%esp
80104b80:	85 c0                	test   %eax,%eax
80104b82:	78 38                	js     80104bbc <sys_exec+0x54>
80104b84:	83 ec 08             	sub    $0x8,%esp
80104b87:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80104b8d:	50                   	push   %eax
80104b8e:	6a 01                	push   $0x1
80104b90:	e8 d0 f4 ff ff       	call   80104065 <argint>
80104b95:	83 c4 10             	add    $0x10,%esp
80104b98:	85 c0                	test   %eax,%eax
80104b9a:	78 20                	js     80104bbc <sys_exec+0x54>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80104b9c:	83 ec 04             	sub    $0x4,%esp
80104b9f:	68 80 00 00 00       	push   $0x80
80104ba4:	6a 00                	push   $0x0
80104ba6:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104bac:	50                   	push   %eax
80104bad:	e8 63 f2 ff ff       	call   80103e15 <memset>
80104bb2:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104bb5:	bb 00 00 00 00       	mov    $0x0,%ebx
80104bba:	eb 2c                	jmp    80104be8 <sys_exec+0x80>
    return -1;
80104bbc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bc1:	eb 78                	jmp    80104c3b <sys_exec+0xd3>
    if(i >= NELEM(argv))
      return -1;
    ...
    if(uarg == 0){
      argv[i] = 0;
80104bc3:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104bca:	00 00 00 00 
      break;
    }
...
80104bdb:	e8 ee bc ff ff       	call   801008ce <exec>
80104be0:	83 c4 10             	add    $0x10,%esp
80104be3:	eb 56                	jmp    80104c3b <sys_exec+0xd3>
  for(i=0;; i++){
80104be5:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104be8:	83 fb 1f             	cmp    $0x1f,%ebx
80104beb:	77 49                	ja     80104c36 <sys_exec+0xce>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80104bed:	83 ec 08             	sub    $0x8,%esp
80104bf0:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80104bf6:	50                   	push   %eax
80104bf7:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
80104bfd:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80104c00:	50                   	push   %eax
80104c01:	e8 e5 f3 ff ff       	call   80103feb <fetchint>
80104c06:	83 c4 10             	add    $0x10,%esp
80104c09:	85 c0                	test   %eax,%eax
80104c0b:	78 33                	js     80104c40 <sys_exec+0xd8>
    if(uarg == 0){
80104c0d:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80104c13:	85 c0                	test   %eax,%eax
80104c15:	74 ac                	je     80104bc3 <sys_exec+0x5b>
    if(fetchstr(uarg, &argv[i]) < 0)
80104c17:	83 ec 08             	sub    $0x8,%esp
80104c1a:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
80104c21:	52                   	push   %edx
80104c22:	50                   	push   %eax
80104c23:	e8 fe f3 ff ff       	call   80104026 <fetchstr>
80104c28:	83 c4 10             	add    $0x10,%esp
80104c2b:	85 c0                	test   %eax,%eax
80104c2d:	79 b6                	jns    80104be5 <sys_exec+0x7d>
      return -1;
80104c2f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c34:	eb 05                	jmp    80104c3b <sys_exec+0xd3>
      return -1;
...
80104c45:	eb f4                	jmp    80104c3b <sys_exec+0xd3>
...
80104c56:	e8 32 f4 ff ff       	call   8010408d <argptr>
80104c5b:	83 c4 10             	add    $0x10,%esp
80104c5e:	85 c0                	test   %eax,%eax
80104c60:	78 79                	js     80104cdb <sys_pipe+0x94>
    return -1;
...
80104c6d:	e8 fa e0 ff ff       	call   80102d6c <pipealloc>
80104c72:	83 c4 10             	add    $0x10,%esp
80104c75:	85 c0                	test   %eax,%eax
80104c77:	78 69                	js     80104ce2 <sys_pipe+0x9b>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104c79:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c7c:	e8 5e f5 ff ff       	call   801041df <fdalloc>
...
80104c8a:	e8 50 f5 ff ff       	call   801041df <fdalloc>
...
80104caa:	79 20                	jns    80104ccc <sys_pipe+0x85>
    fileclose(rf);
80104cac:	83 ec 0c             	sub    $0xc,%esp
80104caf:	ff 75 f0             	push   -0x10(%ebp)
80104cb2:	e8 0c c0 ff ff       	call   80100cc3 <fileclose>
    fileclose(wf);
80104cb7:	83 c4 04             	add    $0x4,%esp
80104cba:	ff 75 ec             	push   -0x14(%ebp)
80104cbd:	e8 01 c0 ff ff       	call   80100cc3 <fileclose>
    return -1;
80104cc2:	83 c4 10             	add    $0x10,%esp
80104cc5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cca:	eb d7                	jmp    80104ca3 <sys_pipe+0x5c>
      myproc()->ofile[fd0] = 0;
80104ccc:	e8 2a e6 ff ff       	call   801032fb <myproc>
80104cd1:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80104cd8:	00 
80104cd9:	eb d1                	jmp    80104cac <sys_pipe+0x65>
    return -1;
80104cdb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ce0:	eb c1                	jmp    80104ca3 <sys_pipe+0x5c>
    return -1;
80104ce2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ce7:	eb ba                	jmp    80104ca3 <sys_pipe+0x5c>
...
80104cec:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104cef:	e8 7d e7 ff ff       	call   80103471 <fork>
}
80104cf4:	c9                   	leave  
80104cf5:	c3                   	ret    
...
80104cf9:	83 ec 08             	sub    $0x8,%esp
  exit();
80104cfc:	e8 2b e9 ff ff       	call   8010362c <exit>
...
80104d0b:	83 ec 08             	sub    $0x8,%esp
  return wait();
80104d0e:	e8 a5 ea ff ff       	call   801037b8 <wait>
}
80104d13:	c9                   	leave  
80104d14:	c3                   	ret    
...
80104d18:	83 ec 20             	sub    $0x20,%esp
  int pid;
...
80104d21:	e8 3f f3 ff ff       	call   80104065 <argint>
80104d26:	83 c4 10             	add    $0x10,%esp
80104d29:	85 c0                	test   %eax,%eax
80104d2b:	78 10                	js     80104d3d <sys_kill+0x28>
    return -1;
  return kill(pid);
80104d2d:	83 ec 0c             	sub    $0xc,%esp
80104d30:	ff 75 f4             	push   -0xc(%ebp)
80104d33:	e8 80 eb ff ff       	call   801038b8 <kill>
...
80104d42:	eb f7                	jmp    80104d3b <sys_kill+0x26>
...
80104d47:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104d4a:	e8 ac e5 ff ff       	call   801032fb <myproc>
80104d4f:	8b 40 10             	mov    0x10(%eax),%eax
}
80104d52:	c9                   	leave  
80104d53:	c3                   	ret    
...
80104d61:	e8 ff f2 ff ff       	call   80104065 <argint>
80104d66:	83 c4 10             	add    $0x10,%esp
80104d69:	85 c0                	test   %eax,%eax
80104d6b:	78 20                	js     80104d8d <sys_sbrk+0x39>
    return -1;
  addr = myproc()->sz;
80104d6d:	e8 89 e5 ff ff       	call   801032fb <myproc>
80104d72:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104d74:	83 ec 0c             	sub    $0xc,%esp
80104d77:	ff 75 f4             	push   -0xc(%ebp)
80104d7a:	e8 87 e6 ff ff       	call   80103406 <growproc>
80104d7f:	83 c4 10             	add    $0x10,%esp
80104d82:	85 c0                	test   %eax,%eax
80104d84:	78 0e                	js     80104d94 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80104d86:	89 d8                	mov    %ebx,%eax
80104d88:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104d8b:	c9                   	leave  
80104d8c:	c3                   	ret    
    return -1;
80104d8d:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104d92:	eb f2                	jmp    80104d86 <sys_sbrk+0x32>
    return -1;
80104d94:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104d99:	eb eb                	jmp    80104d86 <sys_sbrk+0x32>
...
80104da8:	e8 b8 f2 ff ff       	call   80104065 <argint>
80104dad:	83 c4 10             	add    $0x10,%esp
80104db0:	85 c0                	test   %eax,%eax
80104db2:	78 75                	js     80104e29 <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104db4:	83 ec 0c             	sub    $0xc,%esp
80104db7:	68 a0 3e 11 80       	push   $0x80113ea0
80104dbc:	e8 a8 ef ff ff       	call   80103d69 <acquire>
  ticks0 = ticks;
80104dc1:	8b 1d 80 3e 11 80    	mov    0x80113e80,%ebx
  while(ticks - ticks0 < n){
80104dc7:	83 c4 10             	add    $0x10,%esp
80104dca:	a1 80 3e 11 80       	mov    0x80113e80,%eax
80104dcf:	29 d8                	sub    %ebx,%eax
80104dd1:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104dd4:	73 39                	jae    80104e0f <sys_sleep+0x74>
    if(myproc()->killed){
80104dd6:	e8 20 e5 ff ff       	call   801032fb <myproc>
80104ddb:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ddf:	75 17                	jne    80104df8 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104de1:	83 ec 08             	sub    $0x8,%esp
80104de4:	68 a0 3e 11 80       	push   $0x80113ea0
80104de9:	68 80 3e 11 80       	push   $0x80113e80
80104dee:	e8 34 e9 ff ff       	call   80103727 <sleep>
80104df3:	83 c4 10             	add    $0x10,%esp
80104df6:	eb d2                	jmp    80104dca <sys_sleep+0x2f>
      release(&tickslock);
80104df8:	83 ec 0c             	sub    $0xc,%esp
80104dfb:	68 a0 3e 11 80       	push   $0x80113ea0
80104e00:	e8 c9 ef ff ff       	call   80103dce <release>
      return -1;
80104e05:	83 c4 10             	add    $0x10,%esp
80104e08:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e0d:	eb 15                	jmp    80104e24 <sys_sleep+0x89>
  }
  release(&tickslock);
80104e0f:	83 ec 0c             	sub    $0xc,%esp
80104e12:	68 a0 3e 11 80       	push   $0x80113ea0
80104e17:	e8 b2 ef ff ff       	call   80103dce <release>
  return 0;
80104e1c:	83 c4 10             	add    $0x10,%esp
80104e1f:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80104e2e:	eb f4                	jmp    80104e24 <sys_sleep+0x89>
...
80104e34:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80104e37:	68 a0 3e 11 80       	push   $0x80113ea0
80104e3c:	e8 28 ef ff ff       	call   80103d69 <acquire>
  xticks = ticks;
80104e41:	8b 1d 80 3e 11 80    	mov    0x80113e80,%ebx
  release(&tickslock);
80104e47:	c7 04 24 a0 3e 11 80 	movl   $0x80113ea0,(%esp)
80104e4e:	e8 7b ef ff ff       	call   80103dce <release>
  return xticks;
}
...
80104e5d:	83 ec 08             	sub    $0x8,%esp
  yield();
80104e60:	e8 90 e8 ff ff       	call   801036f5 <yield>
  return 0;
}
...
80104e6f:	83 ec 08             	sub    $0x8,%esp
  shutdown();
80104e72:	e8 84 d3 ff ff       	call   801021fb <shutdown>
  return 0;
}
...
80104e82:	83 ec 1c             	sub    $0x1c,%esp
  int tickets;
  argint(0, &tickets);
80104e85:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104e88:	50                   	push   %eax
80104e89:	6a 00                	push   $0x0
80104e8b:	e8 d5 f1 ff ff       	call   80104065 <argint>
  return setticket(myproc(), tickets);
80104e90:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80104e93:	e8 63 e4 ff ff       	call   801032fb <myproc>
80104e98:	83 c4 08             	add    $0x8,%esp
80104e9b:	53                   	push   %ebx
80104e9c:	50                   	push   %eax
80104e9d:	e8 f4 e2 ff ff       	call   80103196 <setticket>
}
80104ea2:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104ea5:	c9                   	leave  
80104ea6:	c3                   	ret    

80104ea7 <sys_getprocessesinfo>:
...
80104eb5:	e8 d3 f1 ff ff       	call   8010408d <argptr>
80104eba:	83 c4 10             	add    $0x10,%esp
80104ebd:	85 c0                	test   %eax,%eax
80104ebf:	75 10                	jne    80104ed1 <sys_getprocessesinfo+0x2a>
    return -1; // invalid ptr
  return getprocinfo(pi);
80104ec1:	83 ec 0c             	sub    $0xc,%esp
80104ec4:	ff 75 f4             	push   -0xc(%ebp)
80104ec7:	e8 19 e3 ff ff       	call   801031e5 <getprocinfo>
...
80104ed6:	eb f7                	jmp    80104ecf <sys_getprocessesinfo+0x28>
...
80104ed9:	06                   	push   %es
  pushl %fs
80104eda:	0f a0                	push   %fs
  pushl %gs
80104edc:	0f a8                	push   %gs
  pushal
80104ede:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104edf:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104ee3:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104ee5:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104ee7:	54                   	push   %esp
  call trap
80104ee8:	e8 37 01 00 00       	call   80105024 <trap>
  addl $4, %esp
...
80104ef0:	61                   	popa   
  popl %gs
80104ef1:	0f a9                	pop    %gs
  popl %fs
80104ef3:	0f a1                	pop    %fs
  popl %es
80104ef5:	07                   	pop    %es
  popl %ds
80104ef6:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80104ef7:	83 c4 08             	add    $0x8,%esp
  iret
80104efa:	cf                   	iret   
...
80104f07:	eb 76                	jmp    80104f7f <tvinit+0x84>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104f09:	8b 0c 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%ecx
80104f10:	66 89 0c c5 e0 3e 11 	mov    %cx,-0x7feec120(,%eax,8)
80104f17:	80 
80104f18:	66 c7 04 c5 e2 3e 11 	movw   $0x8,-0x7feec11e(,%eax,8)
80104f1f:	80 08 00 
80104f22:	0f b6 14 c5 e4 3e 11 	movzbl -0x7feec11c(,%eax,8),%edx
80104f29:	80 
80104f2a:	83 e2 e0             	and    $0xffffffe0,%edx
80104f2d:	88 14 c5 e4 3e 11 80 	mov    %dl,-0x7feec11c(,%eax,8)
80104f34:	c6 04 c5 e4 3e 11 80 	movb   $0x0,-0x7feec11c(,%eax,8)
80104f3b:	00 
80104f3c:	0f b6 14 c5 e5 3e 11 	movzbl -0x7feec11b(,%eax,8),%edx
80104f43:	80 
80104f44:	83 e2 f0             	and    $0xfffffff0,%edx
80104f47:	83 ca 0e             	or     $0xe,%edx
80104f4a:	88 14 c5 e5 3e 11 80 	mov    %dl,-0x7feec11b(,%eax,8)
80104f51:	89 d3                	mov    %edx,%ebx
80104f53:	83 e3 ef             	and    $0xffffffef,%ebx
80104f56:	88 1c c5 e5 3e 11 80 	mov    %bl,-0x7feec11b(,%eax,8)
80104f5d:	83 e2 8f             	and    $0xffffff8f,%edx
80104f60:	88 14 c5 e5 3e 11 80 	mov    %dl,-0x7feec11b(,%eax,8)
80104f67:	83 ca 80             	or     $0xffffff80,%edx
80104f6a:	88 14 c5 e5 3e 11 80 	mov    %dl,-0x7feec11b(,%eax,8)
80104f71:	c1 e9 10             	shr    $0x10,%ecx
80104f74:	66 89 0c c5 e6 3e 11 	mov    %cx,-0x7feec11a(,%eax,8)
80104f7b:	80 
  for(i = 0; i < 256; i++)
80104f7c:	83 c0 01             	add    $0x1,%eax
80104f7f:	3d ff 00 00 00       	cmp    $0xff,%eax
80104f84:	7e 83                	jle    80104f09 <tvinit+0xe>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104f86:	8b 15 0c a1 10 80    	mov    0x8010a10c,%edx
80104f8c:	66 89 15 e0 40 11 80 	mov    %dx,0x801140e0
80104f93:	66 c7 05 e2 40 11 80 	movw   $0x8,0x801140e2
80104f9a:	08 00 
80104f9c:	0f b6 05 e4 40 11 80 	movzbl 0x801140e4,%eax
80104fa3:	83 e0 e0             	and    $0xffffffe0,%eax
80104fa6:	a2 e4 40 11 80       	mov    %al,0x801140e4
80104fab:	c6 05 e4 40 11 80 00 	movb   $0x0,0x801140e4
80104fb2:	0f b6 05 e5 40 11 80 	movzbl 0x801140e5,%eax
80104fb9:	83 c8 0f             	or     $0xf,%eax
80104fbc:	a2 e5 40 11 80       	mov    %al,0x801140e5
80104fc1:	83 e0 ef             	and    $0xffffffef,%eax
80104fc4:	a2 e5 40 11 80       	mov    %al,0x801140e5
80104fc9:	89 c1                	mov    %eax,%ecx
80104fcb:	83 c9 60             	or     $0x60,%ecx
80104fce:	88 0d e5 40 11 80    	mov    %cl,0x801140e5
80104fd4:	83 c8 e0             	or     $0xffffffe0,%eax
80104fd7:	a2 e5 40 11 80       	mov    %al,0x801140e5
80104fdc:	c1 ea 10             	shr    $0x10,%edx
80104fdf:	66 89 15 e6 40 11 80 	mov    %dx,0x801140e6

  initlock(&tickslock, "time");
80104fe6:	83 ec 08             	sub    $0x8,%esp
80104fe9:	68 29 71 10 80       	push   $0x80107129
80104fee:	68 a0 3e 11 80       	push   $0x80113ea0
80104ff3:	e8 35 ec ff ff       	call   80103c2d <initlock>
}
...
80105003:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80105006:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
8010500c:	b8 e0 3e 11 80       	mov    $0x80113ee0,%eax
80105011:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105015:	c1 e8 10             	shr    $0x10,%eax
80105018:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
8010501c:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010501f:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105022:	c9                   	leave  
80105023:	c3                   	ret    
...
8010502a:	83 ec 1c             	sub    $0x1c,%esp
8010502d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105030:	8b 43 30             	mov    0x30(%ebx),%eax
80105033:	83 f8 40             	cmp    $0x40,%eax
80105036:	74 13                	je     8010504b <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105038:	83 e8 20             	sub    $0x20,%eax
8010503b:	83 f8 1f             	cmp    $0x1f,%eax
8010503e:	0f 87 3a 01 00 00    	ja     8010517e <trap+0x15a>
80105044:	ff 24 85 d0 71 10 80 	jmp    *-0x7fef8e30(,%eax,4)
    if(myproc()->killed)
8010504b:	e8 ab e2 ff ff       	call   801032fb <myproc>
80105050:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105054:	75 1f                	jne    80105075 <trap+0x51>
    myproc()->tf = tf;
80105056:	e8 a0 e2 ff ff       	call   801032fb <myproc>
8010505b:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
8010505e:	e8 c5 f0 ff ff       	call   80104128 <syscall>
    if(myproc()->killed)
80105063:	e8 93 e2 ff ff       	call   801032fb <myproc>
80105068:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
8010506c:	74 7e                	je     801050ec <trap+0xc8>
      exit();
8010506e:	e8 b9 e5 ff ff       	call   8010362c <exit>
    return;
80105073:	eb 77                	jmp    801050ec <trap+0xc8>
      exit();
80105075:	e8 b2 e5 ff ff       	call   8010362c <exit>
8010507a:	eb da                	jmp    80105056 <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
8010507c:	e8 5f e2 ff ff       	call   801032e0 <cpuid>
80105081:	85 c0                	test   %eax,%eax
80105083:	74 6f                	je     801050f4 <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80105085:	e8 1e d3 ff ff       	call   801023a8 <lapiceoi>
  }
...
8010508a:	e8 6c e2 ff ff       	call   801032fb <myproc>
8010508f:	85 c0                	test   %eax,%eax
80105091:	74 1c                	je     801050af <trap+0x8b>
80105093:	e8 63 e2 ff ff       	call   801032fb <myproc>
80105098:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
8010509c:	74 11                	je     801050af <trap+0x8b>
8010509e:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801050a2:	83 e0 03             	and    $0x3,%eax
801050a5:	66 83 f8 03          	cmp    $0x3,%ax
801050a9:	0f 84 62 01 00 00    	je     80105211 <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801050af:	e8 47 e2 ff ff       	call   801032fb <myproc>
801050b4:	85 c0                	test   %eax,%eax
801050b6:	74 0f                	je     801050c7 <trap+0xa3>
801050b8:	e8 3e e2 ff ff       	call   801032fb <myproc>
801050bd:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801050c1:	0f 84 54 01 00 00    	je     8010521b <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801050c7:	e8 2f e2 ff ff       	call   801032fb <myproc>
801050cc:	85 c0                	test   %eax,%eax
801050ce:	74 1c                	je     801050ec <trap+0xc8>
801050d0:	e8 26 e2 ff ff       	call   801032fb <myproc>
801050d5:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
801050d9:	74 11                	je     801050ec <trap+0xc8>
801050db:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801050df:	83 e0 03             	and    $0x3,%eax
801050e2:	66 83 f8 03          	cmp    $0x3,%ax
801050e6:	0f 84 43 01 00 00    	je     8010522f <trap+0x20b>
    exit();
}
...
801050f7:	68 a0 3e 11 80       	push   $0x80113ea0
801050fc:	e8 68 ec ff ff       	call   80103d69 <acquire>
      ticks++;
80105101:	83 05 80 3e 11 80 01 	addl   $0x1,0x80113e80
      wakeup(&ticks);
80105108:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
8010510f:	e8 7b e7 ff ff       	call   8010388f <wakeup>
      release(&tickslock);
80105114:	c7 04 24 a0 3e 11 80 	movl   $0x80113ea0,(%esp)
8010511b:	e8 ae ec ff ff       	call   80103dce <release>
80105120:	83 c4 10             	add    $0x10,%esp
80105123:	e9 5d ff ff ff       	jmp    80105085 <trap+0x61>
    ideintr();
80105128:	e8 2f cc ff ff       	call   80101d5c <ideintr>
    lapiceoi();
8010512d:	e8 76 d2 ff ff       	call   801023a8 <lapiceoi>
    break;
80105132:	e9 53 ff ff ff       	jmp    8010508a <trap+0x66>
    kbdintr();
80105137:	e8 aa d0 ff ff       	call   801021e6 <kbdintr>
    lapiceoi();
8010513c:	e8 67 d2 ff ff       	call   801023a8 <lapiceoi>
    break;
80105141:	e9 44 ff ff ff       	jmp    8010508a <trap+0x66>
    uartintr();
80105146:	e8 fe 01 00 00       	call   80105349 <uartintr>
    lapiceoi();
8010514b:	e8 58 d2 ff ff       	call   801023a8 <lapiceoi>
    break;
80105150:	e9 35 ff ff ff       	jmp    8010508a <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105155:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80105158:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010515c:	e8 7f e1 ff ff       	call   801032e0 <cpuid>
80105161:	57                   	push   %edi
80105162:	0f b7 f6             	movzwl %si,%esi
80105165:	56                   	push   %esi
80105166:	50                   	push   %eax
80105167:	68 34 71 10 80       	push   $0x80107134
8010516c:	e8 96 b4 ff ff       	call   80100607 <cprintf>
    lapiceoi();
80105171:	e8 32 d2 ff ff       	call   801023a8 <lapiceoi>
    break;
80105176:	83 c4 10             	add    $0x10,%esp
80105179:	e9 0c ff ff ff       	jmp    8010508a <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
8010517e:	e8 78 e1 ff ff       	call   801032fb <myproc>
80105183:	85 c0                	test   %eax,%eax
80105185:	74 5f                	je     801051e6 <trap+0x1c2>
80105187:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010518b:	74 59                	je     801051e6 <trap+0x1c2>
...
80105190:	8b 43 38             	mov    0x38(%ebx),%eax
80105193:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105196:	e8 45 e1 ff ff       	call   801032e0 <cpuid>
8010519b:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010519e:	8b 53 34             	mov    0x34(%ebx),%edx
801051a1:	89 55 dc             	mov    %edx,-0x24(%ebp)
801051a4:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
801051a7:	e8 4f e1 ff ff       	call   801032fb <myproc>
801051ac:	8d 48 6c             	lea    0x6c(%eax),%ecx
801051af:	89 4d d8             	mov    %ecx,-0x28(%ebp)
801051b2:	e8 44 e1 ff ff       	call   801032fb <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801051b7:	57                   	push   %edi
801051b8:	ff 75 e4             	push   -0x1c(%ebp)
801051bb:	ff 75 e0             	push   -0x20(%ebp)
801051be:	ff 75 dc             	push   -0x24(%ebp)
801051c1:	56                   	push   %esi
801051c2:	ff 75 d8             	push   -0x28(%ebp)
801051c5:	ff 70 10             	push   0x10(%eax)
801051c8:	68 8c 71 10 80       	push   $0x8010718c
801051cd:	e8 35 b4 ff ff       	call   80100607 <cprintf>
    myproc()->killed = 1;
801051d2:	83 c4 20             	add    $0x20,%esp
801051d5:	e8 21 e1 ff ff       	call   801032fb <myproc>
801051da:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801051e1:	e9 a4 fe ff ff       	jmp    8010508a <trap+0x66>
801051e6:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801051e9:	8b 73 38             	mov    0x38(%ebx),%esi
801051ec:	e8 ef e0 ff ff       	call   801032e0 <cpuid>
801051f1:	83 ec 0c             	sub    $0xc,%esp
801051f4:	57                   	push   %edi
801051f5:	56                   	push   %esi
801051f6:	50                   	push   %eax
801051f7:	ff 73 30             	push   0x30(%ebx)
801051fa:	68 58 71 10 80       	push   $0x80107158
801051ff:	e8 03 b4 ff ff       	call   80100607 <cprintf>
      panic("trap");
80105204:	83 c4 14             	add    $0x14,%esp
80105207:	68 2e 71 10 80       	push   $0x8010712e
8010520c:	e8 37 b1 ff ff       	call   80100348 <panic>
    exit();
80105211:	e8 16 e4 ff ff       	call   8010362c <exit>
80105216:	e9 94 fe ff ff       	jmp    801050af <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
8010521b:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
8010521f:	0f 85 a2 fe ff ff    	jne    801050c7 <trap+0xa3>
    yield();
80105225:	e8 cb e4 ff ff       	call   801036f5 <yield>
8010522a:	e9 98 fe ff ff       	jmp    801050c7 <trap+0xa3>
    exit();
8010522f:	e8 f8 e3 ff ff       	call   8010362c <exit>
80105234:	e9 b3 fe ff ff       	jmp    801050ec <trap+0xc8>
...
{
  if(!uart)
80105239:	83 3d e0 46 11 80 00 	cmpl   $0x0,0x801146e0
80105240:	74 14                	je     80105256 <uartgetc+0x1d>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105242:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105247:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105248:	a8 01                	test   $0x1,%al
8010524a:	74 10                	je     8010525c <uartgetc+0x23>
8010524c:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105251:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105252:	0f b6 c0             	movzbl %al,%eax
80105255:	c3                   	ret    
    return -1;
...
80105262 <uartputc>:
  if(!uart)
80105262:	83 3d e0 46 11 80 00 	cmpl   $0x0,0x801146e0
80105269:	74 3b                	je     801052a6 <uartputc+0x44>
{
...
80105272:	bb 00 00 00 00       	mov    $0x0,%ebx
80105277:	eb 10                	jmp    80105289 <uartputc+0x27>
    microdelay(10);
80105279:	83 ec 0c             	sub    $0xc,%esp
8010527c:	6a 0a                	push   $0xa
8010527e:	e8 46 d1 ff ff       	call   801023c9 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105283:	83 c3 01             	add    $0x1,%ebx
80105286:	83 c4 10             	add    $0x10,%esp
80105289:	83 fb 7f             	cmp    $0x7f,%ebx
8010528c:	7f 0a                	jg     80105298 <uartputc+0x36>
8010528e:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105293:	ec                   	in     (%dx),%al
80105294:	a8 20                	test   $0x20,%al
80105296:	74 e1                	je     80105279 <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
801052ac:	b9 00 00 00 00       	mov    $0x0,%ecx
801052b1:	ba fa 03 00 00       	mov    $0x3fa,%edx
801052b6:	89 c8                	mov    %ecx,%eax
801052b8:	ee                   	out    %al,(%dx)
801052b9:	be fb 03 00 00       	mov    $0x3fb,%esi
801052be:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801052c3:	89 f2                	mov    %esi,%edx
801052c5:	ee                   	out    %al,(%dx)
801052c6:	b8 0c 00 00 00       	mov    $0xc,%eax
801052cb:	ba f8 03 00 00       	mov    $0x3f8,%edx
801052d0:	ee                   	out    %al,(%dx)
801052d1:	bb f9 03 00 00       	mov    $0x3f9,%ebx
801052d6:	89 c8                	mov    %ecx,%eax
801052d8:	89 da                	mov    %ebx,%edx
801052da:	ee                   	out    %al,(%dx)
801052db:	b8 03 00 00 00       	mov    $0x3,%eax
801052e0:	89 f2                	mov    %esi,%edx
801052e2:	ee                   	out    %al,(%dx)
801052e3:	ba fc 03 00 00       	mov    $0x3fc,%edx
801052e8:	89 c8                	mov    %ecx,%eax
801052ea:	ee                   	out    %al,(%dx)
801052eb:	b8 01 00 00 00       	mov    $0x1,%eax
801052f0:	89 da                	mov    %ebx,%edx
801052f2:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801052f3:	ba fd 03 00 00       	mov    $0x3fd,%edx
801052f8:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
801052f9:	3c ff                	cmp    $0xff,%al
801052fb:	74 45                	je     80105342 <uartinit+0x9b>
  uart = 1;
801052fd:	c7 05 e0 46 11 80 01 	movl   $0x1,0x801146e0
80105304:	00 00 00 
80105307:	ba fa 03 00 00       	mov    $0x3fa,%edx
8010530c:	ec                   	in     (%dx),%al
8010530d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105312:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105313:	83 ec 08             	sub    $0x8,%esp
80105316:	6a 00                	push   $0x0
80105318:	6a 04                	push   $0x4
8010531a:	e8 42 cc ff ff       	call   80101f61 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
8010531f:	83 c4 10             	add    $0x10,%esp
80105322:	bb 50 72 10 80       	mov    $0x80107250,%ebx
80105327:	eb 12                	jmp    8010533b <uartinit+0x94>
    uartputc(*p);
80105329:	83 ec 0c             	sub    $0xc,%esp
8010532c:	0f be c0             	movsbl %al,%eax
8010532f:	50                   	push   %eax
80105330:	e8 2d ff ff ff       	call   80105262 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105335:	83 c3 01             	add    $0x1,%ebx
80105338:	83 c4 10             	add    $0x10,%esp
8010533b:	0f b6 03             	movzbl (%ebx),%eax
8010533e:	84 c0                	test   %al,%al
80105340:	75 e7                	jne    80105329 <uartinit+0x82>
}
...
8010534f:	68 39 52 10 80       	push   $0x80105239
80105354:	e8 da b3 ff ff       	call   80100733 <consoleintr>
}
...
80105360:	6a 00                	push   $0x0
  jmp alltraps
80105362:	e9 71 fb ff ff       	jmp    80104ed8 <alltraps>
...
80105369:	6a 01                	push   $0x1
  jmp alltraps
8010536b:	e9 68 fb ff ff       	jmp    80104ed8 <alltraps>
...
80105372:	6a 02                	push   $0x2
  jmp alltraps
80105374:	e9 5f fb ff ff       	jmp    80104ed8 <alltraps>
...
8010537b:	6a 03                	push   $0x3
  jmp alltraps
8010537d:	e9 56 fb ff ff       	jmp    80104ed8 <alltraps>
...
80105384:	6a 04                	push   $0x4
  jmp alltraps
80105386:	e9 4d fb ff ff       	jmp    80104ed8 <alltraps>
...
8010538d:	6a 05                	push   $0x5
  jmp alltraps
8010538f:	e9 44 fb ff ff       	jmp    80104ed8 <alltraps>
...
80105396:	6a 06                	push   $0x6
  jmp alltraps
80105398:	e9 3b fb ff ff       	jmp    80104ed8 <alltraps>
...
8010539f:	6a 07                	push   $0x7
  jmp alltraps
801053a1:	e9 32 fb ff ff       	jmp    80104ed8 <alltraps>
...
801053a6:	6a 08                	push   $0x8
  jmp alltraps
801053a8:	e9 2b fb ff ff       	jmp    80104ed8 <alltraps>
...
801053af:	6a 09                	push   $0x9
  jmp alltraps
801053b1:	e9 22 fb ff ff       	jmp    80104ed8 <alltraps>
...
801053b6:	6a 0a                	push   $0xa
  jmp alltraps
801053b8:	e9 1b fb ff ff       	jmp    80104ed8 <alltraps>
...
801053bd:	6a 0b                	push   $0xb
  jmp alltraps
801053bf:	e9 14 fb ff ff       	jmp    80104ed8 <alltraps>
...
801053c4:	6a 0c                	push   $0xc
  jmp alltraps
801053c6:	e9 0d fb ff ff       	jmp    80104ed8 <alltraps>
...
801053cb:	6a 0d                	push   $0xd
  jmp alltraps
801053cd:	e9 06 fb ff ff       	jmp    80104ed8 <alltraps>
...
801053d2:	6a 0e                	push   $0xe
  jmp alltraps
801053d4:	e9 ff fa ff ff       	jmp    80104ed8 <alltraps>
...
801053db:	6a 0f                	push   $0xf
  jmp alltraps
801053dd:	e9 f6 fa ff ff       	jmp    80104ed8 <alltraps>
...
801053e4:	6a 10                	push   $0x10
  jmp alltraps
801053e6:	e9 ed fa ff ff       	jmp    80104ed8 <alltraps>
...
801053eb:	6a 11                	push   $0x11
  jmp alltraps
801053ed:	e9 e6 fa ff ff       	jmp    80104ed8 <alltraps>
...
801053f4:	6a 12                	push   $0x12
  jmp alltraps
801053f6:	e9 dd fa ff ff       	jmp    80104ed8 <alltraps>
...
801053fd:	6a 13                	push   $0x13
  jmp alltraps
801053ff:	e9 d4 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105406:	6a 14                	push   $0x14
  jmp alltraps
80105408:	e9 cb fa ff ff       	jmp    80104ed8 <alltraps>
...
8010540f:	6a 15                	push   $0x15
  jmp alltraps
80105411:	e9 c2 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105418:	6a 16                	push   $0x16
  jmp alltraps
8010541a:	e9 b9 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105421:	6a 17                	push   $0x17
  jmp alltraps
80105423:	e9 b0 fa ff ff       	jmp    80104ed8 <alltraps>
...
8010542a:	6a 18                	push   $0x18
  jmp alltraps
8010542c:	e9 a7 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105433:	6a 19                	push   $0x19
  jmp alltraps
80105435:	e9 9e fa ff ff       	jmp    80104ed8 <alltraps>
...
8010543c:	6a 1a                	push   $0x1a
  jmp alltraps
8010543e:	e9 95 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105445:	6a 1b                	push   $0x1b
  jmp alltraps
80105447:	e9 8c fa ff ff       	jmp    80104ed8 <alltraps>
...
8010544e:	6a 1c                	push   $0x1c
  jmp alltraps
80105450:	e9 83 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105457:	6a 1d                	push   $0x1d
  jmp alltraps
80105459:	e9 7a fa ff ff       	jmp    80104ed8 <alltraps>
...
80105460:	6a 1e                	push   $0x1e
  jmp alltraps
80105462:	e9 71 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105469:	6a 1f                	push   $0x1f
  jmp alltraps
8010546b:	e9 68 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105472:	6a 20                	push   $0x20
  jmp alltraps
80105474:	e9 5f fa ff ff       	jmp    80104ed8 <alltraps>
...
8010547b:	6a 21                	push   $0x21
  jmp alltraps
8010547d:	e9 56 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105484:	6a 22                	push   $0x22
  jmp alltraps
80105486:	e9 4d fa ff ff       	jmp    80104ed8 <alltraps>
...
8010548d:	6a 23                	push   $0x23
  jmp alltraps
8010548f:	e9 44 fa ff ff       	jmp    80104ed8 <alltraps>
...
80105496:	6a 24                	push   $0x24
  jmp alltraps
80105498:	e9 3b fa ff ff       	jmp    80104ed8 <alltraps>
...
8010549f:	6a 25                	push   $0x25
  jmp alltraps
801054a1:	e9 32 fa ff ff       	jmp    80104ed8 <alltraps>
...
801054a8:	6a 26                	push   $0x26
  jmp alltraps
801054aa:	e9 29 fa ff ff       	jmp    80104ed8 <alltraps>
...
801054b1:	6a 27                	push   $0x27
  jmp alltraps
801054b3:	e9 20 fa ff ff       	jmp    80104ed8 <alltraps>
...
801054ba:	6a 28                	push   $0x28
  jmp alltraps
801054bc:	e9 17 fa ff ff       	jmp    80104ed8 <alltraps>
...
801054c3:	6a 29                	push   $0x29
  jmp alltraps
801054c5:	e9 0e fa ff ff       	jmp    80104ed8 <alltraps>
...
801054cc:	6a 2a                	push   $0x2a
  jmp alltraps
801054ce:	e9 05 fa ff ff       	jmp    80104ed8 <alltraps>
...
801054d5:	6a 2b                	push   $0x2b
  jmp alltraps
801054d7:	e9 fc f9 ff ff       	jmp    80104ed8 <alltraps>
...
801054de:	6a 2c                	push   $0x2c
  jmp alltraps
801054e0:	e9 f3 f9 ff ff       	jmp    80104ed8 <alltraps>
...
801054e7:	6a 2d                	push   $0x2d
  jmp alltraps
801054e9:	e9 ea f9 ff ff       	jmp    80104ed8 <alltraps>
...
801054f0:	6a 2e                	push   $0x2e
  jmp alltraps
801054f2:	e9 e1 f9 ff ff       	jmp    80104ed8 <alltraps>
...
801054f9:	6a 2f                	push   $0x2f
  jmp alltraps
801054fb:	e9 d8 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105502:	6a 30                	push   $0x30
  jmp alltraps
80105504:	e9 cf f9 ff ff       	jmp    80104ed8 <alltraps>
...
8010550b:	6a 31                	push   $0x31
  jmp alltraps
8010550d:	e9 c6 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105514:	6a 32                	push   $0x32
  jmp alltraps
80105516:	e9 bd f9 ff ff       	jmp    80104ed8 <alltraps>
...
8010551d:	6a 33                	push   $0x33
  jmp alltraps
8010551f:	e9 b4 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105526:	6a 34                	push   $0x34
  jmp alltraps
80105528:	e9 ab f9 ff ff       	jmp    80104ed8 <alltraps>
...
8010552f:	6a 35                	push   $0x35
  jmp alltraps
80105531:	e9 a2 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105538:	6a 36                	push   $0x36
  jmp alltraps
8010553a:	e9 99 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105541:	6a 37                	push   $0x37
  jmp alltraps
80105543:	e9 90 f9 ff ff       	jmp    80104ed8 <alltraps>
...
8010554a:	6a 38                	push   $0x38
  jmp alltraps
8010554c:	e9 87 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105553:	6a 39                	push   $0x39
  jmp alltraps
80105555:	e9 7e f9 ff ff       	jmp    80104ed8 <alltraps>
...
8010555c:	6a 3a                	push   $0x3a
  jmp alltraps
8010555e:	e9 75 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105565:	6a 3b                	push   $0x3b
  jmp alltraps
80105567:	e9 6c f9 ff ff       	jmp    80104ed8 <alltraps>
...
8010556e:	6a 3c                	push   $0x3c
  jmp alltraps
80105570:	e9 63 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105577:	6a 3d                	push   $0x3d
  jmp alltraps
80105579:	e9 5a f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105580:	6a 3e                	push   $0x3e
  jmp alltraps
80105582:	e9 51 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105589:	6a 3f                	push   $0x3f
  jmp alltraps
8010558b:	e9 48 f9 ff ff       	jmp    80104ed8 <alltraps>
...
80105592:	6a 40                	push   $0x40
  jmp alltraps
80105594:	e9 3f f9 ff ff       	jmp    80104ed8 <alltraps>
...
8010559b:	6a 41                	push   $0x41
  jmp alltraps
8010559d:	e9 36 f9 ff ff       	jmp    80104ed8 <alltraps>
...
801055a4:	6a 42                	push   $0x42
  jmp alltraps
801055a6:	e9 2d f9 ff ff       	jmp    80104ed8 <alltraps>
...
801055ad:	6a 43                	push   $0x43
  jmp alltraps
801055af:	e9 24 f9 ff ff       	jmp    80104ed8 <alltraps>
...
801055b6:	6a 44                	push   $0x44
  jmp alltraps
801055b8:	e9 1b f9 ff ff       	jmp    80104ed8 <alltraps>
...
801055bf:	6a 45                	push   $0x45
  jmp alltraps
801055c1:	e9 12 f9 ff ff       	jmp    80104ed8 <alltraps>
...
801055c8:	6a 46                	push   $0x46
  jmp alltraps
801055ca:	e9 09 f9 ff ff       	jmp    80104ed8 <alltraps>
...
801055d1:	6a 47                	push   $0x47
  jmp alltraps
801055d3:	e9 00 f9 ff ff       	jmp    80104ed8 <alltraps>
...
801055da:	6a 48                	push   $0x48
  jmp alltraps
801055dc:	e9 f7 f8 ff ff       	jmp    80104ed8 <alltraps>
...
801055e3:	6a 49                	push   $0x49
  jmp alltraps
801055e5:	e9 ee f8 ff ff       	jmp    80104ed8 <alltraps>
...
801055ec:	6a 4a                	push   $0x4a
  jmp alltraps
801055ee:	e9 e5 f8 ff ff       	jmp    80104ed8 <alltraps>
...
801055f5:	6a 4b                	push   $0x4b
  jmp alltraps
801055f7:	e9 dc f8 ff ff       	jmp    80104ed8 <alltraps>
...
801055fe:	6a 4c                	push   $0x4c
  jmp alltraps
80105600:	e9 d3 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105607:	6a 4d                	push   $0x4d
  jmp alltraps
80105609:	e9 ca f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105610:	6a 4e                	push   $0x4e
  jmp alltraps
80105612:	e9 c1 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105619:	6a 4f                	push   $0x4f
  jmp alltraps
8010561b:	e9 b8 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105622:	6a 50                	push   $0x50
  jmp alltraps
80105624:	e9 af f8 ff ff       	jmp    80104ed8 <alltraps>
...
8010562b:	6a 51                	push   $0x51
  jmp alltraps
8010562d:	e9 a6 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105634:	6a 52                	push   $0x52
  jmp alltraps
80105636:	e9 9d f8 ff ff       	jmp    80104ed8 <alltraps>
...
8010563d:	6a 53                	push   $0x53
  jmp alltraps
8010563f:	e9 94 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105646:	6a 54                	push   $0x54
  jmp alltraps
80105648:	e9 8b f8 ff ff       	jmp    80104ed8 <alltraps>
...
8010564f:	6a 55                	push   $0x55
  jmp alltraps
80105651:	e9 82 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105658:	6a 56                	push   $0x56
  jmp alltraps
8010565a:	e9 79 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105661:	6a 57                	push   $0x57
  jmp alltraps
80105663:	e9 70 f8 ff ff       	jmp    80104ed8 <alltraps>
...
8010566a:	6a 58                	push   $0x58
  jmp alltraps
8010566c:	e9 67 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105673:	6a 59                	push   $0x59
  jmp alltraps
80105675:	e9 5e f8 ff ff       	jmp    80104ed8 <alltraps>
...
8010567c:	6a 5a                	push   $0x5a
  jmp alltraps
8010567e:	e9 55 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105685:	6a 5b                	push   $0x5b
  jmp alltraps
80105687:	e9 4c f8 ff ff       	jmp    80104ed8 <alltraps>
...
8010568e:	6a 5c                	push   $0x5c
  jmp alltraps
80105690:	e9 43 f8 ff ff       	jmp    80104ed8 <alltraps>
...
80105697:	6a 5d                	push   $0x5d
  jmp alltraps
80105699:	e9 3a f8 ff ff       	jmp    80104ed8 <alltraps>
...
801056a0:	6a 5e                	push   $0x5e
  jmp alltraps
801056a2:	e9 31 f8 ff ff       	jmp    80104ed8 <alltraps>
...
801056a9:	6a 5f                	push   $0x5f
  jmp alltraps
801056ab:	e9 28 f8 ff ff       	jmp    80104ed8 <alltraps>
...
801056b2:	6a 60                	push   $0x60
  jmp alltraps
801056b4:	e9 1f f8 ff ff       	jmp    80104ed8 <alltraps>
...
801056bb:	6a 61                	push   $0x61
  jmp alltraps
801056bd:	e9 16 f8 ff ff       	jmp    80104ed8 <alltraps>
...
801056c4:	6a 62                	push   $0x62
  jmp alltraps
801056c6:	e9 0d f8 ff ff       	jmp    80104ed8 <alltraps>
...
801056cd:	6a 63                	push   $0x63
  jmp alltraps
801056cf:	e9 04 f8 ff ff       	jmp    80104ed8 <alltraps>
...
801056d6:	6a 64                	push   $0x64
  jmp alltraps
801056d8:	e9 fb f7 ff ff       	jmp    80104ed8 <alltraps>
...
801056df:	6a 65                	push   $0x65
  jmp alltraps
801056e1:	e9 f2 f7 ff ff       	jmp    80104ed8 <alltraps>
...
801056e8:	6a 66                	push   $0x66
  jmp alltraps
801056ea:	e9 e9 f7 ff ff       	jmp    80104ed8 <alltraps>
...
801056f1:	6a 67                	push   $0x67
  jmp alltraps
801056f3:	e9 e0 f7 ff ff       	jmp    80104ed8 <alltraps>
...
801056fa:	6a 68                	push   $0x68
  jmp alltraps
801056fc:	e9 d7 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105703:	6a 69                	push   $0x69
  jmp alltraps
80105705:	e9 ce f7 ff ff       	jmp    80104ed8 <alltraps>
...
8010570c:	6a 6a                	push   $0x6a
  jmp alltraps
8010570e:	e9 c5 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105715:	6a 6b                	push   $0x6b
  jmp alltraps
80105717:	e9 bc f7 ff ff       	jmp    80104ed8 <alltraps>
...
8010571e:	6a 6c                	push   $0x6c
  jmp alltraps
80105720:	e9 b3 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105727:	6a 6d                	push   $0x6d
  jmp alltraps
80105729:	e9 aa f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105730:	6a 6e                	push   $0x6e
  jmp alltraps
80105732:	e9 a1 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105739:	6a 6f                	push   $0x6f
  jmp alltraps
8010573b:	e9 98 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105742:	6a 70                	push   $0x70
  jmp alltraps
80105744:	e9 8f f7 ff ff       	jmp    80104ed8 <alltraps>
...
8010574b:	6a 71                	push   $0x71
  jmp alltraps
8010574d:	e9 86 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105754:	6a 72                	push   $0x72
  jmp alltraps
80105756:	e9 7d f7 ff ff       	jmp    80104ed8 <alltraps>
...
8010575d:	6a 73                	push   $0x73
  jmp alltraps
8010575f:	e9 74 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105766:	6a 74                	push   $0x74
  jmp alltraps
80105768:	e9 6b f7 ff ff       	jmp    80104ed8 <alltraps>
...
8010576f:	6a 75                	push   $0x75
  jmp alltraps
80105771:	e9 62 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105778:	6a 76                	push   $0x76
  jmp alltraps
8010577a:	e9 59 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105781:	6a 77                	push   $0x77
  jmp alltraps
80105783:	e9 50 f7 ff ff       	jmp    80104ed8 <alltraps>
...
8010578a:	6a 78                	push   $0x78
  jmp alltraps
8010578c:	e9 47 f7 ff ff       	jmp    80104ed8 <alltraps>
...
80105793:	6a 79                	push   $0x79
  jmp alltraps
80105795:	e9 3e f7 ff ff       	jmp    80104ed8 <alltraps>
...
8010579c:	6a 7a                	push   $0x7a
  jmp alltraps
8010579e:	e9 35 f7 ff ff       	jmp    80104ed8 <alltraps>
...
801057a5:	6a 7b                	push   $0x7b
  jmp alltraps
801057a7:	e9 2c f7 ff ff       	jmp    80104ed8 <alltraps>
...
801057ae:	6a 7c                	push   $0x7c
  jmp alltraps
801057b0:	e9 23 f7 ff ff       	jmp    80104ed8 <alltraps>
...
801057b7:	6a 7d                	push   $0x7d
  jmp alltraps
801057b9:	e9 1a f7 ff ff       	jmp    80104ed8 <alltraps>
...
801057c0:	6a 7e                	push   $0x7e
  jmp alltraps
801057c2:	e9 11 f7 ff ff       	jmp    80104ed8 <alltraps>
...
801057c9:	6a 7f                	push   $0x7f
  jmp alltraps
801057cb:	e9 08 f7 ff ff       	jmp    80104ed8 <alltraps>
...
801057d2:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801057d7:	e9 fc f6 ff ff       	jmp    80104ed8 <alltraps>
...
801057de:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801057e3:	e9 f0 f6 ff ff       	jmp    80104ed8 <alltraps>
...
801057ea:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801057ef:	e9 e4 f6 ff ff       	jmp    80104ed8 <alltraps>
...
801057f6:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801057fb:	e9 d8 f6 ff ff       	jmp    80104ed8 <alltraps>
...
80105802:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105807:	e9 cc f6 ff ff       	jmp    80104ed8 <alltraps>
...
8010580e:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105813:	e9 c0 f6 ff ff       	jmp    80104ed8 <alltraps>
...
8010581a:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010581f:	e9 b4 f6 ff ff       	jmp    80104ed8 <alltraps>
...
80105826:	68 87 00 00 00       	push   $0x87
  jmp alltraps
8010582b:	e9 a8 f6 ff ff       	jmp    80104ed8 <alltraps>
...
80105832:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105837:	e9 9c f6 ff ff       	jmp    80104ed8 <alltraps>
...
8010583e:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105843:	e9 90 f6 ff ff       	jmp    80104ed8 <alltraps>
...
8010584a:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010584f:	e9 84 f6 ff ff       	jmp    80104ed8 <alltraps>
...
80105856:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
8010585b:	e9 78 f6 ff ff       	jmp    80104ed8 <alltraps>
...
80105862:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105867:	e9 6c f6 ff ff       	jmp    80104ed8 <alltraps>
...
8010586e:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105873:	e9 60 f6 ff ff       	jmp    80104ed8 <alltraps>
...
8010587a:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010587f:	e9 54 f6 ff ff       	jmp    80104ed8 <alltraps>
...
80105886:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010588b:	e9 48 f6 ff ff       	jmp    80104ed8 <alltraps>
...
80105892:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105897:	e9 3c f6 ff ff       	jmp    80104ed8 <alltraps>
...
8010589e:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801058a3:	e9 30 f6 ff ff       	jmp    80104ed8 <alltraps>
...
801058aa:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801058af:	e9 24 f6 ff ff       	jmp    80104ed8 <alltraps>
...
801058b6:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801058bb:	e9 18 f6 ff ff       	jmp    80104ed8 <alltraps>
...
801058c2:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801058c7:	e9 0c f6 ff ff       	jmp    80104ed8 <alltraps>
...
801058ce:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801058d3:	e9 00 f6 ff ff       	jmp    80104ed8 <alltraps>
...
801058da:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801058df:	e9 f4 f5 ff ff       	jmp    80104ed8 <alltraps>
...
801058e6:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801058eb:	e9 e8 f5 ff ff       	jmp    80104ed8 <alltraps>
...
801058f2:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801058f7:	e9 dc f5 ff ff       	jmp    80104ed8 <alltraps>
...
801058fe:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105903:	e9 d0 f5 ff ff       	jmp    80104ed8 <alltraps>
...
8010590a:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010590f:	e9 c4 f5 ff ff       	jmp    80104ed8 <alltraps>
...
80105916:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010591b:	e9 b8 f5 ff ff       	jmp    80104ed8 <alltraps>
...
80105922:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105927:	e9 ac f5 ff ff       	jmp    80104ed8 <alltraps>
...
8010592e:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105933:	e9 a0 f5 ff ff       	jmp    80104ed8 <alltraps>
...
8010593a:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010593f:	e9 94 f5 ff ff       	jmp    80104ed8 <alltraps>
...
80105946:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010594b:	e9 88 f5 ff ff       	jmp    80104ed8 <alltraps>
...
80105952:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105957:	e9 7c f5 ff ff       	jmp    80104ed8 <alltraps>
...
8010595e:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105963:	e9 70 f5 ff ff       	jmp    80104ed8 <alltraps>
...
8010596a:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010596f:	e9 64 f5 ff ff       	jmp    80104ed8 <alltraps>
...
80105976:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010597b:	e9 58 f5 ff ff       	jmp    80104ed8 <alltraps>
...
80105982:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105987:	e9 4c f5 ff ff       	jmp    80104ed8 <alltraps>
...
8010598e:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105993:	e9 40 f5 ff ff       	jmp    80104ed8 <alltraps>
...
8010599a:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010599f:	e9 34 f5 ff ff       	jmp    80104ed8 <alltraps>
...
801059a6:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801059ab:	e9 28 f5 ff ff       	jmp    80104ed8 <alltraps>
...
801059b2:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801059b7:	e9 1c f5 ff ff       	jmp    80104ed8 <alltraps>
...
801059be:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801059c3:	e9 10 f5 ff ff       	jmp    80104ed8 <alltraps>
...
801059ca:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801059cf:	e9 04 f5 ff ff       	jmp    80104ed8 <alltraps>
...
801059d6:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801059db:	e9 f8 f4 ff ff       	jmp    80104ed8 <alltraps>
...
801059e2:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801059e7:	e9 ec f4 ff ff       	jmp    80104ed8 <alltraps>
...
801059ee:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801059f3:	e9 e0 f4 ff ff       	jmp    80104ed8 <alltraps>
...
801059fa:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801059ff:	e9 d4 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a06:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105a0b:	e9 c8 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a12:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105a17:	e9 bc f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a1e:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105a23:	e9 b0 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a2a:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105a2f:	e9 a4 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a36:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105a3b:	e9 98 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a42:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105a47:	e9 8c f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a4e:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105a53:	e9 80 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a5a:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105a5f:	e9 74 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a66:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105a6b:	e9 68 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a72:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105a77:	e9 5c f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a7e:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105a83:	e9 50 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a8a:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105a8f:	e9 44 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105a96:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80105a9b:	e9 38 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105aa2:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105aa7:	e9 2c f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105aae:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105ab3:	e9 20 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105aba:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80105abf:	e9 14 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105ac6:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80105acb:	e9 08 f4 ff ff       	jmp    80104ed8 <alltraps>
...
80105ad2:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105ad7:	e9 fc f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105ade:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80105ae3:	e9 f0 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105aea:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80105aef:	e9 e4 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105af6:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80105afb:	e9 d8 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b02:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105b07:	e9 cc f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b0e:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80105b13:	e9 c0 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b1a:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80105b1f:	e9 b4 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b26:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80105b2b:	e9 a8 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b32:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80105b37:	e9 9c f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b3e:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80105b43:	e9 90 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b4a:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80105b4f:	e9 84 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b56:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80105b5b:	e9 78 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b62:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105b67:	e9 6c f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b6e:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105b73:	e9 60 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b7a:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105b7f:	e9 54 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b86:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105b8b:	e9 48 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b92:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105b97:	e9 3c f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105b9e:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105ba3:	e9 30 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105baa:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105baf:	e9 24 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105bb6:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105bbb:	e9 18 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105bc2:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105bc7:	e9 0c f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105bce:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105bd3:	e9 00 f3 ff ff       	jmp    80104ed8 <alltraps>
...
80105bda:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105bdf:	e9 f4 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105be6:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105beb:	e9 e8 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105bf2:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105bf7:	e9 dc f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105bfe:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105c03:	e9 d0 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c0a:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105c0f:	e9 c4 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c16:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105c1b:	e9 b8 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c22:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105c27:	e9 ac f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c2e:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105c33:	e9 a0 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c3a:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105c3f:	e9 94 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c46:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105c4b:	e9 88 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c52:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105c57:	e9 7c f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c5e:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105c63:	e9 70 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c6a:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105c6f:	e9 64 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c76:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105c7b:	e9 58 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c82:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105c87:	e9 4c f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c8e:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105c93:	e9 40 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105c9a:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105c9f:	e9 34 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105ca6:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105cab:	e9 28 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105cb2:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105cb7:	e9 1c f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105cbe:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105cc3:	e9 10 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105cca:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105ccf:	e9 04 f2 ff ff       	jmp    80104ed8 <alltraps>
...
80105cd6:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105cdb:	e9 f8 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105ce2:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105ce7:	e9 ec f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105cee:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105cf3:	e9 e0 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105cfa:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105cff:	e9 d4 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d06:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105d0b:	e9 c8 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d12:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105d17:	e9 bc f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d1e:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105d23:	e9 b0 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d2a:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105d2f:	e9 a4 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d36:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105d3b:	e9 98 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d42:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105d47:	e9 8c f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d4e:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105d53:	e9 80 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d5a:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105d5f:	e9 74 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d66:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105d6b:	e9 68 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d72:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105d77:	e9 5c f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d7e:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105d83:	e9 50 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d8a:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105d8f:	e9 44 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105d96:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105d9b:	e9 38 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105da2:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105da7:	e9 2c f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105dae:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105db3:	e9 20 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105dba:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105dbf:	e9 14 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105dc6:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105dcb:	e9 08 f1 ff ff       	jmp    80104ed8 <alltraps>
...
80105de9:	74 35                	je     80105e20 <walkpgdir+0x50>
...
80105deb:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if (a > KERNBASE)
80105df1:	81 fe 00 00 00 80    	cmp    $0x80000000,%esi
80105df7:	77 1a                	ja     80105e13 <walkpgdir+0x43>
    return (char*)a + KERNBASE;
80105df9:	81 c6 00 00 00 80    	add    $0x80000000,%esi
  ...
  return &pgtab[PTX(va)];
80105dff:	c1 eb 0c             	shr    $0xc,%ebx
80105e02:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
80105e08:	8d 04 9e             	lea    (%esi,%ebx,4),%eax
}
...
80105e16:	68 78 6e 10 80       	push   $0x80106e78
80105e1b:	e8 28 a5 ff ff       	call   80100348 <panic>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80105e20:	85 c9                	test   %ecx,%ecx
80105e22:	74 33                	je     80105e57 <walkpgdir+0x87>
80105e24:	e8 a0 c2 ff ff       	call   801020c9 <kalloc>
80105e29:	89 c6                	mov    %eax,%esi
80105e2b:	85 c0                	test   %eax,%eax
80105e2d:	74 28                	je     80105e57 <walkpgdir+0x87>
    memset(pgtab, 0, PGSIZE);
80105e2f:	83 ec 04             	sub    $0x4,%esp
80105e32:	68 00 10 00 00       	push   $0x1000
80105e37:	6a 00                	push   $0x0
80105e39:	50                   	push   %eax
80105e3a:	e8 d6 df ff ff       	call   80103e15 <memset>
    if (a < (void*) KERNBASE)
80105e3f:	83 c4 10             	add    $0x10,%esp
80105e42:	81 fe ff ff ff 7f    	cmp    $0x7fffffff,%esi
80105e48:	76 14                	jbe    80105e5e <walkpgdir+0x8e>
    return (uint)a - KERNBASE;
80105e4a:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105e50:	83 c8 07             	or     $0x7,%eax
80105e53:	89 07                	mov    %eax,(%edi)
80105e55:	eb a8                	jmp    80105dff <walkpgdir+0x2f>
      return 0;
80105e57:	b8 00 00 00 00       	mov    $0x0,%eax
80105e5c:	eb ad                	jmp    80105e0b <walkpgdir+0x3b>
        panic("V2P on address < KERNBASE "
80105e5e:	83 ec 0c             	sub    $0xc,%esp
80105e61:	68 48 6b 10 80       	push   $0x80106b48
80105e66:	e8 dd a4 ff ff       	call   80100348 <panic>
...
80105e74:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105e77:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105e7a:	89 d3                	mov    %edx,%ebx
80105e7c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105e82:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105e86:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105e8c:	b9 01 00 00 00       	mov    $0x1,%ecx
80105e91:	89 da                	mov    %ebx,%edx
80105e93:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e96:	e8 35 ff ff ff       	call   80105dd0 <walkpgdir>
80105e9b:	85 c0                	test   %eax,%eax
80105e9d:	74 2e                	je     80105ecd <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105e9f:	f6 00 01             	testb  $0x1,(%eax)
80105ea2:	75 1c                	jne    80105ec0 <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105ea4:	89 f2                	mov    %esi,%edx
80105ea6:	0b 55 0c             	or     0xc(%ebp),%edx
80105ea9:	83 ca 01             	or     $0x1,%edx
80105eac:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105eae:	39 fb                	cmp    %edi,%ebx
80105eb0:	74 28                	je     80105eda <mappages+0x6f>
      break;
    a += PGSIZE;
80105eb2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105eb8:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105ebe:	eb cc                	jmp    80105e8c <mappages+0x21>
      panic("remap");
80105ec0:	83 ec 0c             	sub    $0xc,%esp
80105ec3:	68 58 72 10 80       	push   $0x80107258
80105ec8:	e8 7b a4 ff ff       	call   80100348 <panic>
      return -1;
80105ecd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  }
  return 0;
}
80105ed2:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105ed5:	5b                   	pop    %ebx
80105ed6:	5e                   	pop    %esi
80105ed7:	5f                   	pop    %edi
80105ed8:	5d                   	pop    %ebp
...
80105edf:	eb f1                	jmp    80105ed2 <mappages+0x67>
...
80105ee7:	83 ec 1c             	sub    $0x1c,%esp
  c = &cpus[cpuid()];
80105eea:	e8 f1 d3 ff ff       	call   801032e0 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105eef:	69 f8 b0 00 00 00    	imul   $0xb0,%eax,%edi
80105ef5:	66 c7 87 18 18 11 80 	movw   $0xffff,-0x7feee7e8(%edi)
80105efc:	ff ff 
80105efe:	66 c7 87 1a 18 11 80 	movw   $0x0,-0x7feee7e6(%edi)
80105f05:	00 00 
80105f07:	c6 87 1c 18 11 80 00 	movb   $0x0,-0x7feee7e4(%edi)
80105f0e:	0f b6 8f 1d 18 11 80 	movzbl -0x7feee7e3(%edi),%ecx
80105f15:	83 e1 f0             	and    $0xfffffff0,%ecx
80105f18:	89 ce                	mov    %ecx,%esi
80105f1a:	83 ce 0a             	or     $0xa,%esi
80105f1d:	89 f2                	mov    %esi,%edx
80105f1f:	88 97 1d 18 11 80    	mov    %dl,-0x7feee7e3(%edi)
80105f25:	83 c9 1a             	or     $0x1a,%ecx
80105f28:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105f2e:	83 e1 9f             	and    $0xffffff9f,%ecx
80105f31:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105f37:	83 c9 80             	or     $0xffffff80,%ecx
80105f3a:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105f40:	0f b6 8f 1e 18 11 80 	movzbl -0x7feee7e2(%edi),%ecx
80105f47:	83 c9 0f             	or     $0xf,%ecx
80105f4a:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105f50:	89 ce                	mov    %ecx,%esi
80105f52:	83 e6 ef             	and    $0xffffffef,%esi
80105f55:	89 f2                	mov    %esi,%edx
80105f57:	88 97 1e 18 11 80    	mov    %dl,-0x7feee7e2(%edi)
80105f5d:	83 e1 cf             	and    $0xffffffcf,%ecx
80105f60:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105f66:	89 ce                	mov    %ecx,%esi
80105f68:	83 ce 40             	or     $0x40,%esi
80105f6b:	89 f2                	mov    %esi,%edx
80105f6d:	88 97 1e 18 11 80    	mov    %dl,-0x7feee7e2(%edi)
80105f73:	83 c9 c0             	or     $0xffffffc0,%ecx
80105f76:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105f7c:	c6 87 1f 18 11 80 00 	movb   $0x0,-0x7feee7e1(%edi)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105f83:	66 c7 87 20 18 11 80 	movw   $0xffff,-0x7feee7e0(%edi)
80105f8a:	ff ff 
80105f8c:	66 c7 87 22 18 11 80 	movw   $0x0,-0x7feee7de(%edi)
80105f93:	00 00 
80105f95:	c6 87 24 18 11 80 00 	movb   $0x0,-0x7feee7dc(%edi)
80105f9c:	0f b6 8f 25 18 11 80 	movzbl -0x7feee7db(%edi),%ecx
80105fa3:	83 e1 f0             	and    $0xfffffff0,%ecx
80105fa6:	89 ce                	mov    %ecx,%esi
80105fa8:	83 ce 02             	or     $0x2,%esi
80105fab:	89 f2                	mov    %esi,%edx
80105fad:	88 97 25 18 11 80    	mov    %dl,-0x7feee7db(%edi)
80105fb3:	83 c9 12             	or     $0x12,%ecx
80105fb6:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105fbc:	83 e1 9f             	and    $0xffffff9f,%ecx
80105fbf:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105fc5:	83 c9 80             	or     $0xffffff80,%ecx
80105fc8:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105fce:	0f b6 8f 26 18 11 80 	movzbl -0x7feee7da(%edi),%ecx
80105fd5:	83 c9 0f             	or     $0xf,%ecx
80105fd8:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105fde:	89 ce                	mov    %ecx,%esi
80105fe0:	83 e6 ef             	and    $0xffffffef,%esi
80105fe3:	89 f2                	mov    %esi,%edx
80105fe5:	88 97 26 18 11 80    	mov    %dl,-0x7feee7da(%edi)
80105feb:	83 e1 cf             	and    $0xffffffcf,%ecx
80105fee:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105ff4:	89 ce                	mov    %ecx,%esi
80105ff6:	83 ce 40             	or     $0x40,%esi
80105ff9:	89 f2                	mov    %esi,%edx
80105ffb:	88 97 26 18 11 80    	mov    %dl,-0x7feee7da(%edi)
80106001:	83 c9 c0             	or     $0xffffffc0,%ecx
80106004:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
8010600a:	c6 87 27 18 11 80 00 	movb   $0x0,-0x7feee7d9(%edi)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106011:	66 c7 87 28 18 11 80 	movw   $0xffff,-0x7feee7d8(%edi)
80106018:	ff ff 
8010601a:	66 c7 87 2a 18 11 80 	movw   $0x0,-0x7feee7d6(%edi)
80106021:	00 00 
80106023:	c6 87 2c 18 11 80 00 	movb   $0x0,-0x7feee7d4(%edi)
8010602a:	0f b6 9f 2d 18 11 80 	movzbl -0x7feee7d3(%edi),%ebx
80106031:	83 e3 f0             	and    $0xfffffff0,%ebx
80106034:	89 de                	mov    %ebx,%esi
80106036:	83 ce 0a             	or     $0xa,%esi
80106039:	89 f2                	mov    %esi,%edx
8010603b:	88 97 2d 18 11 80    	mov    %dl,-0x7feee7d3(%edi)
80106041:	89 de                	mov    %ebx,%esi
80106043:	83 ce 1a             	or     $0x1a,%esi
80106046:	89 f2                	mov    %esi,%edx
80106048:	88 97 2d 18 11 80    	mov    %dl,-0x7feee7d3(%edi)
8010604e:	83 cb 7a             	or     $0x7a,%ebx
80106051:	88 9f 2d 18 11 80    	mov    %bl,-0x7feee7d3(%edi)
80106057:	c6 87 2d 18 11 80 fa 	movb   $0xfa,-0x7feee7d3(%edi)
8010605e:	0f b6 9f 2e 18 11 80 	movzbl -0x7feee7d2(%edi),%ebx
80106065:	83 cb 0f             	or     $0xf,%ebx
80106068:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
8010606e:	89 de                	mov    %ebx,%esi
80106070:	83 e6 ef             	and    $0xffffffef,%esi
80106073:	89 f2                	mov    %esi,%edx
80106075:	88 97 2e 18 11 80    	mov    %dl,-0x7feee7d2(%edi)
8010607b:	83 e3 cf             	and    $0xffffffcf,%ebx
8010607e:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
80106084:	89 de                	mov    %ebx,%esi
80106086:	83 ce 40             	or     $0x40,%esi
80106089:	89 f2                	mov    %esi,%edx
8010608b:	88 97 2e 18 11 80    	mov    %dl,-0x7feee7d2(%edi)
80106091:	83 cb c0             	or     $0xffffffc0,%ebx
80106094:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
8010609a:	c6 87 2f 18 11 80 00 	movb   $0x0,-0x7feee7d1(%edi)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801060a1:	66 c7 87 30 18 11 80 	movw   $0xffff,-0x7feee7d0(%edi)
801060a8:	ff ff 
801060aa:	66 c7 87 32 18 11 80 	movw   $0x0,-0x7feee7ce(%edi)
801060b1:	00 00 
801060b3:	c6 87 34 18 11 80 00 	movb   $0x0,-0x7feee7cc(%edi)
801060ba:	0f b6 9f 35 18 11 80 	movzbl -0x7feee7cb(%edi),%ebx
801060c1:	83 e3 f0             	and    $0xfffffff0,%ebx
801060c4:	89 de                	mov    %ebx,%esi
801060c6:	83 ce 02             	or     $0x2,%esi
801060c9:	89 f2                	mov    %esi,%edx
801060cb:	88 97 35 18 11 80    	mov    %dl,-0x7feee7cb(%edi)
801060d1:	89 de                	mov    %ebx,%esi
801060d3:	83 ce 12             	or     $0x12,%esi
801060d6:	89 f2                	mov    %esi,%edx
801060d8:	88 97 35 18 11 80    	mov    %dl,-0x7feee7cb(%edi)
801060de:	83 cb 72             	or     $0x72,%ebx
801060e1:	88 9f 35 18 11 80    	mov    %bl,-0x7feee7cb(%edi)
801060e7:	c6 87 35 18 11 80 f2 	movb   $0xf2,-0x7feee7cb(%edi)
801060ee:	0f b6 9f 36 18 11 80 	movzbl -0x7feee7ca(%edi),%ebx
801060f5:	83 cb 0f             	or     $0xf,%ebx
801060f8:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
801060fe:	89 de                	mov    %ebx,%esi
80106100:	83 e6 ef             	and    $0xffffffef,%esi
80106103:	89 f2                	mov    %esi,%edx
80106105:	88 97 36 18 11 80    	mov    %dl,-0x7feee7ca(%edi)
8010610b:	83 e3 cf             	and    $0xffffffcf,%ebx
8010610e:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
80106114:	89 de                	mov    %ebx,%esi
80106116:	83 ce 40             	or     $0x40,%esi
80106119:	89 f2                	mov    %esi,%edx
8010611b:	88 97 36 18 11 80    	mov    %dl,-0x7feee7ca(%edi)
80106121:	83 cb c0             	or     $0xffffffc0,%ebx
80106124:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
8010612a:	c6 87 37 18 11 80 00 	movb   $0x0,-0x7feee7c9(%edi)
  lgdt(c->gdt, sizeof(c->gdt));
80106131:	8d 97 10 18 11 80    	lea    -0x7feee7f0(%edi),%edx
  pd[0] = size-1;
80106137:	66 c7 45 e2 2f 00    	movw   $0x2f,-0x1e(%ebp)
  pd[1] = (uint)p;
8010613d:	66 89 55 e4          	mov    %dx,-0x1c(%ebp)
  pd[2] = (uint)p >> 16;
80106141:	c1 ea 10             	shr    $0x10,%edx
80106144:	66 89 55 e6          	mov    %dx,-0x1a(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80106148:	8d 45 e2             	lea    -0x1e(%ebp),%eax
8010614b:	0f 01 10             	lgdtl  (%eax)
}
8010614e:	83 c4 1c             	add    $0x1c,%esp
80106151:	5b                   	pop    %ebx
80106152:	5e                   	pop    %esi
80106153:	5f                   	pop    %edi
80106154:	5d                   	pop    %ebp
...
80106156:	a1 e4 46 11 80       	mov    0x801146e4,%eax
    if (a < (void*) KERNBASE)
8010615b:	3d ff ff ff 7f       	cmp    $0x7fffffff,%eax
80106160:	76 09                	jbe    8010616b <switchkvm+0x15>
    return (uint)a - KERNBASE;
...
80106167:	0f 22 d8             	mov    %eax,%cr3
8010616a:	c3                   	ret    
{
8010616b:	55                   	push   %ebp
8010616c:	89 e5                	mov    %esp,%ebp
8010616e:	83 ec 14             	sub    $0x14,%esp
        panic("V2P on address < KERNBASE "
80106171:	68 48 6b 10 80       	push   $0x80106b48
80106176:	e8 cd a1 ff ff       	call   80100348 <panic>
...
80106184:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80106187:	85 f6                	test   %esi,%esi
80106189:	0f 84 2c 01 00 00    	je     801062bb <switchuvm+0x140>
    panic("switchuvm: no process");
  if(p->kstack == 0)
8010618f:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
80106193:	0f 84 2f 01 00 00    	je     801062c8 <switchuvm+0x14d>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106199:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
8010619d:	0f 84 32 01 00 00    	je     801062d5 <switchuvm+0x15a>
    panic("switchuvm: no pgdir");

  pushcli();
801061a3:	e8 e6 da ff ff       	call   80103c8e <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801061a8:	e8 d7 d0 ff ff       	call   80103284 <mycpu>
801061ad:	89 c3                	mov    %eax,%ebx
801061af:	e8 d0 d0 ff ff       	call   80103284 <mycpu>
801061b4:	8d 78 08             	lea    0x8(%eax),%edi
801061b7:	e8 c8 d0 ff ff       	call   80103284 <mycpu>
801061bc:	83 c0 08             	add    $0x8,%eax
801061bf:	c1 e8 10             	shr    $0x10,%eax
801061c2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801061c5:	e8 ba d0 ff ff       	call   80103284 <mycpu>
801061ca:	83 c0 08             	add    $0x8,%eax
801061cd:	c1 e8 18             	shr    $0x18,%eax
801061d0:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
801061d7:	67 00 
801061d9:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
801061e0:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
801061e4:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
801061ea:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
801061f1:	83 e2 f0             	and    $0xfffffff0,%edx
801061f4:	89 d1                	mov    %edx,%ecx
801061f6:	83 c9 09             	or     $0x9,%ecx
801061f9:	88 8b 9d 00 00 00    	mov    %cl,0x9d(%ebx)
801061ff:	83 ca 19             	or     $0x19,%edx
80106202:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80106208:	83 e2 9f             	and    $0xffffff9f,%edx
8010620b:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80106211:	83 ca 80             	or     $0xffffff80,%edx
80106214:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
8010621a:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80106221:	89 d1                	mov    %edx,%ecx
80106223:	83 e1 f0             	and    $0xfffffff0,%ecx
80106226:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
8010622c:	89 d1                	mov    %edx,%ecx
8010622e:	83 e1 e0             	and    $0xffffffe0,%ecx
80106231:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
80106237:	83 e2 c0             	and    $0xffffffc0,%edx
8010623a:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80106240:	83 ca 40             	or     $0x40,%edx
80106243:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80106249:	83 e2 7f             	and    $0x7f,%edx
8010624c:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80106252:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106258:	e8 27 d0 ff ff       	call   80103284 <mycpu>
8010625d:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80106264:	83 e2 ef             	and    $0xffffffef,%edx
80106267:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010626d:	e8 12 d0 ff ff       	call   80103284 <mycpu>
80106272:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106278:	8b 5e 08             	mov    0x8(%esi),%ebx
8010627b:	e8 04 d0 ff ff       	call   80103284 <mycpu>
80106280:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106286:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106289:	e8 f6 cf ff ff       	call   80103284 <mycpu>
8010628e:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106294:	b8 28 00 00 00       	mov    $0x28,%eax
80106299:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
8010629c:	8b 46 04             	mov    0x4(%esi),%eax
    if (a < (void*) KERNBASE)
8010629f:	3d ff ff ff 7f       	cmp    $0x7fffffff,%eax
801062a4:	76 3c                	jbe    801062e2 <switchuvm+0x167>
    return (uint)a - KERNBASE;
801062a6:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
801062ab:	0f 22 d8             	mov    %eax,%cr3
  popcli();
801062ae:	e8 17 da ff ff       	call   80103cca <popcli>
}
...
801062be:	68 5e 72 10 80       	push   $0x8010725e
801062c3:	e8 80 a0 ff ff       	call   80100348 <panic>
    panic("switchuvm: no kstack");
801062c8:	83 ec 0c             	sub    $0xc,%esp
801062cb:	68 74 72 10 80       	push   $0x80107274
801062d0:	e8 73 a0 ff ff       	call   80100348 <panic>
    panic("switchuvm: no pgdir");
801062d5:	83 ec 0c             	sub    $0xc,%esp
801062d8:	68 89 72 10 80       	push   $0x80107289
801062dd:	e8 66 a0 ff ff       	call   80100348 <panic>
        panic("V2P on address < KERNBASE "
801062e2:	83 ec 0c             	sub    $0xc,%esp
801062e5:	68 48 6b 10 80       	push   $0x80106b48
...
801062f4:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
801062f7:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801062fd:	77 57                	ja     80106356 <inituvm+0x67>
...
80106311:	e8 ff da ff ff       	call   80103e15 <memset>
    if (a < (void*) KERNBASE)
80106316:	83 c4 10             	add    $0x10,%esp
80106319:	81 fb ff ff ff 7f    	cmp    $0x7fffffff,%ebx
8010631f:	76 42                	jbe    80106363 <inituvm+0x74>
    return (uint)a - KERNBASE;
...
80106332:	ba 00 00 00 00       	mov    $0x0,%edx
80106337:	8b 45 08             	mov    0x8(%ebp),%eax
8010633a:	e8 2c fb ff ff       	call   80105e6b <mappages>
  memmove(mem, init, sz);
8010633f:	83 c4 0c             	add    $0xc,%esp
80106342:	56                   	push   %esi
80106343:	ff 75 0c             	push   0xc(%ebp)
80106346:	53                   	push   %ebx
80106347:	e8 41 db ff ff       	call   80103e8d <memmove>
}
...
80106359:	68 9d 72 10 80       	push   $0x8010729d
8010635e:	e8 e5 9f ff ff       	call   80100348 <panic>
        panic("V2P on address < KERNBASE "
80106363:	83 ec 0c             	sub    $0xc,%esp
80106366:	68 48 6b 10 80       	push   $0x80106b48
8010636b:	e8 d8 9f ff ff       	call   80100348 <panic>
...
80106385:	74 43                	je     801063ca <loaduvm+0x5a>
    panic("loaduvm: addr must be page aligned");
80106387:	83 ec 0c             	sub    $0xc,%esp
8010638a:	68 58 73 10 80       	push   $0x80107358
8010638f:	e8 b4 9f ff ff       	call   80100348 <panic>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106394:	83 ec 0c             	sub    $0xc,%esp
80106397:	68 b7 72 10 80       	push   $0x801072b7
8010639c:	e8 a7 9f ff ff       	call   80100348 <panic>
    pa = PTE_ADDR(*pte);
    if(sz - i < PGSIZE)
      n = sz - i;
    else
...
801063a1:	89 da                	mov    %ebx,%edx
801063a3:	03 55 14             	add    0x14(%ebp),%edx
    if (a > KERNBASE)
801063a6:	3d 00 00 00 80       	cmp    $0x80000000,%eax
801063ab:	77 51                	ja     801063fe <loaduvm+0x8e>
    return (char*)a + KERNBASE;
801063ad:	05 00 00 00 80       	add    $0x80000000,%eax
801063b2:	56                   	push   %esi
801063b3:	52                   	push   %edx
801063b4:	50                   	push   %eax
801063b5:	ff 75 10             	push   0x10(%ebp)
801063b8:	e8 a4 b3 ff ff       	call   80101761 <readi>
801063bd:	83 c4 10             	add    $0x10,%esp
801063c0:	39 f0                	cmp    %esi,%eax
801063c2:	75 54                	jne    80106418 <loaduvm+0xa8>
  for(i = 0; i < sz; i += PGSIZE){
801063c4:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801063ca:	39 fb                	cmp    %edi,%ebx
801063cc:	73 3d                	jae    8010640b <loaduvm+0x9b>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801063ce:	89 da                	mov    %ebx,%edx
801063d0:	03 55 0c             	add    0xc(%ebp),%edx
801063d3:	b9 00 00 00 00       	mov    $0x0,%ecx
801063d8:	8b 45 08             	mov    0x8(%ebp),%eax
801063db:	e8 f0 f9 ff ff       	call   80105dd0 <walkpgdir>
801063e0:	85 c0                	test   %eax,%eax
801063e2:	74 b0                	je     80106394 <loaduvm+0x24>
    pa = PTE_ADDR(*pte);
801063e4:	8b 00                	mov    (%eax),%eax
801063e6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
801063eb:	89 fe                	mov    %edi,%esi
801063ed:	29 de                	sub    %ebx,%esi
801063ef:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801063f5:	76 aa                	jbe    801063a1 <loaduvm+0x31>
      n = PGSIZE;
801063f7:	be 00 10 00 00       	mov    $0x1000,%esi
801063fc:	eb a3                	jmp    801063a1 <loaduvm+0x31>
        panic("P2V on address > KERNBASE");
801063fe:	83 ec 0c             	sub    $0xc,%esp
80106401:	68 78 6e 10 80       	push   $0x80106e78
80106406:	e8 3d 9f ff ff       	call   80100348 <panic>
      return -1;
  }
  return 0;
8010640b:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
8010641d:	eb f1                	jmp    80106410 <loaduvm+0xa0>
...
80106428:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
8010642b:	39 7d 10             	cmp    %edi,0x10(%ebp)
8010642e:	73 11                	jae    80106441 <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
80106430:	8b 45 10             	mov    0x10(%ebp),%eax
80106433:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106439:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010643f:	eb 19                	jmp    8010645a <deallocuvm+0x3b>
    return oldsz;
80106441:	89 f8                	mov    %edi,%eax
80106443:	eb 78                	jmp    801064bd <deallocuvm+0x9e>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106445:	c1 eb 16             	shr    $0x16,%ebx
80106448:	83 c3 01             	add    $0x1,%ebx
8010644b:	c1 e3 16             	shl    $0x16,%ebx
8010644e:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106454:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010645a:	39 fb                	cmp    %edi,%ebx
8010645c:	73 5c                	jae    801064ba <deallocuvm+0x9b>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010645e:	b9 00 00 00 00       	mov    $0x0,%ecx
80106463:	89 da                	mov    %ebx,%edx
80106465:	8b 45 08             	mov    0x8(%ebp),%eax
80106468:	e8 63 f9 ff ff       	call   80105dd0 <walkpgdir>
8010646d:	89 c6                	mov    %eax,%esi
    if(!pte)
8010646f:	85 c0                	test   %eax,%eax
80106471:	74 d2                	je     80106445 <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
80106473:	8b 00                	mov    (%eax),%eax
80106475:	a8 01                	test   $0x1,%al
80106477:	74 db                	je     80106454 <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106479:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010647e:	74 20                	je     801064a0 <deallocuvm+0x81>
    if (a > KERNBASE)
80106480:	3d 00 00 00 80       	cmp    $0x80000000,%eax
80106485:	77 26                	ja     801064ad <deallocuvm+0x8e>
    return (char*)a + KERNBASE;
80106487:	05 00 00 00 80       	add    $0x80000000,%eax
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
8010648c:	83 ec 0c             	sub    $0xc,%esp
8010648f:	50                   	push   %eax
80106490:	e8 f7 ba ff ff       	call   80101f8c <kfree>
      *pte = 0;
80106495:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
8010649b:	83 c4 10             	add    $0x10,%esp
8010649e:	eb b4                	jmp    80106454 <deallocuvm+0x35>
        panic("kfree");
801064a0:	83 ec 0c             	sub    $0xc,%esp
801064a3:	68 d6 6b 10 80       	push   $0x80106bd6
801064a8:	e8 9b 9e ff ff       	call   80100348 <panic>
        panic("P2V on address > KERNBASE");
801064ad:	83 ec 0c             	sub    $0xc,%esp
801064b0:	68 78 6e 10 80       	push   $0x80106e78
...
801064ce:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
801064d1:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801064d4:	85 ff                	test   %edi,%edi
801064d6:	0f 88 d9 00 00 00    	js     801065b5 <allocuvm+0xf0>
  if(newsz < oldsz)
801064dc:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801064df:	72 67                	jb     80106548 <allocuvm+0x83>
  a = PGROUNDUP(oldsz);
801064e1:	8b 45 0c             	mov    0xc(%ebp),%eax
801064e4:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
801064ea:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
801064f0:	39 fe                	cmp    %edi,%esi
801064f2:	0f 83 c4 00 00 00    	jae    801065bc <allocuvm+0xf7>
    mem = kalloc();
801064f8:	e8 cc bb ff ff       	call   801020c9 <kalloc>
801064fd:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
801064ff:	85 c0                	test   %eax,%eax
80106501:	74 4d                	je     80106550 <allocuvm+0x8b>
    memset(mem, 0, PGSIZE);
80106503:	83 ec 04             	sub    $0x4,%esp
80106506:	68 00 10 00 00       	push   $0x1000
8010650b:	6a 00                	push   $0x0
8010650d:	50                   	push   %eax
8010650e:	e8 02 d9 ff ff       	call   80103e15 <memset>
    if (a < (void*) KERNBASE)
80106513:	83 c4 10             	add    $0x10,%esp
80106516:	81 fb ff ff ff 7f    	cmp    $0x7fffffff,%ebx
8010651c:	76 5a                	jbe    80106578 <allocuvm+0xb3>
    return (uint)a - KERNBASE;
8010651e:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106524:	83 ec 08             	sub    $0x8,%esp
80106527:	6a 06                	push   $0x6
80106529:	50                   	push   %eax
8010652a:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010652f:	89 f2                	mov    %esi,%edx
80106531:	8b 45 08             	mov    0x8(%ebp),%eax
80106534:	e8 32 f9 ff ff       	call   80105e6b <mappages>
80106539:	83 c4 10             	add    $0x10,%esp
8010653c:	85 c0                	test   %eax,%eax
8010653e:	78 45                	js     80106585 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
80106540:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106546:	eb a8                	jmp    801064f0 <allocuvm+0x2b>
    return oldsz;
80106548:	8b 45 0c             	mov    0xc(%ebp),%eax
8010654b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010654e:	eb 6c                	jmp    801065bc <allocuvm+0xf7>
      cprintf("allocuvm out of memory\n");
80106550:	83 ec 0c             	sub    $0xc,%esp
80106553:	68 d5 72 10 80       	push   $0x801072d5
80106558:	e8 aa a0 ff ff       	call   80100607 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010655d:	83 c4 0c             	add    $0xc,%esp
80106560:	ff 75 0c             	push   0xc(%ebp)
80106563:	57                   	push   %edi
80106564:	ff 75 08             	push   0x8(%ebp)
80106567:	e8 b3 fe ff ff       	call   8010641f <deallocuvm>
      return 0;
8010656c:	83 c4 10             	add    $0x10,%esp
8010656f:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106576:	eb 44                	jmp    801065bc <allocuvm+0xf7>
        panic("V2P on address < KERNBASE "
80106578:	83 ec 0c             	sub    $0xc,%esp
8010657b:	68 48 6b 10 80       	push   $0x80106b48
80106580:	e8 c3 9d ff ff       	call   80100348 <panic>
      cprintf("allocuvm out of memory (2)\n");
80106585:	83 ec 0c             	sub    $0xc,%esp
80106588:	68 ed 72 10 80       	push   $0x801072ed
...
8010659c:	e8 7e fe ff ff       	call   8010641f <deallocuvm>
      kfree(mem);
...
801065b3:	eb 07                	jmp    801065bc <allocuvm+0xf7>
    return 0;
...
801065de:	e8 3c fe ff ff       	call   8010641f <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801065e3:	83 c4 10             	add    $0x10,%esp
801065e6:	bb 00 00 00 00       	mov    $0x0,%ebx
801065eb:	eb 21                	jmp    8010660e <freevm+0x47>
    panic("freevm: no pgdir");
801065ed:	83 ec 0c             	sub    $0xc,%esp
801065f0:	68 09 73 10 80       	push   $0x80107309
801065f5:	e8 4e 9d ff ff       	call   80100348 <panic>
    return (char*)a + KERNBASE;
801065fa:	05 00 00 00 80       	add    $0x80000000,%eax
    if(pgdir[i] & PTE_P){
...
80106608:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
8010660b:	83 c3 01             	add    $0x1,%ebx
8010660e:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
80106614:	77 20                	ja     80106636 <freevm+0x6f>
    if(pgdir[i] & PTE_P){
80106616:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
80106619:	a8 01                	test   $0x1,%al
8010661b:	74 ee                	je     8010660b <freevm+0x44>
8010661d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if (a > KERNBASE)
80106622:	3d 00 00 00 80       	cmp    $0x80000000,%eax
80106627:	76 d1                	jbe    801065fa <freevm+0x33>
        panic("P2V on address > KERNBASE");
80106629:	83 ec 0c             	sub    $0xc,%esp
8010662c:	68 78 6e 10 80       	push   $0x80106e78
...
8010663a:	e8 4d b9 ff ff       	call   80101f8c <kfree>
}
...
8010664e:	e8 76 ba ff ff       	call   801020c9 <kalloc>
80106653:	89 c6                	mov    %eax,%esi
80106655:	85 c0                	test   %eax,%eax
80106657:	74 55                	je     801066ae <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
80106659:	83 ec 04             	sub    $0x4,%esp
8010665c:	68 00 10 00 00       	push   $0x1000
80106661:	6a 00                	push   $0x0
80106663:	50                   	push   %eax
80106664:	e8 ac d7 ff ff       	call   80103e15 <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106669:	83 c4 10             	add    $0x10,%esp
8010666c:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
80106671:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106677:	73 35                	jae    801066ae <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
80106679:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010667c:	8b 4b 08             	mov    0x8(%ebx),%ecx
8010667f:	29 c1                	sub    %eax,%ecx
80106681:	83 ec 08             	sub    $0x8,%esp
80106684:	ff 73 0c             	push   0xc(%ebx)
80106687:	50                   	push   %eax
80106688:	8b 13                	mov    (%ebx),%edx
8010668a:	89 f0                	mov    %esi,%eax
8010668c:	e8 da f7 ff ff       	call   80105e6b <mappages>
80106691:	83 c4 10             	add    $0x10,%esp
80106694:	85 c0                	test   %eax,%eax
80106696:	78 05                	js     8010669d <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106698:	83 c3 10             	add    $0x10,%ebx
8010669b:	eb d4                	jmp    80106671 <setupkvm+0x28>
      freevm(pgdir);
8010669d:	83 ec 0c             	sub    $0xc,%esp
801066a0:	56                   	push   %esi
801066a1:	e8 21 ff ff ff       	call   801065c7 <freevm>
      return 0;
801066a6:	83 c4 10             	add    $0x10,%esp
801066a9:	be 00 00 00 00       	mov    $0x0,%esi
}
801066ae:	89 f0                	mov    %esi,%eax
...
801066ba:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801066bd:	e8 87 ff ff ff       	call   80106649 <setupkvm>
801066c2:	a3 e4 46 11 80       	mov    %eax,0x801146e4
  switchkvm();
801066c7:	e8 8a fa ff ff       	call   80106156 <switchkvm>
}
801066cc:	c9                   	leave  
801066cd:	c3                   	ret    
...
801066d9:	8b 55 0c             	mov    0xc(%ebp),%edx
801066dc:	8b 45 08             	mov    0x8(%ebp),%eax
801066df:	e8 ec f6 ff ff       	call   80105dd0 <walkpgdir>
  if(pte == 0)
801066e4:	85 c0                	test   %eax,%eax
801066e6:	74 05                	je     801066ed <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
801066e8:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801066eb:	c9                   	leave  
801066ec:	c3                   	ret    
    panic("clearpteu");
801066ed:	83 ec 0c             	sub    $0xc,%esp
801066f0:	68 1a 73 10 80       	push   $0x8010731a
...
80106700:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106703:	e8 41 ff ff ff       	call   80106649 <setupkvm>
80106708:	89 45 dc             	mov    %eax,-0x24(%ebp)
8010670b:	85 c0                	test   %eax,%eax
8010670d:	0f 84 f2 00 00 00    	je     80106805 <copyuvm+0x10b>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106713:	bf 00 00 00 00       	mov    $0x0,%edi
80106718:	eb 3a                	jmp    80106754 <copyuvm+0x5a>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
8010671a:	83 ec 0c             	sub    $0xc,%esp
8010671d:	68 24 73 10 80       	push   $0x80107324
80106722:	e8 21 9c ff ff       	call   80100348 <panic>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106727:	83 ec 0c             	sub    $0xc,%esp
8010672a:	68 3e 73 10 80       	push   $0x8010733e
8010672f:	e8 14 9c ff ff       	call   80100348 <panic>
80106734:	83 ec 0c             	sub    $0xc,%esp
80106737:	68 78 6e 10 80       	push   $0x80106e78
8010673c:	e8 07 9c ff ff       	call   80100348 <panic>
        panic("V2P on address < KERNBASE "
80106741:	83 ec 0c             	sub    $0xc,%esp
80106744:	68 48 6b 10 80       	push   $0x80106b48
80106749:	e8 fa 9b ff ff       	call   80100348 <panic>
  for(i = 0; i < sz; i += PGSIZE){
8010674e:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106754:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106757:	0f 83 a8 00 00 00    	jae    80106805 <copyuvm+0x10b>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010675d:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106760:	b9 00 00 00 00       	mov    $0x0,%ecx
80106765:	89 fa                	mov    %edi,%edx
80106767:	8b 45 08             	mov    0x8(%ebp),%eax
8010676a:	e8 61 f6 ff ff       	call   80105dd0 <walkpgdir>
8010676f:	85 c0                	test   %eax,%eax
80106771:	74 a7                	je     8010671a <copyuvm+0x20>
    if(!(*pte & PTE_P))
80106773:	8b 00                	mov    (%eax),%eax
80106775:	a8 01                	test   $0x1,%al
80106777:	74 ae                	je     80106727 <copyuvm+0x2d>
80106779:	89 c6                	mov    %eax,%esi
8010677b:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
static inline uint PTE_FLAGS(uint pte) { return pte & 0xFFF; }
80106781:	25 ff 0f 00 00       	and    $0xfff,%eax
80106786:	89 45 e0             	mov    %eax,-0x20(%ebp)
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106789:	e8 3b b9 ff ff       	call   801020c9 <kalloc>
8010678e:	89 c3                	mov    %eax,%ebx
80106790:	85 c0                	test   %eax,%eax
80106792:	74 5c                	je     801067f0 <copyuvm+0xf6>
    if (a > KERNBASE)
80106794:	81 fe 00 00 00 80    	cmp    $0x80000000,%esi
8010679a:	77 98                	ja     80106734 <copyuvm+0x3a>
    return (char*)a + KERNBASE;
8010679c:	81 c6 00 00 00 80    	add    $0x80000000,%esi
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
801067a2:	83 ec 04             	sub    $0x4,%esp
801067a5:	68 00 10 00 00       	push   $0x1000
801067aa:	56                   	push   %esi
801067ab:	50                   	push   %eax
801067ac:	e8 dc d6 ff ff       	call   80103e8d <memmove>
    if (a < (void*) KERNBASE)
801067b1:	83 c4 10             	add    $0x10,%esp
801067b4:	81 fb ff ff ff 7f    	cmp    $0x7fffffff,%ebx
801067ba:	76 85                	jbe    80106741 <copyuvm+0x47>
    return (uint)a - KERNBASE;
801067bc:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801067c2:	83 ec 08             	sub    $0x8,%esp
801067c5:	ff 75 e0             	push   -0x20(%ebp)
801067c8:	50                   	push   %eax
801067c9:	b9 00 10 00 00       	mov    $0x1000,%ecx
801067ce:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801067d1:	8b 45 dc             	mov    -0x24(%ebp),%eax
801067d4:	e8 92 f6 ff ff       	call   80105e6b <mappages>
801067d9:	83 c4 10             	add    $0x10,%esp
801067dc:	85 c0                	test   %eax,%eax
801067de:	0f 89 6a ff ff ff    	jns    8010674e <copyuvm+0x54>
      kfree(mem);
801067e4:	83 ec 0c             	sub    $0xc,%esp
801067e7:	53                   	push   %ebx
801067e8:	e8 9f b7 ff ff       	call   80101f8c <kfree>
      goto bad;
...
801067f3:	ff 75 dc             	push   -0x24(%ebp)
801067f6:	e8 cc fd ff ff       	call   801065c7 <freevm>
  return 0;
801067fb:	83 c4 10             	add    $0x10,%esp
801067fe:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
80106805:	8b 45 dc             	mov    -0x24(%ebp),%eax
...
80106813:	83 ec 08             	sub    $0x8,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
80106816:	b9 00 00 00 00       	mov    $0x0,%ecx
8010681b:	8b 55 0c             	mov    0xc(%ebp),%edx
8010681e:	8b 45 08             	mov    0x8(%ebp),%eax
80106821:	e8 aa f5 ff ff       	call   80105dd0 <walkpgdir>
  if((*pte & PTE_P) == 0)
80106826:	8b 00                	mov    (%eax),%eax
80106828:	a8 01                	test   $0x1,%al
8010682a:	74 24                	je     80106850 <uva2ka+0x40>
    return 0;
  if((*pte & PTE_U) == 0)
8010682c:	a8 04                	test   $0x4,%al
8010682e:	74 27                	je     80106857 <uva2ka+0x47>
static inline uint PTE_ADDR(uint pte)  { return pte & ~0xFFF; }
80106830:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if (a > KERNBASE)
80106835:	3d 00 00 00 80       	cmp    $0x80000000,%eax
8010683a:	77 07                	ja     80106843 <uva2ka+0x33>
    return (char*)a + KERNBASE;
8010683c:	05 00 00 00 80       	add    $0x80000000,%eax
    return 0;
...
80106846:	68 78 6e 10 80       	push   $0x80106e78
8010684b:	e8 f8 9a ff ff       	call   80100348 <panic>
    return 0;
80106850:	b8 00 00 00 00       	mov    $0x0,%eax
80106855:	eb ea                	jmp    80106841 <uva2ka+0x31>
    return 0;
80106857:	b8 00 00 00 00       	mov    $0x0,%eax
8010685c:	eb e3                	jmp    80106841 <uva2ka+0x31>
...
80106867:	8b 7d 14             	mov    0x14(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
8010686a:	eb 25                	jmp    80106891 <copyout+0x33>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
8010686c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010686f:	29 f2                	sub    %esi,%edx
80106871:	01 d0                	add    %edx,%eax
80106873:	83 ec 04             	sub    $0x4,%esp
80106876:	53                   	push   %ebx
80106877:	ff 75 10             	push   0x10(%ebp)
8010687a:	50                   	push   %eax
8010687b:	e8 0d d6 ff ff       	call   80103e8d <memmove>
    len -= n;
80106880:	29 df                	sub    %ebx,%edi
    buf += n;
80106882:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80106885:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
8010688b:	89 45 0c             	mov    %eax,0xc(%ebp)
8010688e:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
80106891:	85 ff                	test   %edi,%edi
80106893:	74 2f                	je     801068c4 <copyout+0x66>
    va0 = (uint)PGROUNDDOWN(va);
80106895:	8b 75 0c             	mov    0xc(%ebp),%esi
80106898:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
8010689e:	83 ec 08             	sub    $0x8,%esp
801068a1:	56                   	push   %esi
801068a2:	ff 75 08             	push   0x8(%ebp)
801068a5:	e8 66 ff ff ff       	call   80106810 <uva2ka>
    if(pa0 == 0)
801068aa:	83 c4 10             	add    $0x10,%esp
801068ad:	85 c0                	test   %eax,%eax
801068af:	74 20                	je     801068d1 <copyout+0x73>
    n = PGSIZE - (va - va0);
801068b1:	89 f3                	mov    %esi,%ebx
801068b3:	2b 5d 0c             	sub    0xc(%ebp),%ebx
801068b6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
801068bc:	39 df                	cmp    %ebx,%edi
801068be:	73 ac                	jae    8010686c <copyout+0xe>
      n = len;
801068c0:	89 fb                	mov    %edi,%ebx
801068c2:	eb a8                	jmp    8010686c <copyout+0xe>
  }
  return 0;
...
801068d6:	eb f1                	jmp    801068c9 <copyout+0x6b>
