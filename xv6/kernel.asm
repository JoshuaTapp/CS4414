...
80100373:	e8 8f 02 00 00       	call   80100607 <cprintf>
  cprintf("\n");
80100378:	c7 04 24 ff 70 10 80 	movl   $0x801070ff,(%esp)
...
801004fa:	e8 57 4b 00 00       	call   80105056 <uartputc>
...
80100513:	e8 3e 4b 00 00       	call   80105056 <uartputc>
80100518:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010051f:	e8 32 4b 00 00       	call   80105056 <uartputc>
80100524:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052b:	e8 26 4b 00 00       	call   80105056 <uartputc>
...
8010096c:	eb dc                	jmp    8010094a <exec+0x7c>
  if((pgdir = setupkvm()) == 0)
8010096e:	e8 ca 5a 00 00       	call   8010643d <setupkvm>
...
80100a02:	e8 b2 58 00 00       	call   801062b9 <allocuvm>
...
80100a34:	e8 2b 57 00 00       	call   80106164 <loaduvm>
...
80100a71:	e8 43 58 00 00       	call   801062b9 <allocuvm>
...
80100a9c:	e8 1a 59 00 00       	call   801063bb <freevm>
...
80100ab4:	e8 09 5a 00 00       	call   801064c2 <clearpteu>
...
80100b0a:	e8 43 5b 00 00       	call   80106652 <copyout>
...
80100b6a:	e8 e3 5a 00 00       	call   80106652 <copyout>
...
80100bd5:	e8 95 53 00 00       	call   80105f6f <switchuvm>
  freevm(oldpgdir);
80100bda:	89 1c 24             	mov    %ebx,(%esp)
80100bdd:	e8 d9 57 00 00       	call   801063bb <freevm>
  return 0;
...
80101bc3:	68 f8 6e 10 80       	push   $0x80106ef8
...
80102a48:	e8 a7 23 00 00       	call   80104df4 <idtinit>
...
80102a68:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a6b:	e8 da 34 00 00       	call   80105f4a <switchkvm>
  seginit();
80102a70:	e8 60 32 00 00       	call   80105cd5 <seginit>
  lapicinit();
...
80102ac2:	e8 d4 25 00 00       	call   8010509b <uartinit>
  pinit();         // process table
80102ac7:	e8 bd 06 00 00       	call   80103189 <pinit>
  tvinit();        // trap vectors
80102acc:	e8 1e 22 00 00       	call   80104cef <tvinit>
  binit();         // buffer cache
...
801030f1:	c7 80 b0 0f 00 00 e4 	movl   $0x80104ce4,0xfb0(%eax)
801030f8:	4c 10 80 
  sp -= sizeof *p->context;
...
80103250:	e8 e8 31 00 00       	call   8010643d <setupkvm>
...
8010326e:	e8 70 2e 00 00       	call   801060e3 <inituvm>
  p->sz = PGSIZE;
...
80103342:	e8 28 2c 00 00       	call   80105f6f <switchuvm>
  return 0;
...
80103360:	e8 54 2f 00 00       	call   801062b9 <allocuvm>
...
8010337d:	e8 91 2e 00 00       	call   80106213 <deallocuvm>
...
801033ba:	e8 2f 31 00 00       	call   801064ee <copyuvm>
...
801034ca:	e8 a0 2a 00 00       	call   80105f6f <switchuvm>
      p->state = RUNNING;
...
801034e0:	e8 3f 09 00 00       	call   80103e24 <swtch>
      switchkvm();
801034e5:	e8 60 2a 00 00       	call   80105f4a <switchkvm>
      c->proc = 0;
...
80103790:	e8 26 2c 00 00       	call   801063bb <freevm>
        p->pid = 0;
...
801038f0:	68 ff 70 10 80       	push   $0x801070ff
...
80103f8d:	83 fa 16             	cmp    $0x16,%edx
...
8010409d:	68 c0 6e 10 80       	push   $0x80106ec0
...
801041ae:	68 d2 6e 10 80       	push   $0x80106ed2
...
801041d2:	68 e2 6e 10 80       	push   $0x80106ee2
...
801041ea:	68 e1 6e 10 80       	push   $0x80106ee1
...
801041ff:	68 e4 6e 10 80       	push   $0x80106ee4
80104204:	e8 3f c1 ff ff       	call   80100348 <panic>
    panic("create: dirlink");
80104209:	83 ec 0c             	sub    $0xc,%esp
8010420c:	68 f0 6e 10 80       	push   $0x80106ef0
...
801042eb:	78 43                	js     80104330 <sys_write+0x5f>
...
80104300:	78 2e                	js     80104330 <sys_write+0x5f>
...
80104318:	78 16                	js     80104330 <sys_write+0x5f>
...
80104335:	eb f7                	jmp    8010432e <sys_write+0x5d>
...
8010433a:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
8010433d:	8d 4d f0             	lea    -0x10(%ebp),%ecx
80104340:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104343:	b8 00 00 00 00       	mov    $0x0,%eax
80104348:	e8 80 fc ff ff       	call   80103fcd <argfd>
8010434d:	85 c0                	test   %eax,%eax
8010434f:	78 25                	js     80104376 <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
80104351:	e8 c4 ee ff ff       	call   8010321a <myproc>
80104356:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104359:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104360:	00 
  fileclose(f);
80104361:	83 ec 0c             	sub    $0xc,%esp
80104364:	ff 75 f0             	push   -0x10(%ebp)
80104367:	e8 57 c9 ff ff       	call   80100cc3 <fileclose>
  return 0;
...
80104375:	c3                   	ret    
    return -1;
80104376:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010437b:	eb f7                	jmp    80104374 <sys_close+0x3d>
...
80104383:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104386:	ba 00 00 00 00       	mov    $0x0,%edx
8010438b:	b8 00 00 00 00       	mov    $0x0,%eax
80104390:	e8 38 fc ff ff       	call   80103fcd <argfd>
80104395:	85 c0                	test   %eax,%eax
80104397:	78 2a                	js     801043c3 <sys_fstat+0x46>
80104399:	83 ec 04             	sub    $0x4,%esp
8010439c:	6a 14                	push   $0x14
8010439e:	8d 45 f0             	lea    -0x10(%ebp),%eax
801043a1:	50                   	push   %eax
801043a2:	6a 01                	push   $0x1
801043a4:	e8 32 fb ff ff       	call   80103edb <argptr>
801043a9:	83 c4 10             	add    $0x10,%esp
801043ac:	85 c0                	test   %eax,%eax
801043ae:	78 13                	js     801043c3 <sys_fstat+0x46>
  return filestat(f, st);
801043b0:	83 ec 08             	sub    $0x8,%esp
801043b3:	ff 75 f0             	push   -0x10(%ebp)
801043b6:	ff 75 f4             	push   -0xc(%ebp)
801043b9:	e8 cb c9 ff ff       	call   80100d89 <filestat>
...
801043c8:	eb f7                	jmp    801043c1 <sys_fstat+0x44>
...
801043d2:	8d 45 e0             	lea    -0x20(%ebp),%eax
801043d5:	50                   	push   %eax
801043d6:	6a 00                	push   $0x0
801043d8:	e8 66 fb ff ff       	call   80103f43 <argstr>
801043dd:	83 c4 10             	add    $0x10,%esp
801043e0:	85 c0                	test   %eax,%eax
801043e2:	0f 88 d3 00 00 00    	js     801044bb <sys_link+0xf1>
801043e8:	83 ec 08             	sub    $0x8,%esp
801043eb:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801043ee:	50                   	push   %eax
801043ef:	6a 01                	push   $0x1
801043f1:	e8 4d fb ff ff       	call   80103f43 <argstr>
801043f6:	83 c4 10             	add    $0x10,%esp
801043f9:	85 c0                	test   %eax,%eax
801043fb:	0f 88 ba 00 00 00    	js     801044bb <sys_link+0xf1>
  begin_op();
80104401:	e8 aa e3 ff ff       	call   801027b0 <begin_op>
  if((ip = namei(old)) == 0){
80104406:	83 ec 0c             	sub    $0xc,%esp
80104409:	ff 75 e0             	push   -0x20(%ebp)
8010440c:	e8 bc d7 ff ff       	call   80101bcd <namei>
80104411:	89 c3                	mov    %eax,%ebx
80104413:	83 c4 10             	add    $0x10,%esp
80104416:	85 c0                	test   %eax,%eax
80104418:	0f 84 a4 00 00 00    	je     801044c2 <sys_link+0xf8>
  ilock(ip);
8010441e:	83 ec 0c             	sub    $0xc,%esp
80104421:	50                   	push   %eax
80104422:	e8 48 d1 ff ff       	call   8010156f <ilock>
  if(ip->type == T_DIR){
80104427:	83 c4 10             	add    $0x10,%esp
8010442a:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010442f:	0f 84 99 00 00 00    	je     801044ce <sys_link+0x104>
  ip->nlink++;
80104435:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104439:	83 c0 01             	add    $0x1,%eax
8010443c:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104440:	83 ec 0c             	sub    $0xc,%esp
80104443:	53                   	push   %ebx
80104444:	e8 c5 cf ff ff       	call   8010140e <iupdate>
  iunlock(ip);
80104449:	89 1c 24             	mov    %ebx,(%esp)
8010444c:	e8 e0 d1 ff ff       	call   80101631 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104451:	83 c4 08             	add    $0x8,%esp
80104454:	8d 45 ea             	lea    -0x16(%ebp),%eax
80104457:	50                   	push   %eax
80104458:	ff 75 e4             	push   -0x1c(%ebp)
8010445b:	e8 85 d7 ff ff       	call   80101be5 <nameiparent>
80104460:	89 c6                	mov    %eax,%esi
80104462:	83 c4 10             	add    $0x10,%esp
80104465:	85 c0                	test   %eax,%eax
80104467:	0f 84 85 00 00 00    	je     801044f2 <sys_link+0x128>
  ilock(dp);
8010446d:	83 ec 0c             	sub    $0xc,%esp
80104470:	50                   	push   %eax
80104471:	e8 f9 d0 ff ff       	call   8010156f <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104476:	83 c4 10             	add    $0x10,%esp
80104479:	8b 03                	mov    (%ebx),%eax
8010447b:	39 06                	cmp    %eax,(%esi)
8010447d:	75 67                	jne    801044e6 <sys_link+0x11c>
8010447f:	83 ec 04             	sub    $0x4,%esp
80104482:	ff 73 04             	push   0x4(%ebx)
80104485:	8d 45 ea             	lea    -0x16(%ebp),%eax
80104488:	50                   	push   %eax
80104489:	56                   	push   %esi
8010448a:	e8 8d d6 ff ff       	call   80101b1c <dirlink>
8010448f:	83 c4 10             	add    $0x10,%esp
80104492:	85 c0                	test   %eax,%eax
80104494:	78 50                	js     801044e6 <sys_link+0x11c>
  iunlockput(dp);
80104496:	83 ec 0c             	sub    $0xc,%esp
80104499:	56                   	push   %esi
8010449a:	e8 77 d2 ff ff       	call   80101716 <iunlockput>
  iput(ip);
8010449f:	89 1c 24             	mov    %ebx,(%esp)
801044a2:	e8 cf d1 ff ff       	call   80101676 <iput>
  end_op();
801044a7:	e8 7e e3 ff ff       	call   8010282a <end_op>
  return 0;
...
801044c0:	eb f2                	jmp    801044b4 <sys_link+0xea>
    end_op();
801044c2:	e8 63 e3 ff ff       	call   8010282a <end_op>
    return -1;
801044c7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801044cc:	eb e6                	jmp    801044b4 <sys_link+0xea>
    iunlockput(ip);
801044ce:	83 ec 0c             	sub    $0xc,%esp
801044d1:	53                   	push   %ebx
801044d2:	e8 3f d2 ff ff       	call   80101716 <iunlockput>
    end_op();
801044d7:	e8 4e e3 ff ff       	call   8010282a <end_op>
    return -1;
801044dc:	83 c4 10             	add    $0x10,%esp
801044df:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801044e4:	eb ce                	jmp    801044b4 <sys_link+0xea>
    iunlockput(dp);
801044e6:	83 ec 0c             	sub    $0xc,%esp
801044e9:	56                   	push   %esi
801044ea:	e8 27 d2 ff ff       	call   80101716 <iunlockput>
    goto bad;
801044ef:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
801044f2:	83 ec 0c             	sub    $0xc,%esp
801044f5:	53                   	push   %ebx
801044f6:	e8 74 d0 ff ff       	call   8010156f <ilock>
  ip->nlink--;
801044fb:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801044ff:	83 e8 01             	sub    $0x1,%eax
80104502:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104506:	89 1c 24             	mov    %ebx,(%esp)
80104509:	e8 00 cf ff ff       	call   8010140e <iupdate>
  iunlockput(ip);
8010450e:	89 1c 24             	mov    %ebx,(%esp)
80104511:	e8 00 d2 ff ff       	call   80101716 <iunlockput>
  end_op();
80104516:	e8 0f e3 ff ff       	call   8010282a <end_op>
  return -1;
8010451b:	83 c4 10             	add    $0x10,%esp
8010451e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104523:	eb 8f                	jmp    801044b4 <sys_link+0xea>
...
8010452b:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
8010452e:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104531:	50                   	push   %eax
80104532:	6a 00                	push   $0x0
80104534:	e8 0a fa ff ff       	call   80103f43 <argstr>
80104539:	83 c4 10             	add    $0x10,%esp
8010453c:	85 c0                	test   %eax,%eax
8010453e:	0f 88 83 01 00 00    	js     801046c7 <sys_unlink+0x1a2>
  begin_op();
80104544:	e8 67 e2 ff ff       	call   801027b0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104549:	83 ec 08             	sub    $0x8,%esp
8010454c:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010454f:	50                   	push   %eax
80104550:	ff 75 c4             	push   -0x3c(%ebp)
80104553:	e8 8d d6 ff ff       	call   80101be5 <nameiparent>
80104558:	89 c6                	mov    %eax,%esi
8010455a:	83 c4 10             	add    $0x10,%esp
8010455d:	85 c0                	test   %eax,%eax
8010455f:	0f 84 ed 00 00 00    	je     80104652 <sys_unlink+0x12d>
  ilock(dp);
80104565:	83 ec 0c             	sub    $0xc,%esp
80104568:	50                   	push   %eax
80104569:	e8 01 d0 ff ff       	call   8010156f <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010456e:	83 c4 08             	add    $0x8,%esp
80104571:	68 e2 6e 10 80       	push   $0x80106ee2
80104576:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104579:	50                   	push   %eax
8010457a:	e8 0b d4 ff ff       	call   8010198a <namecmp>
8010457f:	83 c4 10             	add    $0x10,%esp
80104582:	85 c0                	test   %eax,%eax
80104584:	0f 84 fc 00 00 00    	je     80104686 <sys_unlink+0x161>
8010458a:	83 ec 08             	sub    $0x8,%esp
8010458d:	68 e1 6e 10 80       	push   $0x80106ee1
80104592:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104595:	50                   	push   %eax
80104596:	e8 ef d3 ff ff       	call   8010198a <namecmp>
8010459b:	83 c4 10             	add    $0x10,%esp
8010459e:	85 c0                	test   %eax,%eax
801045a0:	0f 84 e0 00 00 00    	je     80104686 <sys_unlink+0x161>
  if((ip = dirlookup(dp, name, &off)) == 0)
801045a6:	83 ec 04             	sub    $0x4,%esp
801045a9:	8d 45 c0             	lea    -0x40(%ebp),%eax
801045ac:	50                   	push   %eax
801045ad:	8d 45 ca             	lea    -0x36(%ebp),%eax
801045b0:	50                   	push   %eax
801045b1:	56                   	push   %esi
801045b2:	e8 e8 d3 ff ff       	call   8010199f <dirlookup>
801045b7:	89 c3                	mov    %eax,%ebx
801045b9:	83 c4 10             	add    $0x10,%esp
801045bc:	85 c0                	test   %eax,%eax
801045be:	0f 84 c2 00 00 00    	je     80104686 <sys_unlink+0x161>
  ilock(ip);
801045c4:	83 ec 0c             	sub    $0xc,%esp
801045c7:	50                   	push   %eax
801045c8:	e8 a2 cf ff ff       	call   8010156f <ilock>
  if(ip->nlink < 1)
801045cd:	83 c4 10             	add    $0x10,%esp
801045d0:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801045d5:	0f 8e 83 00 00 00    	jle    8010465e <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
801045db:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801045e0:	0f 84 85 00 00 00    	je     8010466b <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
801045e6:	83 ec 04             	sub    $0x4,%esp
801045e9:	6a 10                	push   $0x10
801045eb:	6a 00                	push   $0x0
801045ed:	8d 7d d8             	lea    -0x28(%ebp),%edi
801045f0:	57                   	push   %edi
801045f1:	e8 6d f6 ff ff       	call   80103c63 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801045f6:	6a 10                	push   $0x10
801045f8:	ff 75 c0             	push   -0x40(%ebp)
801045fb:	57                   	push   %edi
801045fc:	56                   	push   %esi
801045fd:	e8 5c d2 ff ff       	call   8010185e <writei>
80104602:	83 c4 20             	add    $0x20,%esp
80104605:	83 f8 10             	cmp    $0x10,%eax
80104608:	0f 85 90 00 00 00    	jne    8010469e <sys_unlink+0x179>
  if(ip->type == T_DIR){
8010460e:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104613:	0f 84 92 00 00 00    	je     801046ab <sys_unlink+0x186>
  iunlockput(dp);
80104619:	83 ec 0c             	sub    $0xc,%esp
8010461c:	56                   	push   %esi
8010461d:	e8 f4 d0 ff ff       	call   80101716 <iunlockput>
  ip->nlink--;
80104622:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104626:	83 e8 01             	sub    $0x1,%eax
80104629:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
8010462d:	89 1c 24             	mov    %ebx,(%esp)
80104630:	e8 d9 cd ff ff       	call   8010140e <iupdate>
  iunlockput(ip);
80104635:	89 1c 24             	mov    %ebx,(%esp)
80104638:	e8 d9 d0 ff ff       	call   80101716 <iunlockput>
  end_op();
8010463d:	e8 e8 e1 ff ff       	call   8010282a <end_op>
  return 0;
80104642:	83 c4 10             	add    $0x10,%esp
80104645:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010464a:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010464d:	5b                   	pop    %ebx
8010464e:	5e                   	pop    %esi
8010464f:	5f                   	pop    %edi
80104650:	5d                   	pop    %ebp
80104651:	c3                   	ret    
    end_op();
80104652:	e8 d3 e1 ff ff       	call   8010282a <end_op>
    return -1;
80104657:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010465c:	eb ec                	jmp    8010464a <sys_unlink+0x125>
    panic("unlink: nlink < 1");
8010465e:	83 ec 0c             	sub    $0xc,%esp
80104661:	68 00 6f 10 80       	push   $0x80106f00
80104666:	e8 dd bc ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010466b:	89 d8                	mov    %ebx,%eax
8010466d:	e8 f1 f9 ff ff       	call   80104063 <isdirempty>
80104672:	85 c0                	test   %eax,%eax
80104674:	0f 85 6c ff ff ff    	jne    801045e6 <sys_unlink+0xc1>
    iunlockput(ip);
8010467a:	83 ec 0c             	sub    $0xc,%esp
8010467d:	53                   	push   %ebx
8010467e:	e8 93 d0 ff ff       	call   80101716 <iunlockput>
    goto bad;
80104683:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
80104686:	83 ec 0c             	sub    $0xc,%esp
80104689:	56                   	push   %esi
8010468a:	e8 87 d0 ff ff       	call   80101716 <iunlockput>
  end_op();
8010468f:	e8 96 e1 ff ff       	call   8010282a <end_op>
  return -1;
80104694:	83 c4 10             	add    $0x10,%esp
80104697:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010469c:	eb ac                	jmp    8010464a <sys_unlink+0x125>
    panic("unlink: writei");
8010469e:	83 ec 0c             	sub    $0xc,%esp
801046a1:	68 12 6f 10 80       	push   $0x80106f12
801046a6:	e8 9d bc ff ff       	call   80100348 <panic>
    dp->nlink--;
801046ab:	0f b7 46 56          	movzwl 0x56(%esi),%eax
801046af:	83 e8 01             	sub    $0x1,%eax
801046b2:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
801046b6:	83 ec 0c             	sub    $0xc,%esp
801046b9:	56                   	push   %esi
801046ba:	e8 4f cd ff ff       	call   8010140e <iupdate>
801046bf:	83 c4 10             	add    $0x10,%esp
801046c2:	e9 52 ff ff ff       	jmp    80104619 <sys_unlink+0xf4>
    return -1;
801046c7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046cc:	e9 79 ff ff ff       	jmp    8010464a <sys_unlink+0x125>
...
801046d7:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
801046da:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801046dd:	50                   	push   %eax
801046de:	6a 00                	push   $0x0
801046e0:	e8 5e f8 ff ff       	call   80103f43 <argstr>
801046e5:	83 c4 10             	add    $0x10,%esp
801046e8:	85 c0                	test   %eax,%eax
801046ea:	0f 88 a0 00 00 00    	js     80104790 <sys_open+0xbf>
801046f0:	83 ec 08             	sub    $0x8,%esp
801046f3:	8d 45 e0             	lea    -0x20(%ebp),%eax
801046f6:	50                   	push   %eax
801046f7:	6a 01                	push   $0x1
801046f9:	e8 b5 f7 ff ff       	call   80103eb3 <argint>
801046fe:	83 c4 10             	add    $0x10,%esp
80104701:	85 c0                	test   %eax,%eax
80104703:	0f 88 87 00 00 00    	js     80104790 <sys_open+0xbf>
    return -1;

  begin_op();
80104709:	e8 a2 e0 ff ff       	call   801027b0 <begin_op>

  if(omode & O_CREATE){
8010470e:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
80104712:	0f 84 8b 00 00 00    	je     801047a3 <sys_open+0xd2>
    ip = create(path, T_FILE, 0, 0);
80104718:	83 ec 0c             	sub    $0xc,%esp
8010471b:	6a 00                	push   $0x0
8010471d:	b9 00 00 00 00       	mov    $0x0,%ecx
80104722:	ba 02 00 00 00       	mov    $0x2,%edx
80104727:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010472a:	e8 8b f9 ff ff       	call   801040ba <create>
8010472f:	89 c6                	mov    %eax,%esi
    if(ip == 0){
80104731:	83 c4 10             	add    $0x10,%esp
80104734:	85 c0                	test   %eax,%eax
80104736:	74 5f                	je     80104797 <sys_open+0xc6>
      end_op();
      return -1;
    }
  }
...
80104738:	e8 e0 c4 ff ff       	call   80100c1d <filealloc>
8010473d:	89 c3                	mov    %eax,%ebx
8010473f:	85 c0                	test   %eax,%eax
80104741:	0f 84 b5 00 00 00    	je     801047fc <sys_open+0x12b>
80104747:	e8 e1 f8 ff ff       	call   8010402d <fdalloc>
8010474c:	89 c7                	mov    %eax,%edi
8010474e:	85 c0                	test   %eax,%eax
80104750:	0f 88 a6 00 00 00    	js     801047fc <sys_open+0x12b>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
8010475a:	e8 d2 ce ff ff       	call   80101631 <iunlock>
  end_op();
8010475f:	e8 c6 e0 ff ff       	call   8010282a <end_op>

  f->type = FD_INODE;
80104764:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
8010476a:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
8010476d:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80104774:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104777:	83 c4 10             	add    $0x10,%esp
8010477a:	a8 01                	test   $0x1,%al
8010477c:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80104780:	a8 03                	test   $0x3,%al
80104782:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
...
80104795:	eb ef                	jmp    80104786 <sys_open+0xb5>
      end_op();
80104797:	e8 8e e0 ff ff       	call   8010282a <end_op>
      return -1;
8010479c:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801047a1:	eb e3                	jmp    80104786 <sys_open+0xb5>
    if((ip = namei(path)) == 0){
801047a3:	83 ec 0c             	sub    $0xc,%esp
801047a6:	ff 75 e4             	push   -0x1c(%ebp)
801047a9:	e8 1f d4 ff ff       	call   80101bcd <namei>
801047ae:	89 c6                	mov    %eax,%esi
801047b0:	83 c4 10             	add    $0x10,%esp
801047b3:	85 c0                	test   %eax,%eax
801047b5:	74 39                	je     801047f0 <sys_open+0x11f>
    ilock(ip);
801047b7:	83 ec 0c             	sub    $0xc,%esp
801047ba:	50                   	push   %eax
801047bb:	e8 af cd ff ff       	call   8010156f <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801047c0:	83 c4 10             	add    $0x10,%esp
801047c3:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801047c8:	0f 85 6a ff ff ff    	jne    80104738 <sys_open+0x67>
801047ce:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801047d2:	0f 84 60 ff ff ff    	je     80104738 <sys_open+0x67>
      iunlockput(ip);
801047d8:	83 ec 0c             	sub    $0xc,%esp
801047db:	56                   	push   %esi
801047dc:	e8 35 cf ff ff       	call   80101716 <iunlockput>
      end_op();
801047e1:	e8 44 e0 ff ff       	call   8010282a <end_op>
      return -1;
801047e6:	83 c4 10             	add    $0x10,%esp
801047e9:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801047ee:	eb 96                	jmp    80104786 <sys_open+0xb5>
      end_op();
801047f0:	e8 35 e0 ff ff       	call   8010282a <end_op>
      return -1;
801047f5:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801047fa:	eb 8a                	jmp    80104786 <sys_open+0xb5>
    if(f)
801047fc:	85 db                	test   %ebx,%ebx
801047fe:	74 0c                	je     8010480c <sys_open+0x13b>
      fileclose(f);
80104800:	83 ec 0c             	sub    $0xc,%esp
80104803:	53                   	push   %ebx
80104804:	e8 ba c4 ff ff       	call   80100cc3 <fileclose>
80104809:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010480c:	83 ec 0c             	sub    $0xc,%esp
8010480f:	56                   	push   %esi
80104810:	e8 01 cf ff ff       	call   80101716 <iunlockput>
    end_op();
80104815:	e8 10 e0 ff ff       	call   8010282a <end_op>
    return -1;
8010481a:	83 c4 10             	add    $0x10,%esp
8010481d:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104822:	e9 5f ff ff ff       	jmp    80104786 <sys_open+0xb5>
...
8010482a:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
8010482d:	e8 7e df ff ff       	call   801027b0 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80104832:	83 ec 08             	sub    $0x8,%esp
80104835:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104838:	50                   	push   %eax
80104839:	6a 00                	push   $0x0
8010483b:	e8 03 f7 ff ff       	call   80103f43 <argstr>
80104840:	83 c4 10             	add    $0x10,%esp
80104843:	85 c0                	test   %eax,%eax
80104845:	78 36                	js     8010487d <sys_mkdir+0x56>
80104847:	83 ec 0c             	sub    $0xc,%esp
8010484a:	6a 00                	push   $0x0
8010484c:	b9 00 00 00 00       	mov    $0x0,%ecx
80104851:	ba 01 00 00 00       	mov    $0x1,%edx
80104856:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104859:	e8 5c f8 ff ff       	call   801040ba <create>
8010485e:	83 c4 10             	add    $0x10,%esp
80104861:	85 c0                	test   %eax,%eax
80104863:	74 18                	je     8010487d <sys_mkdir+0x56>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80104869:	e8 a8 ce ff ff       	call   80101716 <iunlockput>
  end_op();
8010486e:	e8 b7 df ff ff       	call   8010282a <end_op>
  return 0;
80104873:	83 c4 10             	add    $0x10,%esp
80104876:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010487b:	c9                   	leave  
8010487c:	c3                   	ret    
    end_op();
...
80104887:	eb f2                	jmp    8010487b <sys_mkdir+0x54>
...
8010488c:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
8010488f:	e8 1c df ff ff       	call   801027b0 <begin_op>
  if((argstr(0, &path)) < 0 ||
80104894:	83 ec 08             	sub    $0x8,%esp
80104897:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010489a:	50                   	push   %eax
8010489b:	6a 00                	push   $0x0
8010489d:	e8 a1 f6 ff ff       	call   80103f43 <argstr>
801048a2:	83 c4 10             	add    $0x10,%esp
801048a5:	85 c0                	test   %eax,%eax
801048a7:	78 62                	js     8010490b <sys_mknod+0x82>
     argint(1, &major) < 0 ||
801048a9:	83 ec 08             	sub    $0x8,%esp
801048ac:	8d 45 f0             	lea    -0x10(%ebp),%eax
801048af:	50                   	push   %eax
801048b0:	6a 01                	push   $0x1
801048b2:	e8 fc f5 ff ff       	call   80103eb3 <argint>
  if((argstr(0, &path)) < 0 ||
801048b7:	83 c4 10             	add    $0x10,%esp
801048ba:	85 c0                	test   %eax,%eax
801048bc:	78 4d                	js     8010490b <sys_mknod+0x82>
     argint(2, &minor) < 0 ||
801048be:	83 ec 08             	sub    $0x8,%esp
801048c1:	8d 45 ec             	lea    -0x14(%ebp),%eax
801048c4:	50                   	push   %eax
801048c5:	6a 02                	push   $0x2
801048c7:	e8 e7 f5 ff ff       	call   80103eb3 <argint>
     argint(1, &major) < 0 ||
801048cc:	83 c4 10             	add    $0x10,%esp
801048cf:	85 c0                	test   %eax,%eax
801048d1:	78 38                	js     8010490b <sys_mknod+0x82>
     (ip = create(path, T_DEV, major, minor)) == 0){
801048d3:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
801048d7:	83 ec 0c             	sub    $0xc,%esp
801048da:	0f bf 45 ec          	movswl -0x14(%ebp),%eax
801048de:	50                   	push   %eax
801048df:	ba 03 00 00 00       	mov    $0x3,%edx
801048e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048e7:	e8 ce f7 ff ff       	call   801040ba <create>
     argint(2, &minor) < 0 ||
801048ec:	83 c4 10             	add    $0x10,%esp
801048ef:	85 c0                	test   %eax,%eax
801048f1:	74 18                	je     8010490b <sys_mknod+0x82>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
801048f7:	e8 1a ce ff ff       	call   80101716 <iunlockput>
  end_op();
801048fc:	e8 29 df ff ff       	call   8010282a <end_op>
  return 0;
...
8010490a:	c3                   	ret    
    end_op();
8010490b:	e8 1a df ff ff       	call   8010282a <end_op>
    return -1;
80104910:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104915:	eb f2                	jmp    80104909 <sys_mknod+0x80>
...
8010491c:	83 ec 10             	sub    $0x10,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
8010491f:	e8 f6 e8 ff ff       	call   8010321a <myproc>
80104924:	89 c6                	mov    %eax,%esi
  
  begin_op();
80104926:	e8 85 de ff ff       	call   801027b0 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
8010492b:	83 ec 08             	sub    $0x8,%esp
8010492e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104931:	50                   	push   %eax
80104932:	6a 00                	push   $0x0
80104934:	e8 0a f6 ff ff       	call   80103f43 <argstr>
80104939:	83 c4 10             	add    $0x10,%esp
8010493c:	85 c0                	test   %eax,%eax
8010493e:	78 52                	js     80104992 <sys_chdir+0x7b>
80104940:	83 ec 0c             	sub    $0xc,%esp
80104943:	ff 75 f4             	push   -0xc(%ebp)
80104946:	e8 82 d2 ff ff       	call   80101bcd <namei>
8010494b:	89 c3                	mov    %eax,%ebx
8010494d:	83 c4 10             	add    $0x10,%esp
80104950:	85 c0                	test   %eax,%eax
80104952:	74 3e                	je     80104992 <sys_chdir+0x7b>
    end_op();
    return -1;
  }
  ilock(ip);
...
80104958:	e8 12 cc ff ff       	call   8010156f <ilock>
  if(ip->type != T_DIR){
8010495d:	83 c4 10             	add    $0x10,%esp
80104960:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104965:	75 37                	jne    8010499e <sys_chdir+0x87>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
8010496b:	e8 c1 cc ff ff       	call   80101631 <iunlock>
  iput(curproc->cwd);
80104970:	83 c4 04             	add    $0x4,%esp
80104973:	ff 76 68             	push   0x68(%esi)
80104976:	e8 fb cc ff ff       	call   80101676 <iput>
  end_op();
8010497b:	e8 aa de ff ff       	call   8010282a <end_op>
  curproc->cwd = ip;
80104980:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
...
801049ba:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
...
801049c6:	e8 78 f5 ff ff       	call   80103f43 <argstr>
801049cb:	83 c4 10             	add    $0x10,%esp
801049ce:	85 c0                	test   %eax,%eax
801049d0:	78 38                	js     80104a0a <sys_exec+0x54>
801049d2:	83 ec 08             	sub    $0x8,%esp
801049d5:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801049db:	50                   	push   %eax
801049dc:	6a 01                	push   $0x1
801049de:	e8 d0 f4 ff ff       	call   80103eb3 <argint>
801049e3:	83 c4 10             	add    $0x10,%esp
801049e6:	85 c0                	test   %eax,%eax
801049e8:	78 20                	js     80104a0a <sys_exec+0x54>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
801049ea:	83 ec 04             	sub    $0x4,%esp
801049ed:	68 80 00 00 00       	push   $0x80
801049f2:	6a 00                	push   $0x0
801049f4:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
801049fa:	50                   	push   %eax
801049fb:	e8 63 f2 ff ff       	call   80103c63 <memset>
80104a00:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104a03:	bb 00 00 00 00       	mov    $0x0,%ebx
80104a08:	eb 2c                	jmp    80104a36 <sys_exec+0x80>
    return -1;
80104a0a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a0f:	eb 78                	jmp    80104a89 <sys_exec+0xd3>
    if(i >= NELEM(argv))
      return -1;
    ...
    if(uarg == 0){
      argv[i] = 0;
80104a11:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104a18:	00 00 00 00 
      break;
    }
...
80104a1f:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104a25:	50                   	push   %eax
80104a26:	ff 75 f4             	push   -0xc(%ebp)
80104a29:	e8 a0 be ff ff       	call   801008ce <exec>
80104a2e:	83 c4 10             	add    $0x10,%esp
80104a31:	eb 56                	jmp    80104a89 <sys_exec+0xd3>
  for(i=0;; i++){
80104a33:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104a36:	83 fb 1f             	cmp    $0x1f,%ebx
80104a39:	77 49                	ja     80104a84 <sys_exec+0xce>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80104a3b:	83 ec 08             	sub    $0x8,%esp
80104a3e:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80104a44:	50                   	push   %eax
80104a45:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
80104a4b:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80104a4e:	50                   	push   %eax
80104a4f:	e8 e5 f3 ff ff       	call   80103e39 <fetchint>
80104a54:	83 c4 10             	add    $0x10,%esp
80104a57:	85 c0                	test   %eax,%eax
80104a59:	78 33                	js     80104a8e <sys_exec+0xd8>
    if(uarg == 0){
80104a5b:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80104a61:	85 c0                	test   %eax,%eax
80104a63:	74 ac                	je     80104a11 <sys_exec+0x5b>
    if(fetchstr(uarg, &argv[i]) < 0)
80104a65:	83 ec 08             	sub    $0x8,%esp
80104a68:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
80104a6f:	52                   	push   %edx
80104a70:	50                   	push   %eax
80104a71:	e8 fe f3 ff ff       	call   80103e74 <fetchstr>
80104a76:	83 c4 10             	add    $0x10,%esp
80104a79:	85 c0                	test   %eax,%eax
80104a7b:	79 b6                	jns    80104a33 <sys_exec+0x7d>
      return -1;
80104a7d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a82:	eb 05                	jmp    80104a89 <sys_exec+0xd3>
      return -1;
...
80104a93:	eb f4                	jmp    80104a89 <sys_exec+0xd3>
...
80104a9c:	6a 08                	push   $0x8
80104a9e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104aa1:	50                   	push   %eax
80104aa2:	6a 00                	push   $0x0
80104aa4:	e8 32 f4 ff ff       	call   80103edb <argptr>
80104aa9:	83 c4 10             	add    $0x10,%esp
80104aac:	85 c0                	test   %eax,%eax
80104aae:	78 79                	js     80104b29 <sys_pipe+0x94>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80104ab0:	83 ec 08             	sub    $0x8,%esp
80104ab3:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104ab6:	50                   	push   %eax
80104ab7:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104aba:	50                   	push   %eax
80104abb:	e8 ac e2 ff ff       	call   80102d6c <pipealloc>
80104ac0:	83 c4 10             	add    $0x10,%esp
80104ac3:	85 c0                	test   %eax,%eax
80104ac5:	78 69                	js     80104b30 <sys_pipe+0x9b>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104ac7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104aca:	e8 5e f5 ff ff       	call   8010402d <fdalloc>
80104acf:	89 c3                	mov    %eax,%ebx
80104ad1:	85 c0                	test   %eax,%eax
80104ad3:	78 21                	js     80104af6 <sys_pipe+0x61>
80104ad5:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104ad8:	e8 50 f5 ff ff       	call   8010402d <fdalloc>
80104add:	85 c0                	test   %eax,%eax
80104adf:	78 15                	js     80104af6 <sys_pipe+0x61>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80104ae4:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
80104ae6:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104ae9:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
...
80104af8:	79 20                	jns    80104b1a <sys_pipe+0x85>
    fileclose(rf);
80104afa:	83 ec 0c             	sub    $0xc,%esp
80104afd:	ff 75 f0             	push   -0x10(%ebp)
80104b00:	e8 be c1 ff ff       	call   80100cc3 <fileclose>
    fileclose(wf);
80104b05:	83 c4 04             	add    $0x4,%esp
80104b08:	ff 75 ec             	push   -0x14(%ebp)
80104b0b:	e8 b3 c1 ff ff       	call   80100cc3 <fileclose>
    return -1;
80104b10:	83 c4 10             	add    $0x10,%esp
80104b13:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b18:	eb d7                	jmp    80104af1 <sys_pipe+0x5c>
      myproc()->ofile[fd0] = 0;
80104b1a:	e8 fb e6 ff ff       	call   8010321a <myproc>
80104b1f:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80104b26:	00 
80104b27:	eb d1                	jmp    80104afa <sys_pipe+0x65>
    return -1;
80104b29:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b2e:	eb c1                	jmp    80104af1 <sys_pipe+0x5c>
    return -1;
80104b30:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b35:	eb ba                	jmp    80104af1 <sys_pipe+0x5c>
...
80104b3a:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104b3d:	e8 4e e8 ff ff       	call   80103390 <fork>
}
80104b42:	c9                   	leave  
80104b43:	c3                   	ret    
...
80104b47:	83 ec 08             	sub    $0x8,%esp
  exit();
80104b4a:	e8 75 ea ff ff       	call   801035c4 <exit>
  return 0;  // not reached
}
80104b4f:	b8 00 00 00 00       	mov    $0x0,%eax
80104b54:	c9                   	leave  
80104b55:	c3                   	ret    
...
80104b59:	83 ec 08             	sub    $0x8,%esp
  return wait();
80104b5c:	e8 ec eb ff ff       	call   8010374d <wait>
}
80104b61:	c9                   	leave  
80104b62:	c3                   	ret    
...
80104b66:	83 ec 20             	sub    $0x20,%esp
  int pid;
...
80104b6f:	e8 3f f3 ff ff       	call   80103eb3 <argint>
80104b74:	83 c4 10             	add    $0x10,%esp
80104b77:	85 c0                	test   %eax,%eax
80104b79:	78 10                	js     80104b8b <sys_kill+0x28>
    return -1;
  return kill(pid);
80104b7b:	83 ec 0c             	sub    $0xc,%esp
80104b7e:	ff 75 f4             	push   -0xc(%ebp)
80104b81:	e8 c4 ec ff ff       	call   8010384a <kill>
...
80104b90:	eb f7                	jmp    80104b89 <sys_kill+0x26>
...
80104b95:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104b98:	e8 7d e6 ff ff       	call   8010321a <myproc>
80104b9d:	8b 40 10             	mov    0x10(%eax),%eax
}
80104ba0:	c9                   	leave  
80104ba1:	c3                   	ret    
...
80104ba6:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  int n;
...
80104baf:	e8 ff f2 ff ff       	call   80103eb3 <argint>
80104bb4:	83 c4 10             	add    $0x10,%esp
80104bb7:	85 c0                	test   %eax,%eax
80104bb9:	78 20                	js     80104bdb <sys_sbrk+0x39>
    return -1;
  addr = myproc()->sz;
80104bbb:	e8 5a e6 ff ff       	call   8010321a <myproc>
80104bc0:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104bc2:	83 ec 0c             	sub    $0xc,%esp
80104bc5:	ff 75 f4             	push   -0xc(%ebp)
80104bc8:	e8 58 e7 ff ff       	call   80103325 <growproc>
80104bcd:	83 c4 10             	add    $0x10,%esp
80104bd0:	85 c0                	test   %eax,%eax
80104bd2:	78 0e                	js     80104be2 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80104bd4:	89 d8                	mov    %ebx,%eax
80104bd6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104bd9:	c9                   	leave  
80104bda:	c3                   	ret    
    return -1;
80104bdb:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104be0:	eb f2                	jmp    80104bd4 <sys_sbrk+0x32>
    return -1;
80104be2:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104be7:	eb eb                	jmp    80104bd4 <sys_sbrk+0x32>
...
80104bed:	83 ec 1c             	sub    $0x1c,%esp
  int n;
  uint ticks0;
...
80104bf6:	e8 b8 f2 ff ff       	call   80103eb3 <argint>
80104bfb:	83 c4 10             	add    $0x10,%esp
80104bfe:	85 c0                	test   %eax,%eax
80104c00:	78 75                	js     80104c77 <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104c02:	83 ec 0c             	sub    $0xc,%esp
80104c05:	68 80 3c 11 80       	push   $0x80113c80
80104c0a:	e8 a8 ef ff ff       	call   80103bb7 <acquire>
  ticks0 = ticks;
80104c0f:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  while(ticks - ticks0 < n){
80104c15:	83 c4 10             	add    $0x10,%esp
80104c18:	a1 60 3c 11 80       	mov    0x80113c60,%eax
80104c1d:	29 d8                	sub    %ebx,%eax
80104c1f:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104c22:	73 39                	jae    80104c5d <sys_sleep+0x74>
    if(myproc()->killed){
80104c24:	e8 f1 e5 ff ff       	call   8010321a <myproc>
80104c29:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104c2d:	75 17                	jne    80104c46 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104c2f:	83 ec 08             	sub    $0x8,%esp
80104c32:	68 80 3c 11 80       	push   $0x80113c80
80104c37:	68 60 3c 11 80       	push   $0x80113c60
80104c3c:	e8 7b ea ff ff       	call   801036bc <sleep>
80104c41:	83 c4 10             	add    $0x10,%esp
80104c44:	eb d2                	jmp    80104c18 <sys_sleep+0x2f>
      release(&tickslock);
80104c46:	83 ec 0c             	sub    $0xc,%esp
80104c49:	68 80 3c 11 80       	push   $0x80113c80
80104c4e:	e8 c9 ef ff ff       	call   80103c1c <release>
      return -1;
80104c53:	83 c4 10             	add    $0x10,%esp
80104c56:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c5b:	eb 15                	jmp    80104c72 <sys_sleep+0x89>
  }
  release(&tickslock);
80104c5d:	83 ec 0c             	sub    $0xc,%esp
80104c60:	68 80 3c 11 80       	push   $0x80113c80
80104c65:	e8 b2 ef ff ff       	call   80103c1c <release>
  return 0;
80104c6a:	83 c4 10             	add    $0x10,%esp
80104c6d:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80104c7c:	eb f4                	jmp    80104c72 <sys_sleep+0x89>
...
80104c82:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80104c85:	68 80 3c 11 80       	push   $0x80113c80
80104c8a:	e8 28 ef ff ff       	call   80103bb7 <acquire>
  xticks = ticks;
80104c8f:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  release(&tickslock);
80104c95:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80104c9c:	e8 7b ef ff ff       	call   80103c1c <release>
  return xticks;
}
80104ca1:	89 d8                	mov    %ebx,%eax
...
80104cab:	83 ec 08             	sub    $0x8,%esp
  yield();
80104cae:	e8 d7 e9 ff ff       	call   8010368a <yield>
  return 0;
}
...
80104cbd:	83 ec 08             	sub    $0x8,%esp
  shutdown();
80104cc0:	e8 36 d5 ff ff       	call   801021fb <shutdown>
  return 0;
}
80104cc5:	b8 00 00 00 00       	mov    $0x0,%eax
80104cca:	c9                   	leave  
80104ccb:	c3                   	ret    
...
80104ccd:	06                   	push   %es
  pushl %fs
80104cce:	0f a0                	push   %fs
  pushl %gs
80104cd0:	0f a8                	push   %gs
  pushal
80104cd2:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104cd3:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104cd7:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104cd9:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104cdb:	54                   	push   %esp
  call trap
80104cdc:	e8 37 01 00 00       	call   80104e18 <trap>
  addl $4, %esp
...
80104ce4:	61                   	popa   
  popl %gs
80104ce5:	0f a9                	pop    %gs
  popl %fs
80104ce7:	0f a1                	pop    %fs
  popl %es
80104ce9:	07                   	pop    %es
  popl %ds
80104cea:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80104ceb:	83 c4 08             	add    $0x8,%esp
  iret
80104cee:	cf                   	iret   
...
80104cfb:	eb 76                	jmp    80104d73 <tvinit+0x84>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104cfd:	8b 0c 85 08 a0 10 80 	mov    -0x7fef5ff8(,%eax,4),%ecx
80104d04:	66 89 0c c5 c0 3c 11 	mov    %cx,-0x7feec340(,%eax,8)
80104d0b:	80 
80104d0c:	66 c7 04 c5 c2 3c 11 	movw   $0x8,-0x7feec33e(,%eax,8)
80104d13:	80 08 00 
80104d16:	0f b6 14 c5 c4 3c 11 	movzbl -0x7feec33c(,%eax,8),%edx
80104d1d:	80 
80104d1e:	83 e2 e0             	and    $0xffffffe0,%edx
80104d21:	88 14 c5 c4 3c 11 80 	mov    %dl,-0x7feec33c(,%eax,8)
80104d28:	c6 04 c5 c4 3c 11 80 	movb   $0x0,-0x7feec33c(,%eax,8)
80104d2f:	00 
80104d30:	0f b6 14 c5 c5 3c 11 	movzbl -0x7feec33b(,%eax,8),%edx
80104d37:	80 
80104d38:	83 e2 f0             	and    $0xfffffff0,%edx
80104d3b:	83 ca 0e             	or     $0xe,%edx
80104d3e:	88 14 c5 c5 3c 11 80 	mov    %dl,-0x7feec33b(,%eax,8)
80104d45:	89 d3                	mov    %edx,%ebx
80104d47:	83 e3 ef             	and    $0xffffffef,%ebx
80104d4a:	88 1c c5 c5 3c 11 80 	mov    %bl,-0x7feec33b(,%eax,8)
80104d51:	83 e2 8f             	and    $0xffffff8f,%edx
80104d54:	88 14 c5 c5 3c 11 80 	mov    %dl,-0x7feec33b(,%eax,8)
80104d5b:	83 ca 80             	or     $0xffffff80,%edx
80104d5e:	88 14 c5 c5 3c 11 80 	mov    %dl,-0x7feec33b(,%eax,8)
80104d65:	c1 e9 10             	shr    $0x10,%ecx
80104d68:	66 89 0c c5 c6 3c 11 	mov    %cx,-0x7feec33a(,%eax,8)
80104d6f:	80 
  for(i = 0; i < 256; i++)
80104d70:	83 c0 01             	add    $0x1,%eax
80104d73:	3d ff 00 00 00       	cmp    $0xff,%eax
80104d78:	7e 83                	jle    80104cfd <tvinit+0xe>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104d7a:	8b 15 08 a1 10 80    	mov    0x8010a108,%edx
80104d80:	66 89 15 c0 3e 11 80 	mov    %dx,0x80113ec0
80104d87:	66 c7 05 c2 3e 11 80 	movw   $0x8,0x80113ec2
80104d8e:	08 00 
80104d90:	0f b6 05 c4 3e 11 80 	movzbl 0x80113ec4,%eax
80104d97:	83 e0 e0             	and    $0xffffffe0,%eax
80104d9a:	a2 c4 3e 11 80       	mov    %al,0x80113ec4
80104d9f:	c6 05 c4 3e 11 80 00 	movb   $0x0,0x80113ec4
80104da6:	0f b6 05 c5 3e 11 80 	movzbl 0x80113ec5,%eax
80104dad:	83 c8 0f             	or     $0xf,%eax
80104db0:	a2 c5 3e 11 80       	mov    %al,0x80113ec5
80104db5:	83 e0 ef             	and    $0xffffffef,%eax
80104db8:	a2 c5 3e 11 80       	mov    %al,0x80113ec5
80104dbd:	89 c1                	mov    %eax,%ecx
80104dbf:	83 c9 60             	or     $0x60,%ecx
80104dc2:	88 0d c5 3e 11 80    	mov    %cl,0x80113ec5
80104dc8:	83 c8 e0             	or     $0xffffffe0,%eax
80104dcb:	a2 c5 3e 11 80       	mov    %al,0x80113ec5
80104dd0:	c1 ea 10             	shr    $0x10,%edx
80104dd3:	66 89 15 c6 3e 11 80 	mov    %dx,0x80113ec6

  initlock(&tickslock, "time");
80104dda:	83 ec 08             	sub    $0x8,%esp
80104ddd:	68 21 6f 10 80       	push   $0x80106f21
80104de2:	68 80 3c 11 80       	push   $0x80113c80
80104de7:	e8 8f ec ff ff       	call   80103a7b <initlock>
}
...
80104df7:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80104dfa:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80104e00:	b8 c0 3c 11 80       	mov    $0x80113cc0,%eax
80104e05:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80104e09:	c1 e8 10             	shr    $0x10,%eax
80104e0c:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80104e10:	8d 45 fa             	lea    -0x6(%ebp),%eax
80104e13:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80104e16:	c9                   	leave  
80104e17:	c3                   	ret    
...
80104e24:	8b 43 30             	mov    0x30(%ebx),%eax
80104e27:	83 f8 40             	cmp    $0x40,%eax
80104e2a:	74 13                	je     80104e3f <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80104e2c:	83 e8 20             	sub    $0x20,%eax
80104e2f:	83 f8 1f             	cmp    $0x1f,%eax
80104e32:	0f 87 3a 01 00 00    	ja     80104f72 <trap+0x15a>
80104e38:	ff 24 85 c8 6f 10 80 	jmp    *-0x7fef9038(,%eax,4)
    if(myproc()->killed)
80104e3f:	e8 d6 e3 ff ff       	call   8010321a <myproc>
80104e44:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104e48:	75 1f                	jne    80104e69 <trap+0x51>
    myproc()->tf = tf;
80104e4a:	e8 cb e3 ff ff       	call   8010321a <myproc>
80104e4f:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80104e52:	e8 1f f1 ff ff       	call   80103f76 <syscall>
    if(myproc()->killed)
80104e57:	e8 be e3 ff ff       	call   8010321a <myproc>
80104e5c:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104e60:	74 7e                	je     80104ee0 <trap+0xc8>
      exit();
80104e62:	e8 5d e7 ff ff       	call   801035c4 <exit>
    return;
80104e67:	eb 77                	jmp    80104ee0 <trap+0xc8>
      exit();
80104e69:	e8 56 e7 ff ff       	call   801035c4 <exit>
80104e6e:	eb da                	jmp    80104e4a <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80104e70:	e8 8a e3 ff ff       	call   801031ff <cpuid>
80104e75:	85 c0                	test   %eax,%eax
80104e77:	74 6f                	je     80104ee8 <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80104e79:	e8 2a d5 ff ff       	call   801023a8 <lapiceoi>
  }
...
80104e7e:	e8 97 e3 ff ff       	call   8010321a <myproc>
80104e83:	85 c0                	test   %eax,%eax
80104e85:	74 1c                	je     80104ea3 <trap+0x8b>
80104e87:	e8 8e e3 ff ff       	call   8010321a <myproc>
80104e8c:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104e90:	74 11                	je     80104ea3 <trap+0x8b>
80104e92:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104e96:	83 e0 03             	and    $0x3,%eax
80104e99:	66 83 f8 03          	cmp    $0x3,%ax
80104e9d:	0f 84 62 01 00 00    	je     80105005 <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80104ea3:	e8 72 e3 ff ff       	call   8010321a <myproc>
80104ea8:	85 c0                	test   %eax,%eax
80104eaa:	74 0f                	je     80104ebb <trap+0xa3>
80104eac:	e8 69 e3 ff ff       	call   8010321a <myproc>
80104eb1:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80104eb5:	0f 84 54 01 00 00    	je     8010500f <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80104ebb:	e8 5a e3 ff ff       	call   8010321a <myproc>
80104ec0:	85 c0                	test   %eax,%eax
80104ec2:	74 1c                	je     80104ee0 <trap+0xc8>
80104ec4:	e8 51 e3 ff ff       	call   8010321a <myproc>
80104ec9:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ecd:	74 11                	je     80104ee0 <trap+0xc8>
80104ecf:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104ed3:	83 e0 03             	and    $0x3,%eax
80104ed6:	66 83 f8 03          	cmp    $0x3,%ax
80104eda:	0f 84 43 01 00 00    	je     80105023 <trap+0x20b>
    exit();
}
...
80104eeb:	68 80 3c 11 80       	push   $0x80113c80
80104ef0:	e8 c2 ec ff ff       	call   80103bb7 <acquire>
      ticks++;
80104ef5:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80104efc:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104f03:	e8 19 e9 ff ff       	call   80103821 <wakeup>
      release(&tickslock);
80104f08:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80104f0f:	e8 08 ed ff ff       	call   80103c1c <release>
80104f14:	83 c4 10             	add    $0x10,%esp
80104f17:	e9 5d ff ff ff       	jmp    80104e79 <trap+0x61>
    ideintr();
80104f1c:	e8 3b ce ff ff       	call   80101d5c <ideintr>
    lapiceoi();
80104f21:	e8 82 d4 ff ff       	call   801023a8 <lapiceoi>
    break;
80104f26:	e9 53 ff ff ff       	jmp    80104e7e <trap+0x66>
    kbdintr();
80104f2b:	e8 b6 d2 ff ff       	call   801021e6 <kbdintr>
    lapiceoi();
80104f30:	e8 73 d4 ff ff       	call   801023a8 <lapiceoi>
    break;
80104f35:	e9 44 ff ff ff       	jmp    80104e7e <trap+0x66>
    uartintr();
80104f3a:	e8 fe 01 00 00       	call   8010513d <uartintr>
    lapiceoi();
80104f3f:	e8 64 d4 ff ff       	call   801023a8 <lapiceoi>
    break;
80104f44:	e9 35 ff ff ff       	jmp    80104e7e <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80104f49:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80104f4c:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80104f50:	e8 aa e2 ff ff       	call   801031ff <cpuid>
80104f55:	57                   	push   %edi
80104f56:	0f b7 f6             	movzwl %si,%esi
80104f59:	56                   	push   %esi
80104f5a:	50                   	push   %eax
80104f5b:	68 2c 6f 10 80       	push   $0x80106f2c
80104f60:	e8 a2 b6 ff ff       	call   80100607 <cprintf>
    lapiceoi();
80104f65:	e8 3e d4 ff ff       	call   801023a8 <lapiceoi>
    break;
80104f6a:	83 c4 10             	add    $0x10,%esp
80104f6d:	e9 0c ff ff ff       	jmp    80104e7e <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
80104f72:	e8 a3 e2 ff ff       	call   8010321a <myproc>
80104f77:	85 c0                	test   %eax,%eax
80104f79:	74 5f                	je     80104fda <trap+0x1c2>
80104f7b:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80104f7f:	74 59                	je     80104fda <trap+0x1c2>
...
80104f81:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80104f84:	8b 43 38             	mov    0x38(%ebx),%eax
80104f87:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80104f8a:	e8 70 e2 ff ff       	call   801031ff <cpuid>
80104f8f:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104f92:	8b 53 34             	mov    0x34(%ebx),%edx
80104f95:	89 55 dc             	mov    %edx,-0x24(%ebp)
80104f98:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
80104f9b:	e8 7a e2 ff ff       	call   8010321a <myproc>
80104fa0:	8d 48 6c             	lea    0x6c(%eax),%ecx
80104fa3:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80104fa6:	e8 6f e2 ff ff       	call   8010321a <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80104fab:	57                   	push   %edi
80104fac:	ff 75 e4             	push   -0x1c(%ebp)
80104faf:	ff 75 e0             	push   -0x20(%ebp)
80104fb2:	ff 75 dc             	push   -0x24(%ebp)
80104fb5:	56                   	push   %esi
80104fb6:	ff 75 d8             	push   -0x28(%ebp)
80104fb9:	ff 70 10             	push   0x10(%eax)
80104fbc:	68 84 6f 10 80       	push   $0x80106f84
80104fc1:	e8 41 b6 ff ff       	call   80100607 <cprintf>
    myproc()->killed = 1;
80104fc6:	83 c4 20             	add    $0x20,%esp
80104fc9:	e8 4c e2 ff ff       	call   8010321a <myproc>
80104fce:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80104fd5:	e9 a4 fe ff ff       	jmp    80104e7e <trap+0x66>
80104fda:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80104fdd:	8b 73 38             	mov    0x38(%ebx),%esi
80104fe0:	e8 1a e2 ff ff       	call   801031ff <cpuid>
80104fe5:	83 ec 0c             	sub    $0xc,%esp
80104fe8:	57                   	push   %edi
80104fe9:	56                   	push   %esi
80104fea:	50                   	push   %eax
80104feb:	ff 73 30             	push   0x30(%ebx)
80104fee:	68 50 6f 10 80       	push   $0x80106f50
80104ff3:	e8 0f b6 ff ff       	call   80100607 <cprintf>
      panic("trap");
80104ff8:	83 c4 14             	add    $0x14,%esp
80104ffb:	68 26 6f 10 80       	push   $0x80106f26
80105000:	e8 43 b3 ff ff       	call   80100348 <panic>
    exit();
80105005:	e8 ba e5 ff ff       	call   801035c4 <exit>
8010500a:	e9 94 fe ff ff       	jmp    80104ea3 <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
8010500f:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105013:	0f 85 a2 fe ff ff    	jne    80104ebb <trap+0xa3>
    yield();
80105019:	e8 6c e6 ff ff       	call   8010368a <yield>
8010501e:	e9 98 fe ff ff       	jmp    80104ebb <trap+0xa3>
    exit();
80105023:	e8 9c e5 ff ff       	call   801035c4 <exit>
80105028:	e9 b3 fe ff ff       	jmp    80104ee0 <trap+0xc8>
...
{
  if(!uart)
8010502d:	83 3d c0 44 11 80 00 	cmpl   $0x0,0x801144c0
80105034:	74 14                	je     8010504a <uartgetc+0x1d>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105036:	ba fd 03 00 00       	mov    $0x3fd,%edx
8010503b:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
8010503c:	a8 01                	test   $0x1,%al
8010503e:	74 10                	je     80105050 <uartgetc+0x23>
80105040:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105045:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
...
80105056 <uartputc>:
  if(!uart)
80105056:	83 3d c0 44 11 80 00 	cmpl   $0x0,0x801144c0
8010505d:	74 3b                	je     8010509a <uartputc+0x44>
{
...
80105066:	bb 00 00 00 00       	mov    $0x0,%ebx
8010506b:	eb 10                	jmp    8010507d <uartputc+0x27>
    microdelay(10);
8010506d:	83 ec 0c             	sub    $0xc,%esp
80105070:	6a 0a                	push   $0xa
80105072:	e8 52 d3 ff ff       	call   801023c9 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105077:	83 c3 01             	add    $0x1,%ebx
8010507a:	83 c4 10             	add    $0x10,%esp
8010507d:	83 fb 7f             	cmp    $0x7f,%ebx
80105080:	7f 0a                	jg     8010508c <uartputc+0x36>
80105082:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105087:	ec                   	in     (%dx),%al
80105088:	a8 20                	test   $0x20,%al
8010508a:	74 e1                	je     8010506d <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010508c:	8b 45 08             	mov    0x8(%ebp),%eax
8010508f:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105094:	ee                   	out    %al,(%dx)
}
...
801050a0:	b9 00 00 00 00       	mov    $0x0,%ecx
801050a5:	ba fa 03 00 00       	mov    $0x3fa,%edx
801050aa:	89 c8                	mov    %ecx,%eax
801050ac:	ee                   	out    %al,(%dx)
801050ad:	be fb 03 00 00       	mov    $0x3fb,%esi
801050b2:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801050b7:	89 f2                	mov    %esi,%edx
801050b9:	ee                   	out    %al,(%dx)
801050ba:	b8 0c 00 00 00       	mov    $0xc,%eax
801050bf:	ba f8 03 00 00       	mov    $0x3f8,%edx
801050c4:	ee                   	out    %al,(%dx)
801050c5:	bb f9 03 00 00       	mov    $0x3f9,%ebx
801050ca:	89 c8                	mov    %ecx,%eax
801050cc:	89 da                	mov    %ebx,%edx
801050ce:	ee                   	out    %al,(%dx)
801050cf:	b8 03 00 00 00       	mov    $0x3,%eax
801050d4:	89 f2                	mov    %esi,%edx
801050d6:	ee                   	out    %al,(%dx)
801050d7:	ba fc 03 00 00       	mov    $0x3fc,%edx
801050dc:	89 c8                	mov    %ecx,%eax
801050de:	ee                   	out    %al,(%dx)
801050df:	b8 01 00 00 00       	mov    $0x1,%eax
801050e4:	89 da                	mov    %ebx,%edx
801050e6:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801050e7:	ba fd 03 00 00       	mov    $0x3fd,%edx
801050ec:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
801050ed:	3c ff                	cmp    $0xff,%al
801050ef:	74 45                	je     80105136 <uartinit+0x9b>
  uart = 1;
801050f1:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
801050f8:	00 00 00 
801050fb:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105100:	ec                   	in     (%dx),%al
80105101:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105106:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105107:	83 ec 08             	sub    $0x8,%esp
8010510a:	6a 00                	push   $0x0
8010510c:	6a 04                	push   $0x4
8010510e:	e8 4e ce ff ff       	call   80101f61 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105113:	83 c4 10             	add    $0x10,%esp
80105116:	bb 48 70 10 80       	mov    $0x80107048,%ebx
8010511b:	eb 12                	jmp    8010512f <uartinit+0x94>
    uartputc(*p);
8010511d:	83 ec 0c             	sub    $0xc,%esp
80105120:	0f be c0             	movsbl %al,%eax
80105123:	50                   	push   %eax
80105124:	e8 2d ff ff ff       	call   80105056 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105129:	83 c3 01             	add    $0x1,%ebx
8010512c:	83 c4 10             	add    $0x10,%esp
8010512f:	0f b6 03             	movzbl (%ebx),%eax
80105132:	84 c0                	test   %al,%al
80105134:	75 e7                	jne    8010511d <uartinit+0x82>
}
80105136:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105139:	5b                   	pop    %ebx
8010513a:	5e                   	pop    %esi
8010513b:	5d                   	pop    %ebp
8010513c:	c3                   	ret    
...
80105140:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105143:	68 2d 50 10 80       	push   $0x8010502d
80105148:	e8 e6 b5 ff ff       	call   80100733 <consoleintr>
}
...
80105154:	6a 00                	push   $0x0
  jmp alltraps
80105156:	e9 71 fb ff ff       	jmp    80104ccc <alltraps>
...
8010515d:	6a 01                	push   $0x1
  jmp alltraps
8010515f:	e9 68 fb ff ff       	jmp    80104ccc <alltraps>
...
80105164:	6a 00                	push   $0x0
  pushl $2
80105166:	6a 02                	push   $0x2
  jmp alltraps
80105168:	e9 5f fb ff ff       	jmp    80104ccc <alltraps>
...
8010516d:	6a 00                	push   $0x0
  pushl $3
8010516f:	6a 03                	push   $0x3
  jmp alltraps
80105171:	e9 56 fb ff ff       	jmp    80104ccc <alltraps>
...
80105176:	6a 00                	push   $0x0
  pushl $4
80105178:	6a 04                	push   $0x4
  jmp alltraps
8010517a:	e9 4d fb ff ff       	jmp    80104ccc <alltraps>
...
8010517f:	6a 00                	push   $0x0
  pushl $5
80105181:	6a 05                	push   $0x5
  jmp alltraps
80105183:	e9 44 fb ff ff       	jmp    80104ccc <alltraps>
...
80105188:	6a 00                	push   $0x0
  pushl $6
8010518a:	6a 06                	push   $0x6
  jmp alltraps
8010518c:	e9 3b fb ff ff       	jmp    80104ccc <alltraps>
...
80105191:	6a 00                	push   $0x0
  pushl $7
80105193:	6a 07                	push   $0x7
  jmp alltraps
80105195:	e9 32 fb ff ff       	jmp    80104ccc <alltraps>

8010519a <vector8>:
.globl vector8
vector8:
  pushl $8
8010519a:	6a 08                	push   $0x8
  jmp alltraps
8010519c:	e9 2b fb ff ff       	jmp    80104ccc <alltraps>
...
801051a1:	6a 00                	push   $0x0
  pushl $9
801051a3:	6a 09                	push   $0x9
  jmp alltraps
801051a5:	e9 22 fb ff ff       	jmp    80104ccc <alltraps>

801051aa <vector10>:
.globl vector10
vector10:
  pushl $10
801051aa:	6a 0a                	push   $0xa
  jmp alltraps
801051ac:	e9 1b fb ff ff       	jmp    80104ccc <alltraps>

801051b1 <vector11>:
.globl vector11
vector11:
  pushl $11
801051b1:	6a 0b                	push   $0xb
  jmp alltraps
801051b3:	e9 14 fb ff ff       	jmp    80104ccc <alltraps>

801051b8 <vector12>:
.globl vector12
vector12:
  pushl $12
801051b8:	6a 0c                	push   $0xc
  jmp alltraps
801051ba:	e9 0d fb ff ff       	jmp    80104ccc <alltraps>

801051bf <vector13>:
.globl vector13
vector13:
  pushl $13
801051bf:	6a 0d                	push   $0xd
  jmp alltraps
801051c1:	e9 06 fb ff ff       	jmp    80104ccc <alltraps>

801051c6 <vector14>:
.globl vector14
vector14:
  pushl $14
801051c6:	6a 0e                	push   $0xe
  jmp alltraps
801051c8:	e9 ff fa ff ff       	jmp    80104ccc <alltraps>
...
801051cd:	6a 00                	push   $0x0
  pushl $15
801051cf:	6a 0f                	push   $0xf
  jmp alltraps
801051d1:	e9 f6 fa ff ff       	jmp    80104ccc <alltraps>
...
801051d8:	6a 10                	push   $0x10
  jmp alltraps
801051da:	e9 ed fa ff ff       	jmp    80104ccc <alltraps>

801051df <vector17>:
.globl vector17
vector17:
  pushl $17
801051df:	6a 11                	push   $0x11
  jmp alltraps
801051e1:	e9 e6 fa ff ff       	jmp    80104ccc <alltraps>
...
801051e6:	6a 00                	push   $0x0
  pushl $18
801051e8:	6a 12                	push   $0x12
  jmp alltraps
801051ea:	e9 dd fa ff ff       	jmp    80104ccc <alltraps>
...
801051ef:	6a 00                	push   $0x0
  pushl $19
801051f1:	6a 13                	push   $0x13
  jmp alltraps
801051f3:	e9 d4 fa ff ff       	jmp    80104ccc <alltraps>
...
801051fa:	6a 14                	push   $0x14
  jmp alltraps
801051fc:	e9 cb fa ff ff       	jmp    80104ccc <alltraps>
...
80105201:	6a 00                	push   $0x0
  pushl $21
80105203:	6a 15                	push   $0x15
  jmp alltraps
80105205:	e9 c2 fa ff ff       	jmp    80104ccc <alltraps>
...
8010520a:	6a 00                	push   $0x0
  pushl $22
8010520c:	6a 16                	push   $0x16
  jmp alltraps
8010520e:	e9 b9 fa ff ff       	jmp    80104ccc <alltraps>
...
80105213:	6a 00                	push   $0x0
  pushl $23
80105215:	6a 17                	push   $0x17
  jmp alltraps
80105217:	e9 b0 fa ff ff       	jmp    80104ccc <alltraps>
...
8010521c:	6a 00                	push   $0x0
  pushl $24
8010521e:	6a 18                	push   $0x18
  jmp alltraps
80105220:	e9 a7 fa ff ff       	jmp    80104ccc <alltraps>
...
80105225:	6a 00                	push   $0x0
  pushl $25
80105227:	6a 19                	push   $0x19
  jmp alltraps
80105229:	e9 9e fa ff ff       	jmp    80104ccc <alltraps>
...
8010522e:	6a 00                	push   $0x0
  pushl $26
80105230:	6a 1a                	push   $0x1a
  jmp alltraps
80105232:	e9 95 fa ff ff       	jmp    80104ccc <alltraps>
...
80105237:	6a 00                	push   $0x0
  pushl $27
80105239:	6a 1b                	push   $0x1b
  jmp alltraps
8010523b:	e9 8c fa ff ff       	jmp    80104ccc <alltraps>
...
80105240:	6a 00                	push   $0x0
  pushl $28
80105242:	6a 1c                	push   $0x1c
  jmp alltraps
80105244:	e9 83 fa ff ff       	jmp    80104ccc <alltraps>
...
80105249:	6a 00                	push   $0x0
  pushl $29
8010524b:	6a 1d                	push   $0x1d
  jmp alltraps
8010524d:	e9 7a fa ff ff       	jmp    80104ccc <alltraps>
...
80105252:	6a 00                	push   $0x0
  pushl $30
80105254:	6a 1e                	push   $0x1e
  jmp alltraps
80105256:	e9 71 fa ff ff       	jmp    80104ccc <alltraps>
...
8010525b:	6a 00                	push   $0x0
  pushl $31
8010525d:	6a 1f                	push   $0x1f
  jmp alltraps
8010525f:	e9 68 fa ff ff       	jmp    80104ccc <alltraps>
...
80105264:	6a 00                	push   $0x0
  pushl $32
80105266:	6a 20                	push   $0x20
  jmp alltraps
80105268:	e9 5f fa ff ff       	jmp    80104ccc <alltraps>
...
8010526d:	6a 00                	push   $0x0
  pushl $33
8010526f:	6a 21                	push   $0x21
  jmp alltraps
80105271:	e9 56 fa ff ff       	jmp    80104ccc <alltraps>
...
80105276:	6a 00                	push   $0x0
  pushl $34
80105278:	6a 22                	push   $0x22
  jmp alltraps
8010527a:	e9 4d fa ff ff       	jmp    80104ccc <alltraps>
...
8010527f:	6a 00                	push   $0x0
  pushl $35
80105281:	6a 23                	push   $0x23
  jmp alltraps
80105283:	e9 44 fa ff ff       	jmp    80104ccc <alltraps>
...
80105288:	6a 00                	push   $0x0
  pushl $36
8010528a:	6a 24                	push   $0x24
  jmp alltraps
8010528c:	e9 3b fa ff ff       	jmp    80104ccc <alltraps>
...
80105291:	6a 00                	push   $0x0
  pushl $37
80105293:	6a 25                	push   $0x25
  jmp alltraps
80105295:	e9 32 fa ff ff       	jmp    80104ccc <alltraps>
...
8010529a:	6a 00                	push   $0x0
  pushl $38
8010529c:	6a 26                	push   $0x26
  jmp alltraps
8010529e:	e9 29 fa ff ff       	jmp    80104ccc <alltraps>
...
801052a3:	6a 00                	push   $0x0
  pushl $39
801052a5:	6a 27                	push   $0x27
  jmp alltraps
801052a7:	e9 20 fa ff ff       	jmp    80104ccc <alltraps>
...
801052ac:	6a 00                	push   $0x0
  pushl $40
801052ae:	6a 28                	push   $0x28
  jmp alltraps
801052b0:	e9 17 fa ff ff       	jmp    80104ccc <alltraps>
...
801052b5:	6a 00                	push   $0x0
  pushl $41
801052b7:	6a 29                	push   $0x29
  jmp alltraps
801052b9:	e9 0e fa ff ff       	jmp    80104ccc <alltraps>
...
801052be:	6a 00                	push   $0x0
  pushl $42
801052c0:	6a 2a                	push   $0x2a
  jmp alltraps
801052c2:	e9 05 fa ff ff       	jmp    80104ccc <alltraps>
...
801052c7:	6a 00                	push   $0x0
  pushl $43
801052c9:	6a 2b                	push   $0x2b
  jmp alltraps
801052cb:	e9 fc f9 ff ff       	jmp    80104ccc <alltraps>
...
801052d0:	6a 00                	push   $0x0
  pushl $44
801052d2:	6a 2c                	push   $0x2c
  jmp alltraps
801052d4:	e9 f3 f9 ff ff       	jmp    80104ccc <alltraps>
...
801052d9:	6a 00                	push   $0x0
  pushl $45
801052db:	6a 2d                	push   $0x2d
  jmp alltraps
801052dd:	e9 ea f9 ff ff       	jmp    80104ccc <alltraps>
...
801052e2:	6a 00                	push   $0x0
  pushl $46
801052e4:	6a 2e                	push   $0x2e
  jmp alltraps
801052e6:	e9 e1 f9 ff ff       	jmp    80104ccc <alltraps>
...
801052eb:	6a 00                	push   $0x0
  pushl $47
801052ed:	6a 2f                	push   $0x2f
  jmp alltraps
801052ef:	e9 d8 f9 ff ff       	jmp    80104ccc <alltraps>
...
801052f4:	6a 00                	push   $0x0
  pushl $48
801052f6:	6a 30                	push   $0x30
  jmp alltraps
801052f8:	e9 cf f9 ff ff       	jmp    80104ccc <alltraps>
...
801052fd:	6a 00                	push   $0x0
  pushl $49
801052ff:	6a 31                	push   $0x31
  jmp alltraps
80105301:	e9 c6 f9 ff ff       	jmp    80104ccc <alltraps>
...
80105306:	6a 00                	push   $0x0
  pushl $50
80105308:	6a 32                	push   $0x32
  jmp alltraps
8010530a:	e9 bd f9 ff ff       	jmp    80104ccc <alltraps>
...
8010530f:	6a 00                	push   $0x0
  pushl $51
80105311:	6a 33                	push   $0x33
  jmp alltraps
80105313:	e9 b4 f9 ff ff       	jmp    80104ccc <alltraps>
...
80105318:	6a 00                	push   $0x0
  pushl $52
8010531a:	6a 34                	push   $0x34
  jmp alltraps
8010531c:	e9 ab f9 ff ff       	jmp    80104ccc <alltraps>
...
80105321:	6a 00                	push   $0x0
  pushl $53
80105323:	6a 35                	push   $0x35
  jmp alltraps
80105325:	e9 a2 f9 ff ff       	jmp    80104ccc <alltraps>
...
8010532a:	6a 00                	push   $0x0
  pushl $54
8010532c:	6a 36                	push   $0x36
  jmp alltraps
8010532e:	e9 99 f9 ff ff       	jmp    80104ccc <alltraps>
...
80105333:	6a 00                	push   $0x0
  pushl $55
80105335:	6a 37                	push   $0x37
  jmp alltraps
80105337:	e9 90 f9 ff ff       	jmp    80104ccc <alltraps>
...
8010533c:	6a 00                	push   $0x0
  pushl $56
8010533e:	6a 38                	push   $0x38
  jmp alltraps
80105340:	e9 87 f9 ff ff       	jmp    80104ccc <alltraps>
...
80105345:	6a 00                	push   $0x0
  pushl $57
80105347:	6a 39                	push   $0x39
  jmp alltraps
80105349:	e9 7e f9 ff ff       	jmp    80104ccc <alltraps>
...
8010534e:	6a 00                	push   $0x0
  pushl $58
80105350:	6a 3a                	push   $0x3a
  jmp alltraps
80105352:	e9 75 f9 ff ff       	jmp    80104ccc <alltraps>
...
80105357:	6a 00                	push   $0x0
  pushl $59
80105359:	6a 3b                	push   $0x3b
  jmp alltraps
8010535b:	e9 6c f9 ff ff       	jmp    80104ccc <alltraps>
...
80105360:	6a 00                	push   $0x0
  pushl $60
80105362:	6a 3c                	push   $0x3c
  jmp alltraps
80105364:	e9 63 f9 ff ff       	jmp    80104ccc <alltraps>
...
80105369:	6a 00                	push   $0x0
  pushl $61
8010536b:	6a 3d                	push   $0x3d
  jmp alltraps
8010536d:	e9 5a f9 ff ff       	jmp    80104ccc <alltraps>
...
80105372:	6a 00                	push   $0x0
  pushl $62
80105374:	6a 3e                	push   $0x3e
  jmp alltraps
80105376:	e9 51 f9 ff ff       	jmp    80104ccc <alltraps>
...
8010537b:	6a 00                	push   $0x0
  pushl $63
8010537d:	6a 3f                	push   $0x3f
  jmp alltraps
8010537f:	e9 48 f9 ff ff       	jmp    80104ccc <alltraps>
...
80105384:	6a 00                	push   $0x0
  pushl $64
80105386:	6a 40                	push   $0x40
  jmp alltraps
80105388:	e9 3f f9 ff ff       	jmp    80104ccc <alltraps>
...
8010538d:	6a 00                	push   $0x0
  pushl $65
8010538f:	6a 41                	push   $0x41
  jmp alltraps
80105391:	e9 36 f9 ff ff       	jmp    80104ccc <alltraps>
...
80105396:	6a 00                	push   $0x0
  pushl $66
80105398:	6a 42                	push   $0x42
  jmp alltraps
8010539a:	e9 2d f9 ff ff       	jmp    80104ccc <alltraps>
...
8010539f:	6a 00                	push   $0x0
  pushl $67
801053a1:	6a 43                	push   $0x43
  jmp alltraps
801053a3:	e9 24 f9 ff ff       	jmp    80104ccc <alltraps>
...
801053a8:	6a 00                	push   $0x0
  pushl $68
801053aa:	6a 44                	push   $0x44
  jmp alltraps
801053ac:	e9 1b f9 ff ff       	jmp    80104ccc <alltraps>
...
801053b1:	6a 00                	push   $0x0
  pushl $69
801053b3:	6a 45                	push   $0x45
  jmp alltraps
801053b5:	e9 12 f9 ff ff       	jmp    80104ccc <alltraps>
...
801053ba:	6a 00                	push   $0x0
  pushl $70
801053bc:	6a 46                	push   $0x46
  jmp alltraps
801053be:	e9 09 f9 ff ff       	jmp    80104ccc <alltraps>
...
801053c3:	6a 00                	push   $0x0
  pushl $71
801053c5:	6a 47                	push   $0x47
  jmp alltraps
801053c7:	e9 00 f9 ff ff       	jmp    80104ccc <alltraps>
...
801053cc:	6a 00                	push   $0x0
  pushl $72
801053ce:	6a 48                	push   $0x48
  jmp alltraps
801053d0:	e9 f7 f8 ff ff       	jmp    80104ccc <alltraps>
...
801053d5:	6a 00                	push   $0x0
  pushl $73
801053d7:	6a 49                	push   $0x49
  jmp alltraps
801053d9:	e9 ee f8 ff ff       	jmp    80104ccc <alltraps>
...
801053de:	6a 00                	push   $0x0
  pushl $74
801053e0:	6a 4a                	push   $0x4a
  jmp alltraps
801053e2:	e9 e5 f8 ff ff       	jmp    80104ccc <alltraps>
...
801053e7:	6a 00                	push   $0x0
  pushl $75
801053e9:	6a 4b                	push   $0x4b
  jmp alltraps
801053eb:	e9 dc f8 ff ff       	jmp    80104ccc <alltraps>
...
801053f0:	6a 00                	push   $0x0
  pushl $76
801053f2:	6a 4c                	push   $0x4c
  jmp alltraps
801053f4:	e9 d3 f8 ff ff       	jmp    80104ccc <alltraps>
...
801053f9:	6a 00                	push   $0x0
  pushl $77
801053fb:	6a 4d                	push   $0x4d
  jmp alltraps
801053fd:	e9 ca f8 ff ff       	jmp    80104ccc <alltraps>
...
80105402:	6a 00                	push   $0x0
  pushl $78
80105404:	6a 4e                	push   $0x4e
  jmp alltraps
80105406:	e9 c1 f8 ff ff       	jmp    80104ccc <alltraps>
...
8010540b:	6a 00                	push   $0x0
  pushl $79
8010540d:	6a 4f                	push   $0x4f
  jmp alltraps
8010540f:	e9 b8 f8 ff ff       	jmp    80104ccc <alltraps>
...
80105414:	6a 00                	push   $0x0
  pushl $80
80105416:	6a 50                	push   $0x50
  jmp alltraps
80105418:	e9 af f8 ff ff       	jmp    80104ccc <alltraps>
...
8010541d:	6a 00                	push   $0x0
  pushl $81
8010541f:	6a 51                	push   $0x51
  jmp alltraps
80105421:	e9 a6 f8 ff ff       	jmp    80104ccc <alltraps>
...
80105426:	6a 00                	push   $0x0
  pushl $82
80105428:	6a 52                	push   $0x52
  jmp alltraps
8010542a:	e9 9d f8 ff ff       	jmp    80104ccc <alltraps>
...
8010542f:	6a 00                	push   $0x0
  pushl $83
80105431:	6a 53                	push   $0x53
  jmp alltraps
80105433:	e9 94 f8 ff ff       	jmp    80104ccc <alltraps>
...
80105438:	6a 00                	push   $0x0
  pushl $84
8010543a:	6a 54                	push   $0x54
  jmp alltraps
8010543c:	e9 8b f8 ff ff       	jmp    80104ccc <alltraps>
...
80105441:	6a 00                	push   $0x0
  pushl $85
80105443:	6a 55                	push   $0x55
  jmp alltraps
80105445:	e9 82 f8 ff ff       	jmp    80104ccc <alltraps>
...
8010544a:	6a 00                	push   $0x0
  pushl $86
8010544c:	6a 56                	push   $0x56
  jmp alltraps
8010544e:	e9 79 f8 ff ff       	jmp    80104ccc <alltraps>
...
80105453:	6a 00                	push   $0x0
  pushl $87
80105455:	6a 57                	push   $0x57
  jmp alltraps
80105457:	e9 70 f8 ff ff       	jmp    80104ccc <alltraps>
...
8010545c:	6a 00                	push   $0x0
  pushl $88
8010545e:	6a 58                	push   $0x58
  jmp alltraps
80105460:	e9 67 f8 ff ff       	jmp    80104ccc <alltraps>
...
80105465:	6a 00                	push   $0x0
  pushl $89
80105467:	6a 59                	push   $0x59
  jmp alltraps
80105469:	e9 5e f8 ff ff       	jmp    80104ccc <alltraps>
...
8010546e:	6a 00                	push   $0x0
  pushl $90
80105470:	6a 5a                	push   $0x5a
  jmp alltraps
80105472:	e9 55 f8 ff ff       	jmp    80104ccc <alltraps>
...
80105477:	6a 00                	push   $0x0
  pushl $91
80105479:	6a 5b                	push   $0x5b
  jmp alltraps
8010547b:	e9 4c f8 ff ff       	jmp    80104ccc <alltraps>
...
80105480:	6a 00                	push   $0x0
  pushl $92
80105482:	6a 5c                	push   $0x5c
  jmp alltraps
80105484:	e9 43 f8 ff ff       	jmp    80104ccc <alltraps>
...
80105489:	6a 00                	push   $0x0
  pushl $93
8010548b:	6a 5d                	push   $0x5d
  jmp alltraps
8010548d:	e9 3a f8 ff ff       	jmp    80104ccc <alltraps>
...
80105492:	6a 00                	push   $0x0
  pushl $94
80105494:	6a 5e                	push   $0x5e
  jmp alltraps
80105496:	e9 31 f8 ff ff       	jmp    80104ccc <alltraps>
...
8010549b:	6a 00                	push   $0x0
  pushl $95
8010549d:	6a 5f                	push   $0x5f
  jmp alltraps
8010549f:	e9 28 f8 ff ff       	jmp    80104ccc <alltraps>
...
801054a4:	6a 00                	push   $0x0
  pushl $96
801054a6:	6a 60                	push   $0x60
  jmp alltraps
801054a8:	e9 1f f8 ff ff       	jmp    80104ccc <alltraps>
...
801054ad:	6a 00                	push   $0x0
  pushl $97
801054af:	6a 61                	push   $0x61
  jmp alltraps
801054b1:	e9 16 f8 ff ff       	jmp    80104ccc <alltraps>
...
801054b6:	6a 00                	push   $0x0
  pushl $98
801054b8:	6a 62                	push   $0x62
  jmp alltraps
801054ba:	e9 0d f8 ff ff       	jmp    80104ccc <alltraps>
...
801054bf:	6a 00                	push   $0x0
  pushl $99
801054c1:	6a 63                	push   $0x63
  jmp alltraps
801054c3:	e9 04 f8 ff ff       	jmp    80104ccc <alltraps>
...
801054c8:	6a 00                	push   $0x0
  pushl $100
801054ca:	6a 64                	push   $0x64
  jmp alltraps
801054cc:	e9 fb f7 ff ff       	jmp    80104ccc <alltraps>
...
801054d1:	6a 00                	push   $0x0
  pushl $101
801054d3:	6a 65                	push   $0x65
  jmp alltraps
801054d5:	e9 f2 f7 ff ff       	jmp    80104ccc <alltraps>
...
801054da:	6a 00                	push   $0x0
  pushl $102
801054dc:	6a 66                	push   $0x66
  jmp alltraps
801054de:	e9 e9 f7 ff ff       	jmp    80104ccc <alltraps>
...
801054e3:	6a 00                	push   $0x0
  pushl $103
801054e5:	6a 67                	push   $0x67
  jmp alltraps
801054e7:	e9 e0 f7 ff ff       	jmp    80104ccc <alltraps>
...
801054ec:	6a 00                	push   $0x0
  pushl $104
801054ee:	6a 68                	push   $0x68
  jmp alltraps
801054f0:	e9 d7 f7 ff ff       	jmp    80104ccc <alltraps>
...
801054f5:	6a 00                	push   $0x0
  pushl $105
801054f7:	6a 69                	push   $0x69
  jmp alltraps
801054f9:	e9 ce f7 ff ff       	jmp    80104ccc <alltraps>
...
801054fe:	6a 00                	push   $0x0
  pushl $106
80105500:	6a 6a                	push   $0x6a
  jmp alltraps
80105502:	e9 c5 f7 ff ff       	jmp    80104ccc <alltraps>
...
80105507:	6a 00                	push   $0x0
  pushl $107
80105509:	6a 6b                	push   $0x6b
  jmp alltraps
8010550b:	e9 bc f7 ff ff       	jmp    80104ccc <alltraps>
...
80105510:	6a 00                	push   $0x0
  pushl $108
80105512:	6a 6c                	push   $0x6c
  jmp alltraps
80105514:	e9 b3 f7 ff ff       	jmp    80104ccc <alltraps>
...
80105519:	6a 00                	push   $0x0
  pushl $109
8010551b:	6a 6d                	push   $0x6d
  jmp alltraps
8010551d:	e9 aa f7 ff ff       	jmp    80104ccc <alltraps>
...
80105522:	6a 00                	push   $0x0
  pushl $110
80105524:	6a 6e                	push   $0x6e
  jmp alltraps
80105526:	e9 a1 f7 ff ff       	jmp    80104ccc <alltraps>
...
8010552b:	6a 00                	push   $0x0
  pushl $111
8010552d:	6a 6f                	push   $0x6f
  jmp alltraps
8010552f:	e9 98 f7 ff ff       	jmp    80104ccc <alltraps>
...
80105534:	6a 00                	push   $0x0
  pushl $112
80105536:	6a 70                	push   $0x70
  jmp alltraps
80105538:	e9 8f f7 ff ff       	jmp    80104ccc <alltraps>
...
8010553d:	6a 00                	push   $0x0
  pushl $113
8010553f:	6a 71                	push   $0x71
  jmp alltraps
80105541:	e9 86 f7 ff ff       	jmp    80104ccc <alltraps>
...
80105546:	6a 00                	push   $0x0
  pushl $114
80105548:	6a 72                	push   $0x72
  jmp alltraps
8010554a:	e9 7d f7 ff ff       	jmp    80104ccc <alltraps>
...
8010554f:	6a 00                	push   $0x0
  pushl $115
80105551:	6a 73                	push   $0x73
  jmp alltraps
80105553:	e9 74 f7 ff ff       	jmp    80104ccc <alltraps>
...
80105558:	6a 00                	push   $0x0
  pushl $116
8010555a:	6a 74                	push   $0x74
  jmp alltraps
8010555c:	e9 6b f7 ff ff       	jmp    80104ccc <alltraps>
...
80105561:	6a 00                	push   $0x0
  pushl $117
80105563:	6a 75                	push   $0x75
  jmp alltraps
80105565:	e9 62 f7 ff ff       	jmp    80104ccc <alltraps>
...
8010556a:	6a 00                	push   $0x0
  pushl $118
8010556c:	6a 76                	push   $0x76
  jmp alltraps
8010556e:	e9 59 f7 ff ff       	jmp    80104ccc <alltraps>
...
80105573:	6a 00                	push   $0x0
  pushl $119
80105575:	6a 77                	push   $0x77
  jmp alltraps
80105577:	e9 50 f7 ff ff       	jmp    80104ccc <alltraps>
...
8010557c:	6a 00                	push   $0x0
  pushl $120
8010557e:	6a 78                	push   $0x78
  jmp alltraps
80105580:	e9 47 f7 ff ff       	jmp    80104ccc <alltraps>
...
80105585:	6a 00                	push   $0x0
  pushl $121
80105587:	6a 79                	push   $0x79
  jmp alltraps
80105589:	e9 3e f7 ff ff       	jmp    80104ccc <alltraps>
...
8010558e:	6a 00                	push   $0x0
  pushl $122
80105590:	6a 7a                	push   $0x7a
  jmp alltraps
80105592:	e9 35 f7 ff ff       	jmp    80104ccc <alltraps>
...
80105597:	6a 00                	push   $0x0
  pushl $123
80105599:	6a 7b                	push   $0x7b
  jmp alltraps
8010559b:	e9 2c f7 ff ff       	jmp    80104ccc <alltraps>
...
801055a0:	6a 00                	push   $0x0
  pushl $124
801055a2:	6a 7c                	push   $0x7c
  jmp alltraps
801055a4:	e9 23 f7 ff ff       	jmp    80104ccc <alltraps>
...
801055a9:	6a 00                	push   $0x0
  pushl $125
801055ab:	6a 7d                	push   $0x7d
  jmp alltraps
801055ad:	e9 1a f7 ff ff       	jmp    80104ccc <alltraps>
...
801055b2:	6a 00                	push   $0x0
  pushl $126
801055b4:	6a 7e                	push   $0x7e
  jmp alltraps
801055b6:	e9 11 f7 ff ff       	jmp    80104ccc <alltraps>
...
801055bb:	6a 00                	push   $0x0
  pushl $127
801055bd:	6a 7f                	push   $0x7f
  jmp alltraps
801055bf:	e9 08 f7 ff ff       	jmp    80104ccc <alltraps>
...
801055c4:	6a 00                	push   $0x0
  pushl $128
801055c6:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801055cb:	e9 fc f6 ff ff       	jmp    80104ccc <alltraps>
...
801055d0:	6a 00                	push   $0x0
  pushl $129
801055d2:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801055d7:	e9 f0 f6 ff ff       	jmp    80104ccc <alltraps>
...
801055dc:	6a 00                	push   $0x0
  pushl $130
801055de:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801055e3:	e9 e4 f6 ff ff       	jmp    80104ccc <alltraps>
...
801055e8:	6a 00                	push   $0x0
  pushl $131
801055ea:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801055ef:	e9 d8 f6 ff ff       	jmp    80104ccc <alltraps>
...
801055f4:	6a 00                	push   $0x0
  pushl $132
801055f6:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801055fb:	e9 cc f6 ff ff       	jmp    80104ccc <alltraps>
...
80105600:	6a 00                	push   $0x0
  pushl $133
80105602:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105607:	e9 c0 f6 ff ff       	jmp    80104ccc <alltraps>
...
8010560c:	6a 00                	push   $0x0
  pushl $134
8010560e:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105613:	e9 b4 f6 ff ff       	jmp    80104ccc <alltraps>
...
80105618:	6a 00                	push   $0x0
  pushl $135
8010561a:	68 87 00 00 00       	push   $0x87
  jmp alltraps
8010561f:	e9 a8 f6 ff ff       	jmp    80104ccc <alltraps>
...
80105624:	6a 00                	push   $0x0
  pushl $136
80105626:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010562b:	e9 9c f6 ff ff       	jmp    80104ccc <alltraps>
...
80105630:	6a 00                	push   $0x0
  pushl $137
80105632:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105637:	e9 90 f6 ff ff       	jmp    80104ccc <alltraps>
...
8010563c:	6a 00                	push   $0x0
  pushl $138
8010563e:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105643:	e9 84 f6 ff ff       	jmp    80104ccc <alltraps>
...
80105648:	6a 00                	push   $0x0
  pushl $139
8010564a:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
8010564f:	e9 78 f6 ff ff       	jmp    80104ccc <alltraps>
...
80105654:	6a 00                	push   $0x0
  pushl $140
80105656:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010565b:	e9 6c f6 ff ff       	jmp    80104ccc <alltraps>
...
80105660:	6a 00                	push   $0x0
  pushl $141
80105662:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105667:	e9 60 f6 ff ff       	jmp    80104ccc <alltraps>
...
8010566c:	6a 00                	push   $0x0
  pushl $142
8010566e:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105673:	e9 54 f6 ff ff       	jmp    80104ccc <alltraps>
...
80105678:	6a 00                	push   $0x0
  pushl $143
8010567a:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010567f:	e9 48 f6 ff ff       	jmp    80104ccc <alltraps>
...
80105684:	6a 00                	push   $0x0
  pushl $144
80105686:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010568b:	e9 3c f6 ff ff       	jmp    80104ccc <alltraps>
...
80105690:	6a 00                	push   $0x0
  pushl $145
80105692:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105697:	e9 30 f6 ff ff       	jmp    80104ccc <alltraps>
...
8010569c:	6a 00                	push   $0x0
  pushl $146
8010569e:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801056a3:	e9 24 f6 ff ff       	jmp    80104ccc <alltraps>
...
801056a8:	6a 00                	push   $0x0
  pushl $147
801056aa:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801056af:	e9 18 f6 ff ff       	jmp    80104ccc <alltraps>
...
801056b4:	6a 00                	push   $0x0
  pushl $148
801056b6:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801056bb:	e9 0c f6 ff ff       	jmp    80104ccc <alltraps>
...
801056c0:	6a 00                	push   $0x0
  pushl $149
801056c2:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801056c7:	e9 00 f6 ff ff       	jmp    80104ccc <alltraps>
...
801056cc:	6a 00                	push   $0x0
  pushl $150
801056ce:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801056d3:	e9 f4 f5 ff ff       	jmp    80104ccc <alltraps>
...
801056d8:	6a 00                	push   $0x0
  pushl $151
801056da:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801056df:	e9 e8 f5 ff ff       	jmp    80104ccc <alltraps>
...
801056e4:	6a 00                	push   $0x0
  pushl $152
801056e6:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801056eb:	e9 dc f5 ff ff       	jmp    80104ccc <alltraps>
...
801056f0:	6a 00                	push   $0x0
  pushl $153
801056f2:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801056f7:	e9 d0 f5 ff ff       	jmp    80104ccc <alltraps>
...
801056fc:	6a 00                	push   $0x0
  pushl $154
801056fe:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105703:	e9 c4 f5 ff ff       	jmp    80104ccc <alltraps>
...
80105708:	6a 00                	push   $0x0
  pushl $155
8010570a:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010570f:	e9 b8 f5 ff ff       	jmp    80104ccc <alltraps>
...
80105714:	6a 00                	push   $0x0
  pushl $156
80105716:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010571b:	e9 ac f5 ff ff       	jmp    80104ccc <alltraps>
...
80105720:	6a 00                	push   $0x0
  pushl $157
80105722:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105727:	e9 a0 f5 ff ff       	jmp    80104ccc <alltraps>
...
8010572c:	6a 00                	push   $0x0
  pushl $158
8010572e:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105733:	e9 94 f5 ff ff       	jmp    80104ccc <alltraps>
...
80105738:	6a 00                	push   $0x0
  pushl $159
8010573a:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010573f:	e9 88 f5 ff ff       	jmp    80104ccc <alltraps>
...
80105744:	6a 00                	push   $0x0
  pushl $160
80105746:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010574b:	e9 7c f5 ff ff       	jmp    80104ccc <alltraps>
...
80105750:	6a 00                	push   $0x0
  pushl $161
80105752:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105757:	e9 70 f5 ff ff       	jmp    80104ccc <alltraps>
...
8010575c:	6a 00                	push   $0x0
  pushl $162
8010575e:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105763:	e9 64 f5 ff ff       	jmp    80104ccc <alltraps>
...
80105768:	6a 00                	push   $0x0
  pushl $163
8010576a:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010576f:	e9 58 f5 ff ff       	jmp    80104ccc <alltraps>
...
80105774:	6a 00                	push   $0x0
  pushl $164
80105776:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010577b:	e9 4c f5 ff ff       	jmp    80104ccc <alltraps>
...
80105780:	6a 00                	push   $0x0
  pushl $165
80105782:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105787:	e9 40 f5 ff ff       	jmp    80104ccc <alltraps>
...
8010578c:	6a 00                	push   $0x0
  pushl $166
8010578e:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105793:	e9 34 f5 ff ff       	jmp    80104ccc <alltraps>
...
80105798:	6a 00                	push   $0x0
  pushl $167
8010579a:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
8010579f:	e9 28 f5 ff ff       	jmp    80104ccc <alltraps>
...
801057a4:	6a 00                	push   $0x0
  pushl $168
801057a6:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801057ab:	e9 1c f5 ff ff       	jmp    80104ccc <alltraps>
...
801057b0:	6a 00                	push   $0x0
  pushl $169
801057b2:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801057b7:	e9 10 f5 ff ff       	jmp    80104ccc <alltraps>
...
801057bc:	6a 00                	push   $0x0
  pushl $170
801057be:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801057c3:	e9 04 f5 ff ff       	jmp    80104ccc <alltraps>
...
801057c8:	6a 00                	push   $0x0
  pushl $171
801057ca:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801057cf:	e9 f8 f4 ff ff       	jmp    80104ccc <alltraps>
...
801057d4:	6a 00                	push   $0x0
  pushl $172
801057d6:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801057db:	e9 ec f4 ff ff       	jmp    80104ccc <alltraps>
...
801057e0:	6a 00                	push   $0x0
  pushl $173
801057e2:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801057e7:	e9 e0 f4 ff ff       	jmp    80104ccc <alltraps>
...
801057ec:	6a 00                	push   $0x0
  pushl $174
801057ee:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801057f3:	e9 d4 f4 ff ff       	jmp    80104ccc <alltraps>
...
801057f8:	6a 00                	push   $0x0
  pushl $175
801057fa:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801057ff:	e9 c8 f4 ff ff       	jmp    80104ccc <alltraps>
...
80105804:	6a 00                	push   $0x0
  pushl $176
80105806:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010580b:	e9 bc f4 ff ff       	jmp    80104ccc <alltraps>
...
80105810:	6a 00                	push   $0x0
  pushl $177
80105812:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105817:	e9 b0 f4 ff ff       	jmp    80104ccc <alltraps>
...
8010581c:	6a 00                	push   $0x0
  pushl $178
8010581e:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80105823:	e9 a4 f4 ff ff       	jmp    80104ccc <alltraps>
...
80105828:	6a 00                	push   $0x0
  pushl $179
8010582a:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010582f:	e9 98 f4 ff ff       	jmp    80104ccc <alltraps>
...
80105834:	6a 00                	push   $0x0
  pushl $180
80105836:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010583b:	e9 8c f4 ff ff       	jmp    80104ccc <alltraps>
...
80105840:	6a 00                	push   $0x0
  pushl $181
80105842:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105847:	e9 80 f4 ff ff       	jmp    80104ccc <alltraps>
...
8010584c:	6a 00                	push   $0x0
  pushl $182
8010584e:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105853:	e9 74 f4 ff ff       	jmp    80104ccc <alltraps>
...
80105858:	6a 00                	push   $0x0
  pushl $183
8010585a:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010585f:	e9 68 f4 ff ff       	jmp    80104ccc <alltraps>
...
80105864:	6a 00                	push   $0x0
  pushl $184
80105866:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010586b:	e9 5c f4 ff ff       	jmp    80104ccc <alltraps>
...
80105870:	6a 00                	push   $0x0
  pushl $185
80105872:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105877:	e9 50 f4 ff ff       	jmp    80104ccc <alltraps>
...
8010587c:	6a 00                	push   $0x0
  pushl $186
8010587e:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105883:	e9 44 f4 ff ff       	jmp    80104ccc <alltraps>
...
80105888:	6a 00                	push   $0x0
  pushl $187
8010588a:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010588f:	e9 38 f4 ff ff       	jmp    80104ccc <alltraps>
...
80105894:	6a 00                	push   $0x0
  pushl $188
80105896:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010589b:	e9 2c f4 ff ff       	jmp    80104ccc <alltraps>
...
801058a0:	6a 00                	push   $0x0
  pushl $189
801058a2:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801058a7:	e9 20 f4 ff ff       	jmp    80104ccc <alltraps>
...
801058ac:	6a 00                	push   $0x0
  pushl $190
801058ae:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801058b3:	e9 14 f4 ff ff       	jmp    80104ccc <alltraps>
...
801058b8:	6a 00                	push   $0x0
  pushl $191
801058ba:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801058bf:	e9 08 f4 ff ff       	jmp    80104ccc <alltraps>
...
801058c4:	6a 00                	push   $0x0
  pushl $192
801058c6:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801058cb:	e9 fc f3 ff ff       	jmp    80104ccc <alltraps>
...
801058d0:	6a 00                	push   $0x0
  pushl $193
801058d2:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801058d7:	e9 f0 f3 ff ff       	jmp    80104ccc <alltraps>
...
801058dc:	6a 00                	push   $0x0
  pushl $194
801058de:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801058e3:	e9 e4 f3 ff ff       	jmp    80104ccc <alltraps>
...
801058e8:	6a 00                	push   $0x0
  pushl $195
801058ea:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801058ef:	e9 d8 f3 ff ff       	jmp    80104ccc <alltraps>
...
801058f4:	6a 00                	push   $0x0
  pushl $196
801058f6:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801058fb:	e9 cc f3 ff ff       	jmp    80104ccc <alltraps>
...
80105900:	6a 00                	push   $0x0
  pushl $197
80105902:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80105907:	e9 c0 f3 ff ff       	jmp    80104ccc <alltraps>
...
8010590c:	6a 00                	push   $0x0
  pushl $198
8010590e:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80105913:	e9 b4 f3 ff ff       	jmp    80104ccc <alltraps>
...
80105918:	6a 00                	push   $0x0
  pushl $199
8010591a:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010591f:	e9 a8 f3 ff ff       	jmp    80104ccc <alltraps>
...
80105924:	6a 00                	push   $0x0
  pushl $200
80105926:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010592b:	e9 9c f3 ff ff       	jmp    80104ccc <alltraps>
...
80105930:	6a 00                	push   $0x0
  pushl $201
80105932:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80105937:	e9 90 f3 ff ff       	jmp    80104ccc <alltraps>
...
8010593c:	6a 00                	push   $0x0
  pushl $202
8010593e:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80105943:	e9 84 f3 ff ff       	jmp    80104ccc <alltraps>
...
80105948:	6a 00                	push   $0x0
  pushl $203
8010594a:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
8010594f:	e9 78 f3 ff ff       	jmp    80104ccc <alltraps>
...
80105954:	6a 00                	push   $0x0
  pushl $204
80105956:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010595b:	e9 6c f3 ff ff       	jmp    80104ccc <alltraps>
...
80105960:	6a 00                	push   $0x0
  pushl $205
80105962:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105967:	e9 60 f3 ff ff       	jmp    80104ccc <alltraps>
...
8010596c:	6a 00                	push   $0x0
  pushl $206
8010596e:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105973:	e9 54 f3 ff ff       	jmp    80104ccc <alltraps>
...
80105978:	6a 00                	push   $0x0
  pushl $207
8010597a:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010597f:	e9 48 f3 ff ff       	jmp    80104ccc <alltraps>
...
80105984:	6a 00                	push   $0x0
  pushl $208
80105986:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010598b:	e9 3c f3 ff ff       	jmp    80104ccc <alltraps>
...
80105990:	6a 00                	push   $0x0
  pushl $209
80105992:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105997:	e9 30 f3 ff ff       	jmp    80104ccc <alltraps>
...
8010599c:	6a 00                	push   $0x0
  pushl $210
8010599e:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801059a3:	e9 24 f3 ff ff       	jmp    80104ccc <alltraps>
...
801059a8:	6a 00                	push   $0x0
  pushl $211
801059aa:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801059af:	e9 18 f3 ff ff       	jmp    80104ccc <alltraps>
...
801059b4:	6a 00                	push   $0x0
  pushl $212
801059b6:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801059bb:	e9 0c f3 ff ff       	jmp    80104ccc <alltraps>
...
801059c0:	6a 00                	push   $0x0
  pushl $213
801059c2:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801059c7:	e9 00 f3 ff ff       	jmp    80104ccc <alltraps>
...
801059cc:	6a 00                	push   $0x0
  pushl $214
801059ce:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801059d3:	e9 f4 f2 ff ff       	jmp    80104ccc <alltraps>
...
801059d8:	6a 00                	push   $0x0
  pushl $215
801059da:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801059df:	e9 e8 f2 ff ff       	jmp    80104ccc <alltraps>
...
801059e4:	6a 00                	push   $0x0
  pushl $216
801059e6:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801059eb:	e9 dc f2 ff ff       	jmp    80104ccc <alltraps>
...
801059f0:	6a 00                	push   $0x0
  pushl $217
801059f2:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801059f7:	e9 d0 f2 ff ff       	jmp    80104ccc <alltraps>
...
801059fc:	6a 00                	push   $0x0
  pushl $218
801059fe:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105a03:	e9 c4 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a08:	6a 00                	push   $0x0
  pushl $219
80105a0a:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105a0f:	e9 b8 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a14:	6a 00                	push   $0x0
  pushl $220
80105a16:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105a1b:	e9 ac f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a20:	6a 00                	push   $0x0
  pushl $221
80105a22:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105a27:	e9 a0 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a2c:	6a 00                	push   $0x0
  pushl $222
80105a2e:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105a33:	e9 94 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a38:	6a 00                	push   $0x0
  pushl $223
80105a3a:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105a3f:	e9 88 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a44:	6a 00                	push   $0x0
  pushl $224
80105a46:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105a4b:	e9 7c f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a50:	6a 00                	push   $0x0
  pushl $225
80105a52:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105a57:	e9 70 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a5c:	6a 00                	push   $0x0
  pushl $226
80105a5e:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105a63:	e9 64 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a68:	6a 00                	push   $0x0
  pushl $227
80105a6a:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105a6f:	e9 58 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a74:	6a 00                	push   $0x0
  pushl $228
80105a76:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105a7b:	e9 4c f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a80:	6a 00                	push   $0x0
  pushl $229
80105a82:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105a87:	e9 40 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a8c:	6a 00                	push   $0x0
  pushl $230
80105a8e:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105a93:	e9 34 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105a98:	6a 00                	push   $0x0
  pushl $231
80105a9a:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105a9f:	e9 28 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105aa4:	6a 00                	push   $0x0
  pushl $232
80105aa6:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105aab:	e9 1c f2 ff ff       	jmp    80104ccc <alltraps>
...
80105ab0:	6a 00                	push   $0x0
  pushl $233
80105ab2:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105ab7:	e9 10 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105abc:	6a 00                	push   $0x0
  pushl $234
80105abe:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105ac3:	e9 04 f2 ff ff       	jmp    80104ccc <alltraps>
...
80105ac8:	6a 00                	push   $0x0
  pushl $235
80105aca:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105acf:	e9 f8 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105ad4:	6a 00                	push   $0x0
  pushl $236
80105ad6:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105adb:	e9 ec f1 ff ff       	jmp    80104ccc <alltraps>
...
80105ae0:	6a 00                	push   $0x0
  pushl $237
80105ae2:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105ae7:	e9 e0 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105aec:	6a 00                	push   $0x0
  pushl $238
80105aee:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105af3:	e9 d4 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105af8:	6a 00                	push   $0x0
  pushl $239
80105afa:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105aff:	e9 c8 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b04:	6a 00                	push   $0x0
  pushl $240
80105b06:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105b0b:	e9 bc f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b10:	6a 00                	push   $0x0
  pushl $241
80105b12:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105b17:	e9 b0 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b1c:	6a 00                	push   $0x0
  pushl $242
80105b1e:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105b23:	e9 a4 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b28:	6a 00                	push   $0x0
  pushl $243
80105b2a:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105b2f:	e9 98 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b34:	6a 00                	push   $0x0
  pushl $244
80105b36:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105b3b:	e9 8c f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b40:	6a 00                	push   $0x0
  pushl $245
80105b42:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105b47:	e9 80 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b4c:	6a 00                	push   $0x0
  pushl $246
80105b4e:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105b53:	e9 74 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b58:	6a 00                	push   $0x0
  pushl $247
80105b5a:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105b5f:	e9 68 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b64:	6a 00                	push   $0x0
  pushl $248
80105b66:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105b6b:	e9 5c f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b70:	6a 00                	push   $0x0
  pushl $249
80105b72:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105b77:	e9 50 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b7c:	6a 00                	push   $0x0
  pushl $250
80105b7e:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105b83:	e9 44 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b88:	6a 00                	push   $0x0
  pushl $251
80105b8a:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105b8f:	e9 38 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105b94:	6a 00                	push   $0x0
  pushl $252
80105b96:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105b9b:	e9 2c f1 ff ff       	jmp    80104ccc <alltraps>
...
80105ba0:	6a 00                	push   $0x0
  pushl $253
80105ba2:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105ba7:	e9 20 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105bac:	6a 00                	push   $0x0
  pushl $254
80105bae:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105bb3:	e9 14 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105bb8:	6a 00                	push   $0x0
  pushl $255
80105bba:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105bbf:	e9 08 f1 ff ff       	jmp    80104ccc <alltraps>
...
80105bcd:	89 d3                	mov    %edx,%ebx
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80105bcf:	c1 ea 16             	shr    $0x16,%edx
80105bd2:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105bd5:	8b 37                	mov    (%edi),%esi
80105bd7:	f7 c6 01 00 00 00    	test   $0x1,%esi
80105bdd:	74 35                	je     80105c14 <walkpgdir+0x50>
...
80105bdf:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if (a > KERNBASE)
80105be5:	81 fe 00 00 00 80    	cmp    $0x80000000,%esi
80105beb:	77 1a                	ja     80105c07 <walkpgdir+0x43>
    return (char*)a + KERNBASE;
80105bed:	81 c6 00 00 00 80    	add    $0x80000000,%esi
  ...
  return &pgtab[PTX(va)];
80105bf3:	c1 eb 0c             	shr    $0xc,%ebx
80105bf6:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
80105bfc:	8d 04 9e             	lea    (%esi,%ebx,4),%eax
}
...
80105c0a:	68 78 6c 10 80       	push   $0x80106c78
80105c0f:	e8 34 a7 ff ff       	call   80100348 <panic>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80105c14:	85 c9                	test   %ecx,%ecx
80105c16:	74 33                	je     80105c4b <walkpgdir+0x87>
80105c18:	e8 ac c4 ff ff       	call   801020c9 <kalloc>
80105c1d:	89 c6                	mov    %eax,%esi
80105c1f:	85 c0                	test   %eax,%eax
80105c21:	74 28                	je     80105c4b <walkpgdir+0x87>
    memset(pgtab, 0, PGSIZE);
80105c23:	83 ec 04             	sub    $0x4,%esp
80105c26:	68 00 10 00 00       	push   $0x1000
80105c2b:	6a 00                	push   $0x0
80105c2d:	50                   	push   %eax
80105c2e:	e8 30 e0 ff ff       	call   80103c63 <memset>
    if (a < (void*) KERNBASE)
80105c33:	83 c4 10             	add    $0x10,%esp
80105c36:	81 fe ff ff ff 7f    	cmp    $0x7fffffff,%esi
80105c3c:	76 14                	jbe    80105c52 <walkpgdir+0x8e>
    return (uint)a - KERNBASE;
80105c3e:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105c44:	83 c8 07             	or     $0x7,%eax
80105c47:	89 07                	mov    %eax,(%edi)
80105c49:	eb a8                	jmp    80105bf3 <walkpgdir+0x2f>
      return 0;
80105c4b:	b8 00 00 00 00       	mov    $0x0,%eax
80105c50:	eb ad                	jmp    80105bff <walkpgdir+0x3b>
        panic("V2P on address < KERNBASE "
80105c52:	83 ec 0c             	sub    $0xc,%esp
80105c55:	68 48 69 10 80       	push   $0x80106948
80105c5a:	e8 e9 a6 ff ff       	call   80100348 <panic>
...
80105c65:	83 ec 1c             	sub    $0x1c,%esp
80105c68:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105c6b:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105c6e:	89 d3                	mov    %edx,%ebx
80105c70:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105c76:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105c7a:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105c80:	b9 01 00 00 00       	mov    $0x1,%ecx
80105c85:	89 da                	mov    %ebx,%edx
80105c87:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105c8a:	e8 35 ff ff ff       	call   80105bc4 <walkpgdir>
80105c8f:	85 c0                	test   %eax,%eax
80105c91:	74 2e                	je     80105cc1 <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105c93:	f6 00 01             	testb  $0x1,(%eax)
80105c96:	75 1c                	jne    80105cb4 <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105c98:	89 f2                	mov    %esi,%edx
80105c9a:	0b 55 0c             	or     0xc(%ebp),%edx
80105c9d:	83 ca 01             	or     $0x1,%edx
80105ca0:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105ca2:	39 fb                	cmp    %edi,%ebx
80105ca4:	74 28                	je     80105cce <mappages+0x6f>
      break;
    a += PGSIZE;
80105ca6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105cac:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105cb2:	eb cc                	jmp    80105c80 <mappages+0x21>
      panic("remap");
80105cb4:	83 ec 0c             	sub    $0xc,%esp
80105cb7:	68 50 70 10 80       	push   $0x80107050
80105cbc:	e8 87 a6 ff ff       	call   80100348 <panic>
      return -1;
...
80105cd3:	eb f1                	jmp    80105cc6 <mappages+0x67>
...
80105cdb:	83 ec 1c             	sub    $0x1c,%esp
  c = &cpus[cpuid()];
80105cde:	e8 1c d5 ff ff       	call   801031ff <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105ce3:	69 f8 b0 00 00 00    	imul   $0xb0,%eax,%edi
80105ce9:	66 c7 87 18 18 11 80 	movw   $0xffff,-0x7feee7e8(%edi)
80105cf0:	ff ff 
80105cf2:	66 c7 87 1a 18 11 80 	movw   $0x0,-0x7feee7e6(%edi)
80105cf9:	00 00 
80105cfb:	c6 87 1c 18 11 80 00 	movb   $0x0,-0x7feee7e4(%edi)
80105d02:	0f b6 8f 1d 18 11 80 	movzbl -0x7feee7e3(%edi),%ecx
80105d09:	83 e1 f0             	and    $0xfffffff0,%ecx
80105d0c:	89 ce                	mov    %ecx,%esi
80105d0e:	83 ce 0a             	or     $0xa,%esi
80105d11:	89 f2                	mov    %esi,%edx
80105d13:	88 97 1d 18 11 80    	mov    %dl,-0x7feee7e3(%edi)
80105d19:	83 c9 1a             	or     $0x1a,%ecx
80105d1c:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105d22:	83 e1 9f             	and    $0xffffff9f,%ecx
80105d25:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105d2b:	83 c9 80             	or     $0xffffff80,%ecx
80105d2e:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105d34:	0f b6 8f 1e 18 11 80 	movzbl -0x7feee7e2(%edi),%ecx
80105d3b:	83 c9 0f             	or     $0xf,%ecx
80105d3e:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105d44:	89 ce                	mov    %ecx,%esi
80105d46:	83 e6 ef             	and    $0xffffffef,%esi
80105d49:	89 f2                	mov    %esi,%edx
80105d4b:	88 97 1e 18 11 80    	mov    %dl,-0x7feee7e2(%edi)
80105d51:	83 e1 cf             	and    $0xffffffcf,%ecx
80105d54:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105d5a:	89 ce                	mov    %ecx,%esi
80105d5c:	83 ce 40             	or     $0x40,%esi
80105d5f:	89 f2                	mov    %esi,%edx
80105d61:	88 97 1e 18 11 80    	mov    %dl,-0x7feee7e2(%edi)
80105d67:	83 c9 c0             	or     $0xffffffc0,%ecx
80105d6a:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105d70:	c6 87 1f 18 11 80 00 	movb   $0x0,-0x7feee7e1(%edi)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105d77:	66 c7 87 20 18 11 80 	movw   $0xffff,-0x7feee7e0(%edi)
80105d7e:	ff ff 
80105d80:	66 c7 87 22 18 11 80 	movw   $0x0,-0x7feee7de(%edi)
80105d87:	00 00 
80105d89:	c6 87 24 18 11 80 00 	movb   $0x0,-0x7feee7dc(%edi)
80105d90:	0f b6 8f 25 18 11 80 	movzbl -0x7feee7db(%edi),%ecx
80105d97:	83 e1 f0             	and    $0xfffffff0,%ecx
80105d9a:	89 ce                	mov    %ecx,%esi
80105d9c:	83 ce 02             	or     $0x2,%esi
80105d9f:	89 f2                	mov    %esi,%edx
80105da1:	88 97 25 18 11 80    	mov    %dl,-0x7feee7db(%edi)
80105da7:	83 c9 12             	or     $0x12,%ecx
80105daa:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105db0:	83 e1 9f             	and    $0xffffff9f,%ecx
80105db3:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105db9:	83 c9 80             	or     $0xffffff80,%ecx
80105dbc:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105dc2:	0f b6 8f 26 18 11 80 	movzbl -0x7feee7da(%edi),%ecx
80105dc9:	83 c9 0f             	or     $0xf,%ecx
80105dcc:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105dd2:	89 ce                	mov    %ecx,%esi
80105dd4:	83 e6 ef             	and    $0xffffffef,%esi
80105dd7:	89 f2                	mov    %esi,%edx
80105dd9:	88 97 26 18 11 80    	mov    %dl,-0x7feee7da(%edi)
80105ddf:	83 e1 cf             	and    $0xffffffcf,%ecx
80105de2:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105de8:	89 ce                	mov    %ecx,%esi
80105dea:	83 ce 40             	or     $0x40,%esi
80105ded:	89 f2                	mov    %esi,%edx
80105def:	88 97 26 18 11 80    	mov    %dl,-0x7feee7da(%edi)
80105df5:	83 c9 c0             	or     $0xffffffc0,%ecx
80105df8:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105dfe:	c6 87 27 18 11 80 00 	movb   $0x0,-0x7feee7d9(%edi)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80105e05:	66 c7 87 28 18 11 80 	movw   $0xffff,-0x7feee7d8(%edi)
80105e0c:	ff ff 
80105e0e:	66 c7 87 2a 18 11 80 	movw   $0x0,-0x7feee7d6(%edi)
80105e15:	00 00 
80105e17:	c6 87 2c 18 11 80 00 	movb   $0x0,-0x7feee7d4(%edi)
80105e1e:	0f b6 9f 2d 18 11 80 	movzbl -0x7feee7d3(%edi),%ebx
80105e25:	83 e3 f0             	and    $0xfffffff0,%ebx
80105e28:	89 de                	mov    %ebx,%esi
80105e2a:	83 ce 0a             	or     $0xa,%esi
80105e2d:	89 f2                	mov    %esi,%edx
80105e2f:	88 97 2d 18 11 80    	mov    %dl,-0x7feee7d3(%edi)
80105e35:	89 de                	mov    %ebx,%esi
80105e37:	83 ce 1a             	or     $0x1a,%esi
80105e3a:	89 f2                	mov    %esi,%edx
80105e3c:	88 97 2d 18 11 80    	mov    %dl,-0x7feee7d3(%edi)
80105e42:	83 cb 7a             	or     $0x7a,%ebx
80105e45:	88 9f 2d 18 11 80    	mov    %bl,-0x7feee7d3(%edi)
80105e4b:	c6 87 2d 18 11 80 fa 	movb   $0xfa,-0x7feee7d3(%edi)
80105e52:	0f b6 9f 2e 18 11 80 	movzbl -0x7feee7d2(%edi),%ebx
80105e59:	83 cb 0f             	or     $0xf,%ebx
80105e5c:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
80105e62:	89 de                	mov    %ebx,%esi
80105e64:	83 e6 ef             	and    $0xffffffef,%esi
80105e67:	89 f2                	mov    %esi,%edx
80105e69:	88 97 2e 18 11 80    	mov    %dl,-0x7feee7d2(%edi)
80105e6f:	83 e3 cf             	and    $0xffffffcf,%ebx
80105e72:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
80105e78:	89 de                	mov    %ebx,%esi
80105e7a:	83 ce 40             	or     $0x40,%esi
80105e7d:	89 f2                	mov    %esi,%edx
80105e7f:	88 97 2e 18 11 80    	mov    %dl,-0x7feee7d2(%edi)
80105e85:	83 cb c0             	or     $0xffffffc0,%ebx
80105e88:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
80105e8e:	c6 87 2f 18 11 80 00 	movb   $0x0,-0x7feee7d1(%edi)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80105e95:	66 c7 87 30 18 11 80 	movw   $0xffff,-0x7feee7d0(%edi)
80105e9c:	ff ff 
80105e9e:	66 c7 87 32 18 11 80 	movw   $0x0,-0x7feee7ce(%edi)
80105ea5:	00 00 
80105ea7:	c6 87 34 18 11 80 00 	movb   $0x0,-0x7feee7cc(%edi)
80105eae:	0f b6 9f 35 18 11 80 	movzbl -0x7feee7cb(%edi),%ebx
80105eb5:	83 e3 f0             	and    $0xfffffff0,%ebx
80105eb8:	89 de                	mov    %ebx,%esi
80105eba:	83 ce 02             	or     $0x2,%esi
80105ebd:	89 f2                	mov    %esi,%edx
80105ebf:	88 97 35 18 11 80    	mov    %dl,-0x7feee7cb(%edi)
80105ec5:	89 de                	mov    %ebx,%esi
80105ec7:	83 ce 12             	or     $0x12,%esi
80105eca:	89 f2                	mov    %esi,%edx
80105ecc:	88 97 35 18 11 80    	mov    %dl,-0x7feee7cb(%edi)
80105ed2:	83 cb 72             	or     $0x72,%ebx
80105ed5:	88 9f 35 18 11 80    	mov    %bl,-0x7feee7cb(%edi)
80105edb:	c6 87 35 18 11 80 f2 	movb   $0xf2,-0x7feee7cb(%edi)
80105ee2:	0f b6 9f 36 18 11 80 	movzbl -0x7feee7ca(%edi),%ebx
80105ee9:	83 cb 0f             	or     $0xf,%ebx
80105eec:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
80105ef2:	89 de                	mov    %ebx,%esi
80105ef4:	83 e6 ef             	and    $0xffffffef,%esi
80105ef7:	89 f2                	mov    %esi,%edx
80105ef9:	88 97 36 18 11 80    	mov    %dl,-0x7feee7ca(%edi)
80105eff:	83 e3 cf             	and    $0xffffffcf,%ebx
80105f02:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
80105f08:	89 de                	mov    %ebx,%esi
80105f0a:	83 ce 40             	or     $0x40,%esi
80105f0d:	89 f2                	mov    %esi,%edx
80105f0f:	88 97 36 18 11 80    	mov    %dl,-0x7feee7ca(%edi)
80105f15:	83 cb c0             	or     $0xffffffc0,%ebx
80105f18:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
80105f1e:	c6 87 37 18 11 80 00 	movb   $0x0,-0x7feee7c9(%edi)
  lgdt(c->gdt, sizeof(c->gdt));
80105f25:	8d 97 10 18 11 80    	lea    -0x7feee7f0(%edi),%edx
  pd[0] = size-1;
80105f2b:	66 c7 45 e2 2f 00    	movw   $0x2f,-0x1e(%ebp)
  pd[1] = (uint)p;
80105f31:	66 89 55 e4          	mov    %dx,-0x1c(%ebp)
  pd[2] = (uint)p >> 16;
80105f35:	c1 ea 10             	shr    $0x10,%edx
80105f38:	66 89 55 e6          	mov    %dx,-0x1a(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80105f3c:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105f3f:	0f 01 10             	lgdtl  (%eax)
}
80105f42:	83 c4 1c             	add    $0x1c,%esp
80105f45:	5b                   	pop    %ebx
80105f46:	5e                   	pop    %esi
80105f47:	5f                   	pop    %edi
80105f48:	5d                   	pop    %ebp
...
80105f4a:	a1 c4 44 11 80       	mov    0x801144c4,%eax
    if (a < (void*) KERNBASE)
80105f4f:	3d ff ff ff 7f       	cmp    $0x7fffffff,%eax
80105f54:	76 09                	jbe    80105f5f <switchkvm+0x15>
    return (uint)a - KERNBASE;
80105f56:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80105f62:	83 ec 14             	sub    $0x14,%esp
        panic("V2P on address < KERNBASE "
80105f65:	68 48 69 10 80       	push   $0x80106948
...
80105f72:	57                   	push   %edi
80105f73:	56                   	push   %esi
80105f74:	53                   	push   %ebx
80105f75:	83 ec 1c             	sub    $0x1c,%esp
80105f78:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80105f7b:	85 f6                	test   %esi,%esi
80105f7d:	0f 84 2c 01 00 00    	je     801060af <switchuvm+0x140>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80105f83:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
80105f87:	0f 84 2f 01 00 00    	je     801060bc <switchuvm+0x14d>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80105f8d:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80105f91:	0f 84 32 01 00 00    	je     801060c9 <switchuvm+0x15a>
    panic("switchuvm: no pgdir");

  pushcli();
80105f97:	e8 40 db ff ff       	call   80103adc <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80105f9c:	e8 02 d2 ff ff       	call   801031a3 <mycpu>
80105fa1:	89 c3                	mov    %eax,%ebx
80105fa3:	e8 fb d1 ff ff       	call   801031a3 <mycpu>
80105fa8:	8d 78 08             	lea    0x8(%eax),%edi
80105fab:	e8 f3 d1 ff ff       	call   801031a3 <mycpu>
80105fb0:	83 c0 08             	add    $0x8,%eax
80105fb3:	c1 e8 10             	shr    $0x10,%eax
80105fb6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105fb9:	e8 e5 d1 ff ff       	call   801031a3 <mycpu>
80105fbe:	83 c0 08             	add    $0x8,%eax
80105fc1:	c1 e8 18             	shr    $0x18,%eax
80105fc4:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80105fcb:	67 00 
80105fcd:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80105fd4:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
80105fd8:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80105fde:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80105fe5:	83 e2 f0             	and    $0xfffffff0,%edx
80105fe8:	89 d1                	mov    %edx,%ecx
80105fea:	83 c9 09             	or     $0x9,%ecx
80105fed:	88 8b 9d 00 00 00    	mov    %cl,0x9d(%ebx)
80105ff3:	83 ca 19             	or     $0x19,%edx
80105ff6:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80105ffc:	83 e2 9f             	and    $0xffffff9f,%edx
80105fff:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80106005:	83 ca 80             	or     $0xffffff80,%edx
80106008:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
8010600e:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80106015:	89 d1                	mov    %edx,%ecx
80106017:	83 e1 f0             	and    $0xfffffff0,%ecx
8010601a:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
80106020:	89 d1                	mov    %edx,%ecx
80106022:	83 e1 e0             	and    $0xffffffe0,%ecx
80106025:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
8010602b:	83 e2 c0             	and    $0xffffffc0,%edx
8010602e:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80106034:	83 ca 40             	or     $0x40,%edx
80106037:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
8010603d:	83 e2 7f             	and    $0x7f,%edx
80106040:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80106046:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010604c:	e8 52 d1 ff ff       	call   801031a3 <mycpu>
80106051:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80106058:	83 e2 ef             	and    $0xffffffef,%edx
8010605b:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106061:	e8 3d d1 ff ff       	call   801031a3 <mycpu>
80106066:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
8010606c:	8b 5e 08             	mov    0x8(%esi),%ebx
8010606f:	e8 2f d1 ff ff       	call   801031a3 <mycpu>
80106074:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010607a:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
8010607d:	e8 21 d1 ff ff       	call   801031a3 <mycpu>
80106082:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106088:	b8 28 00 00 00       	mov    $0x28,%eax
8010608d:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106090:	8b 46 04             	mov    0x4(%esi),%eax
    if (a < (void*) KERNBASE)
80106093:	3d ff ff ff 7f       	cmp    $0x7fffffff,%eax
80106098:	76 3c                	jbe    801060d6 <switchuvm+0x167>
    return (uint)a - KERNBASE;
8010609a:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
8010609f:	0f 22 d8             	mov    %eax,%cr3
  popcli();
801060a2:	e8 71 da ff ff       	call   80103b18 <popcli>
}
801060a7:	8d 65 f4             	lea    -0xc(%ebp),%esp
801060aa:	5b                   	pop    %ebx
801060ab:	5e                   	pop    %esi
801060ac:	5f                   	pop    %edi
801060ad:	5d                   	pop    %ebp
...
801060b2:	68 56 70 10 80       	push   $0x80107056
801060b7:	e8 8c a2 ff ff       	call   80100348 <panic>
    panic("switchuvm: no kstack");
801060bc:	83 ec 0c             	sub    $0xc,%esp
801060bf:	68 6c 70 10 80       	push   $0x8010706c
801060c4:	e8 7f a2 ff ff       	call   80100348 <panic>
    panic("switchuvm: no pgdir");
801060c9:	83 ec 0c             	sub    $0xc,%esp
801060cc:	68 81 70 10 80       	push   $0x80107081
801060d1:	e8 72 a2 ff ff       	call   80100348 <panic>
        panic("V2P on address < KERNBASE "
801060d6:	83 ec 0c             	sub    $0xc,%esp
801060d9:	68 48 69 10 80       	push   $0x80106948
...
801060e8:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
801060eb:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801060f1:	77 57                	ja     8010614a <inituvm+0x67>
    panic("inituvm: more than a page");
  mem = kalloc();
801060f3:	e8 d1 bf ff ff       	call   801020c9 <kalloc>
801060f8:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801060fa:	83 ec 04             	sub    $0x4,%esp
801060fd:	68 00 10 00 00       	push   $0x1000
80106102:	6a 00                	push   $0x0
80106104:	50                   	push   %eax
80106105:	e8 59 db ff ff       	call   80103c63 <memset>
    if (a < (void*) KERNBASE)
8010610a:	83 c4 10             	add    $0x10,%esp
8010610d:	81 fb ff ff ff 7f    	cmp    $0x7fffffff,%ebx
80106113:	76 42                	jbe    80106157 <inituvm+0x74>
    return (uint)a - KERNBASE;
80106115:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
8010611b:	83 ec 08             	sub    $0x8,%esp
8010611e:	6a 06                	push   $0x6
80106120:	50                   	push   %eax
80106121:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106126:	ba 00 00 00 00       	mov    $0x0,%edx
8010612b:	8b 45 08             	mov    0x8(%ebp),%eax
8010612e:	e8 2c fb ff ff       	call   80105c5f <mappages>
  memmove(mem, init, sz);
80106133:	83 c4 0c             	add    $0xc,%esp
80106136:	56                   	push   %esi
80106137:	ff 75 0c             	push   0xc(%ebp)
8010613a:	53                   	push   %ebx
8010613b:	e8 9b db ff ff       	call   80103cdb <memmove>
}
80106140:	83 c4 10             	add    $0x10,%esp
80106143:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106146:	5b                   	pop    %ebx
80106147:	5e                   	pop    %esi
80106148:	5d                   	pop    %ebp
80106149:	c3                   	ret    
...
8010614d:	68 95 70 10 80       	push   $0x80107095
80106152:	e8 f1 a1 ff ff       	call   80100348 <panic>
        panic("V2P on address < KERNBASE "
80106157:	83 ec 0c             	sub    $0xc,%esp
8010615a:	68 48 69 10 80       	push   $0x80106948
8010615f:	e8 e4 a1 ff ff       	call   80100348 <panic>
...
8010616d:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80106170:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80106173:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
80106179:	74 43                	je     801061be <loaduvm+0x5a>
    panic("loaduvm: addr must be page aligned");
8010617b:	83 ec 0c             	sub    $0xc,%esp
8010617e:	68 50 71 10 80       	push   $0x80107150
80106183:	e8 c0 a1 ff ff       	call   80100348 <panic>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106188:	83 ec 0c             	sub    $0xc,%esp
8010618b:	68 af 70 10 80       	push   $0x801070af
...
80106195:	89 da                	mov    %ebx,%edx
80106197:	03 55 14             	add    0x14(%ebp),%edx
    if (a > KERNBASE)
8010619a:	3d 00 00 00 80       	cmp    $0x80000000,%eax
8010619f:	77 51                	ja     801061f2 <loaduvm+0x8e>
    return (char*)a + KERNBASE;
801061a1:	05 00 00 00 80       	add    $0x80000000,%eax
801061a6:	56                   	push   %esi
801061a7:	52                   	push   %edx
801061a8:	50                   	push   %eax
801061a9:	ff 75 10             	push   0x10(%ebp)
801061ac:	e8 b0 b5 ff ff       	call   80101761 <readi>
801061b1:	83 c4 10             	add    $0x10,%esp
801061b4:	39 f0                	cmp    %esi,%eax
801061b6:	75 54                	jne    8010620c <loaduvm+0xa8>
  for(i = 0; i < sz; i += PGSIZE){
801061b8:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801061be:	39 fb                	cmp    %edi,%ebx
801061c0:	73 3d                	jae    801061ff <loaduvm+0x9b>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801061c2:	89 da                	mov    %ebx,%edx
801061c4:	03 55 0c             	add    0xc(%ebp),%edx
801061c7:	b9 00 00 00 00       	mov    $0x0,%ecx
801061cc:	8b 45 08             	mov    0x8(%ebp),%eax
801061cf:	e8 f0 f9 ff ff       	call   80105bc4 <walkpgdir>
801061d4:	85 c0                	test   %eax,%eax
801061d6:	74 b0                	je     80106188 <loaduvm+0x24>
    pa = PTE_ADDR(*pte);
801061d8:	8b 00                	mov    (%eax),%eax
801061da:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
801061df:	89 fe                	mov    %edi,%esi
801061e1:	29 de                	sub    %ebx,%esi
801061e3:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801061e9:	76 aa                	jbe    80106195 <loaduvm+0x31>
      n = PGSIZE;
801061eb:	be 00 10 00 00       	mov    $0x1000,%esi
801061f0:	eb a3                	jmp    80106195 <loaduvm+0x31>
        panic("P2V on address > KERNBASE");
801061f2:	83 ec 0c             	sub    $0xc,%esp
801061f5:	68 78 6c 10 80       	push   $0x80106c78
801061fa:	e8 49 a1 ff ff       	call   80100348 <panic>
      return -1;
  }
  return 0;
...
80106211:	eb f1                	jmp    80106204 <loaduvm+0xa0>
...
80106217:	56                   	push   %esi
80106218:	53                   	push   %ebx
80106219:	83 ec 0c             	sub    $0xc,%esp
8010621c:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
8010621f:	39 7d 10             	cmp    %edi,0x10(%ebp)
80106222:	73 11                	jae    80106235 <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
80106224:	8b 45 10             	mov    0x10(%ebp),%eax
80106227:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
8010622d:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106233:	eb 19                	jmp    8010624e <deallocuvm+0x3b>
    return oldsz;
80106235:	89 f8                	mov    %edi,%eax
80106237:	eb 78                	jmp    801062b1 <deallocuvm+0x9e>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106239:	c1 eb 16             	shr    $0x16,%ebx
8010623c:	83 c3 01             	add    $0x1,%ebx
8010623f:	c1 e3 16             	shl    $0x16,%ebx
80106242:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106248:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010624e:	39 fb                	cmp    %edi,%ebx
80106250:	73 5c                	jae    801062ae <deallocuvm+0x9b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106252:	b9 00 00 00 00       	mov    $0x0,%ecx
80106257:	89 da                	mov    %ebx,%edx
80106259:	8b 45 08             	mov    0x8(%ebp),%eax
8010625c:	e8 63 f9 ff ff       	call   80105bc4 <walkpgdir>
80106261:	89 c6                	mov    %eax,%esi
    if(!pte)
80106263:	85 c0                	test   %eax,%eax
80106265:	74 d2                	je     80106239 <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
80106267:	8b 00                	mov    (%eax),%eax
80106269:	a8 01                	test   $0x1,%al
8010626b:	74 db                	je     80106248 <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010626d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106272:	74 20                	je     80106294 <deallocuvm+0x81>
    if (a > KERNBASE)
80106274:	3d 00 00 00 80       	cmp    $0x80000000,%eax
80106279:	77 26                	ja     801062a1 <deallocuvm+0x8e>
    return (char*)a + KERNBASE;
...
80106284:	e8 03 bd ff ff       	call   80101f8c <kfree>
      *pte = 0;
80106289:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
8010628f:	83 c4 10             	add    $0x10,%esp
80106292:	eb b4                	jmp    80106248 <deallocuvm+0x35>
        panic("kfree");
80106294:	83 ec 0c             	sub    $0xc,%esp
80106297:	68 d6 69 10 80       	push   $0x801069d6
8010629c:	e8 a7 a0 ff ff       	call   80100348 <panic>
        panic("P2V on address > KERNBASE");
801062a1:	83 ec 0c             	sub    $0xc,%esp
801062a4:	68 78 6c 10 80       	push   $0x80106c78
801062a9:	e8 9a a0 ff ff       	call   80100348 <panic>
    }
  }
  return newsz;
...
801062be:	53                   	push   %ebx
801062bf:	83 ec 1c             	sub    $0x1c,%esp
801062c2:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
801062c5:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801062c8:	85 ff                	test   %edi,%edi
801062ca:	0f 88 d9 00 00 00    	js     801063a9 <allocuvm+0xf0>
  if(newsz < oldsz)
801062d0:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801062d3:	72 67                	jb     8010633c <allocuvm+0x83>
  a = PGROUNDUP(oldsz);
801062d5:	8b 45 0c             	mov    0xc(%ebp),%eax
801062d8:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
801062de:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
801062e4:	39 fe                	cmp    %edi,%esi
801062e6:	0f 83 c4 00 00 00    	jae    801063b0 <allocuvm+0xf7>
    mem = kalloc();
801062ec:	e8 d8 bd ff ff       	call   801020c9 <kalloc>
801062f1:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
801062f3:	85 c0                	test   %eax,%eax
801062f5:	74 4d                	je     80106344 <allocuvm+0x8b>
    memset(mem, 0, PGSIZE);
801062f7:	83 ec 04             	sub    $0x4,%esp
801062fa:	68 00 10 00 00       	push   $0x1000
801062ff:	6a 00                	push   $0x0
80106301:	50                   	push   %eax
80106302:	e8 5c d9 ff ff       	call   80103c63 <memset>
    if (a < (void*) KERNBASE)
80106307:	83 c4 10             	add    $0x10,%esp
8010630a:	81 fb ff ff ff 7f    	cmp    $0x7fffffff,%ebx
80106310:	76 5a                	jbe    8010636c <allocuvm+0xb3>
    return (uint)a - KERNBASE;
80106312:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106318:	83 ec 08             	sub    $0x8,%esp
8010631b:	6a 06                	push   $0x6
8010631d:	50                   	push   %eax
8010631e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106323:	89 f2                	mov    %esi,%edx
80106325:	8b 45 08             	mov    0x8(%ebp),%eax
80106328:	e8 32 f9 ff ff       	call   80105c5f <mappages>
8010632d:	83 c4 10             	add    $0x10,%esp
80106330:	85 c0                	test   %eax,%eax
80106332:	78 45                	js     80106379 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
80106334:	81 c6 00 10 00 00    	add    $0x1000,%esi
8010633a:	eb a8                	jmp    801062e4 <allocuvm+0x2b>
    return oldsz;
8010633c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010633f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106342:	eb 6c                	jmp    801063b0 <allocuvm+0xf7>
      cprintf("allocuvm out of memory\n");
80106344:	83 ec 0c             	sub    $0xc,%esp
80106347:	68 cd 70 10 80       	push   $0x801070cd
8010634c:	e8 b6 a2 ff ff       	call   80100607 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106351:	83 c4 0c             	add    $0xc,%esp
80106354:	ff 75 0c             	push   0xc(%ebp)
80106357:	57                   	push   %edi
80106358:	ff 75 08             	push   0x8(%ebp)
8010635b:	e8 b3 fe ff ff       	call   80106213 <deallocuvm>
      return 0;
80106360:	83 c4 10             	add    $0x10,%esp
80106363:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010636a:	eb 44                	jmp    801063b0 <allocuvm+0xf7>
        panic("V2P on address < KERNBASE "
8010636c:	83 ec 0c             	sub    $0xc,%esp
8010636f:	68 48 69 10 80       	push   $0x80106948
80106374:	e8 cf 9f ff ff       	call   80100348 <panic>
      cprintf("allocuvm out of memory (2)\n");
80106379:	83 ec 0c             	sub    $0xc,%esp
8010637c:	68 e5 70 10 80       	push   $0x801070e5
80106381:	e8 81 a2 ff ff       	call   80100607 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106386:	83 c4 0c             	add    $0xc,%esp
80106389:	ff 75 0c             	push   0xc(%ebp)
8010638c:	57                   	push   %edi
8010638d:	ff 75 08             	push   0x8(%ebp)
80106390:	e8 7e fe ff ff       	call   80106213 <deallocuvm>
      kfree(mem);
80106395:	89 1c 24             	mov    %ebx,(%esp)
80106398:	e8 ef bb ff ff       	call   80101f8c <kfree>
      return 0;
8010639d:	83 c4 10             	add    $0x10,%esp
801063a0:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801063a7:	eb 07                	jmp    801063b0 <allocuvm+0xf7>
    return 0;
801063a9:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
801063c5:	74 1a                	je     801063e1 <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
801063c7:	83 ec 04             	sub    $0x4,%esp
801063ca:	6a 00                	push   $0x0
801063cc:	68 00 00 00 80       	push   $0x80000000
801063d1:	56                   	push   %esi
801063d2:	e8 3c fe ff ff       	call   80106213 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801063d7:	83 c4 10             	add    $0x10,%esp
801063da:	bb 00 00 00 00       	mov    $0x0,%ebx
801063df:	eb 21                	jmp    80106402 <freevm+0x47>
    panic("freevm: no pgdir");
801063e1:	83 ec 0c             	sub    $0xc,%esp
801063e4:	68 01 71 10 80       	push   $0x80107101
...
801063f7:	e8 90 bb ff ff       	call   80101f8c <kfree>
801063fc:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
801063ff:	83 c3 01             	add    $0x1,%ebx
80106402:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
80106408:	77 20                	ja     8010642a <freevm+0x6f>
    if(pgdir[i] & PTE_P){
8010640a:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
8010640d:	a8 01                	test   $0x1,%al
8010640f:	74 ee                	je     801063ff <freevm+0x44>
80106411:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if (a > KERNBASE)
80106416:	3d 00 00 00 80       	cmp    $0x80000000,%eax
8010641b:	76 d1                	jbe    801063ee <freevm+0x33>
        panic("P2V on address > KERNBASE");
8010641d:	83 ec 0c             	sub    $0xc,%esp
80106420:	68 78 6c 10 80       	push   $0x80106c78
80106425:	e8 1e 9f ff ff       	call   80100348 <panic>
    }
  }
  kfree((char*)pgdir);
8010642a:	83 ec 0c             	sub    $0xc,%esp
8010642d:	56                   	push   %esi
8010642e:	e8 59 bb ff ff       	call   80101f8c <kfree>
}
80106433:	83 c4 10             	add    $0x10,%esp
80106436:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106439:	5b                   	pop    %ebx
8010643a:	5e                   	pop    %esi
8010643b:	5d                   	pop    %ebp
8010643c:	c3                   	ret    
...
80106442:	e8 82 bc ff ff       	call   801020c9 <kalloc>
80106447:	89 c6                	mov    %eax,%esi
80106449:	85 c0                	test   %eax,%eax
8010644b:	74 55                	je     801064a2 <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
8010644d:	83 ec 04             	sub    $0x4,%esp
80106450:	68 00 10 00 00       	push   $0x1000
80106455:	6a 00                	push   $0x0
80106457:	50                   	push   %eax
80106458:	e8 06 d8 ff ff       	call   80103c63 <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010645d:	83 c4 10             	add    $0x10,%esp
80106460:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
80106465:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
8010646b:	73 35                	jae    801064a2 <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
8010646d:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106470:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106473:	29 c1                	sub    %eax,%ecx
80106475:	83 ec 08             	sub    $0x8,%esp
80106478:	ff 73 0c             	push   0xc(%ebx)
8010647b:	50                   	push   %eax
8010647c:	8b 13                	mov    (%ebx),%edx
8010647e:	89 f0                	mov    %esi,%eax
80106480:	e8 da f7 ff ff       	call   80105c5f <mappages>
80106485:	83 c4 10             	add    $0x10,%esp
80106488:	85 c0                	test   %eax,%eax
8010648a:	78 05                	js     80106491 <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010648c:	83 c3 10             	add    $0x10,%ebx
8010648f:	eb d4                	jmp    80106465 <setupkvm+0x28>
      freevm(pgdir);
80106491:	83 ec 0c             	sub    $0xc,%esp
80106494:	56                   	push   %esi
80106495:	e8 21 ff ff ff       	call   801063bb <freevm>
      return 0;
8010649a:	83 c4 10             	add    $0x10,%esp
8010649d:	be 00 00 00 00       	mov    $0x0,%esi
}
801064a2:	89 f0                	mov    %esi,%eax
801064a4:	8d 65 f8             	lea    -0x8(%ebp),%esp
801064a7:	5b                   	pop    %ebx
801064a8:	5e                   	pop    %esi
801064a9:	5d                   	pop    %ebp
801064aa:	c3                   	ret    
...
801064ae:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801064b1:	e8 87 ff ff ff       	call   8010643d <setupkvm>
801064b6:	a3 c4 44 11 80       	mov    %eax,0x801144c4
  switchkvm();
801064bb:	e8 8a fa ff ff       	call   80105f4a <switchkvm>
}
801064c0:	c9                   	leave  
801064c1:	c3                   	ret    
...
801064d3:	e8 ec f6 ff ff       	call   80105bc4 <walkpgdir>
  if(pte == 0)
801064d8:	85 c0                	test   %eax,%eax
801064da:	74 05                	je     801064e1 <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
801064dc:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801064df:	c9                   	leave  
801064e0:	c3                   	ret    
    panic("clearpteu");
801064e1:	83 ec 0c             	sub    $0xc,%esp
801064e4:	68 12 71 10 80       	push   $0x80107112
801064e9:	e8 5a 9e ff ff       	call   80100348 <panic>
...
801064f4:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801064f7:	e8 41 ff ff ff       	call   8010643d <setupkvm>
801064fc:	89 45 dc             	mov    %eax,-0x24(%ebp)
801064ff:	85 c0                	test   %eax,%eax
80106501:	0f 84 f2 00 00 00    	je     801065f9 <copyuvm+0x10b>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106507:	bf 00 00 00 00       	mov    $0x0,%edi
8010650c:	eb 3a                	jmp    80106548 <copyuvm+0x5a>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
8010650e:	83 ec 0c             	sub    $0xc,%esp
80106511:	68 1c 71 10 80       	push   $0x8010711c
80106516:	e8 2d 9e ff ff       	call   80100348 <panic>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
8010651b:	83 ec 0c             	sub    $0xc,%esp
8010651e:	68 36 71 10 80       	push   $0x80107136
80106523:	e8 20 9e ff ff       	call   80100348 <panic>
80106528:	83 ec 0c             	sub    $0xc,%esp
8010652b:	68 78 6c 10 80       	push   $0x80106c78
80106530:	e8 13 9e ff ff       	call   80100348 <panic>
        panic("V2P on address < KERNBASE "
80106535:	83 ec 0c             	sub    $0xc,%esp
80106538:	68 48 69 10 80       	push   $0x80106948
8010653d:	e8 06 9e ff ff       	call   80100348 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80106542:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106548:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010654b:	0f 83 a8 00 00 00    	jae    801065f9 <copyuvm+0x10b>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106551:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106554:	b9 00 00 00 00       	mov    $0x0,%ecx
80106559:	89 fa                	mov    %edi,%edx
8010655b:	8b 45 08             	mov    0x8(%ebp),%eax
8010655e:	e8 61 f6 ff ff       	call   80105bc4 <walkpgdir>
80106563:	85 c0                	test   %eax,%eax
80106565:	74 a7                	je     8010650e <copyuvm+0x20>
    if(!(*pte & PTE_P))
80106567:	8b 00                	mov    (%eax),%eax
80106569:	a8 01                	test   $0x1,%al
8010656b:	74 ae                	je     8010651b <copyuvm+0x2d>
8010656d:	89 c6                	mov    %eax,%esi
8010656f:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
static inline uint PTE_FLAGS(uint pte) { return pte & 0xFFF; }
80106575:	25 ff 0f 00 00       	and    $0xfff,%eax
8010657a:	89 45 e0             	mov    %eax,-0x20(%ebp)
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
8010657d:	e8 47 bb ff ff       	call   801020c9 <kalloc>
80106582:	89 c3                	mov    %eax,%ebx
80106584:	85 c0                	test   %eax,%eax
80106586:	74 5c                	je     801065e4 <copyuvm+0xf6>
    if (a > KERNBASE)
80106588:	81 fe 00 00 00 80    	cmp    $0x80000000,%esi
8010658e:	77 98                	ja     80106528 <copyuvm+0x3a>
    return (char*)a + KERNBASE;
80106590:	81 c6 00 00 00 80    	add    $0x80000000,%esi
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106596:	83 ec 04             	sub    $0x4,%esp
80106599:	68 00 10 00 00       	push   $0x1000
8010659e:	56                   	push   %esi
8010659f:	50                   	push   %eax
801065a0:	e8 36 d7 ff ff       	call   80103cdb <memmove>
    if (a < (void*) KERNBASE)
801065a5:	83 c4 10             	add    $0x10,%esp
801065a8:	81 fb ff ff ff 7f    	cmp    $0x7fffffff,%ebx
801065ae:	76 85                	jbe    80106535 <copyuvm+0x47>
    return (uint)a - KERNBASE;
801065b0:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801065b6:	83 ec 08             	sub    $0x8,%esp
801065b9:	ff 75 e0             	push   -0x20(%ebp)
801065bc:	50                   	push   %eax
801065bd:	b9 00 10 00 00       	mov    $0x1000,%ecx
801065c2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801065c5:	8b 45 dc             	mov    -0x24(%ebp),%eax
801065c8:	e8 92 f6 ff ff       	call   80105c5f <mappages>
801065cd:	83 c4 10             	add    $0x10,%esp
801065d0:	85 c0                	test   %eax,%eax
801065d2:	0f 89 6a ff ff ff    	jns    80106542 <copyuvm+0x54>
      kfree(mem);
...
801065e7:	ff 75 dc             	push   -0x24(%ebp)
801065ea:	e8 cc fd ff ff       	call   801063bb <freevm>
  return 0;
801065ef:	83 c4 10             	add    $0x10,%esp
801065f2:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
801065f9:	8b 45 dc             	mov    -0x24(%ebp),%eax
...
80106615:	e8 aa f5 ff ff       	call   80105bc4 <walkpgdir>
  if((*pte & PTE_P) == 0)
8010661a:	8b 00                	mov    (%eax),%eax
8010661c:	a8 01                	test   $0x1,%al
8010661e:	74 24                	je     80106644 <uva2ka+0x40>
    return 0;
  if((*pte & PTE_U) == 0)
80106620:	a8 04                	test   $0x4,%al
80106622:	74 27                	je     8010664b <uva2ka+0x47>
static inline uint PTE_ADDR(uint pte)  { return pte & ~0xFFF; }
80106624:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if (a > KERNBASE)
80106629:	3d 00 00 00 80       	cmp    $0x80000000,%eax
8010662e:	77 07                	ja     80106637 <uva2ka+0x33>
    return (char*)a + KERNBASE;
80106630:	05 00 00 00 80       	add    $0x80000000,%eax
    return 0;
...
8010663a:	68 78 6c 10 80       	push   $0x80106c78
8010663f:	e8 04 9d ff ff       	call   80100348 <panic>
    return 0;
80106644:	b8 00 00 00 00       	mov    $0x0,%eax
80106649:	eb ea                	jmp    80106635 <uva2ka+0x31>
    return 0;
8010664b:	b8 00 00 00 00       	mov    $0x0,%eax
80106650:	eb e3                	jmp    80106635 <uva2ka+0x31>
...
8010665b:	8b 7d 14             	mov    0x14(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
8010665e:	eb 25                	jmp    80106685 <copyout+0x33>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
80106660:	8b 55 0c             	mov    0xc(%ebp),%edx
80106663:	29 f2                	sub    %esi,%edx
80106665:	01 d0                	add    %edx,%eax
80106667:	83 ec 04             	sub    $0x4,%esp
8010666a:	53                   	push   %ebx
8010666b:	ff 75 10             	push   0x10(%ebp)
8010666e:	50                   	push   %eax
8010666f:	e8 67 d6 ff ff       	call   80103cdb <memmove>
    len -= n;
80106674:	29 df                	sub    %ebx,%edi
    buf += n;
80106676:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80106679:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
8010667f:	89 45 0c             	mov    %eax,0xc(%ebp)
80106682:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
80106685:	85 ff                	test   %edi,%edi
80106687:	74 2f                	je     801066b8 <copyout+0x66>
    va0 = (uint)PGROUNDDOWN(va);
80106689:	8b 75 0c             	mov    0xc(%ebp),%esi
8010668c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106692:	83 ec 08             	sub    $0x8,%esp
80106695:	56                   	push   %esi
80106696:	ff 75 08             	push   0x8(%ebp)
80106699:	e8 66 ff ff ff       	call   80106604 <uva2ka>
    if(pa0 == 0)
8010669e:	83 c4 10             	add    $0x10,%esp
801066a1:	85 c0                	test   %eax,%eax
801066a3:	74 20                	je     801066c5 <copyout+0x73>
    n = PGSIZE - (va - va0);
801066a5:	89 f3                	mov    %esi,%ebx
801066a7:	2b 5d 0c             	sub    0xc(%ebp),%ebx
801066aa:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
801066b0:	39 df                	cmp    %ebx,%edi
801066b2:	73 ac                	jae    80106660 <copyout+0xe>
      n = len;
801066b4:	89 fb                	mov    %edi,%ebx
801066b6:	eb a8                	jmp    80106660 <copyout+0xe>
  }
  return 0;
801066b8:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
801066ca:	eb f1                	jmp    801066bd <copyout+0x6b>
